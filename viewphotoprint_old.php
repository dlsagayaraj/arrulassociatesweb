...
<section class="invoice-view-wrapper section" style=" background: white !important;">
  ...
  <div class="row">
		...
		<h4 style="text-align: center;"><span style="border-bottom:1px solid;">Technical Snaps View OF the Propery</span></h4>
...
{
?>
		<tr><td style="width:100%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:370px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:410px;" <?php } ?>></td></tr>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{?>
		<img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:800px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:820px;" <?php } ?>>
<?php } ?>		
...
{?>
		...
		<td style="width:100%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:400px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:410px;" <?php } ?>></td>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:370px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:410px;" <?php } ?>></td>	<?php } ?></tr>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:370px;" <?php } else {?> style="    width: 100%;border-radius:20px;transform: skewX(-19deg);  height:410px;" <?php } ?>></td><?php } ?>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:235px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:240px;" <?php } ?>></td>	<?php } ?></tr>
		
	<tr>	<?php
$ftaxreceipt = mysqli_query($conn,"SELECT * FROM `photocollect` where 1=1 and  cat_id='$edit_id' and  delete_status='0' order by id asc limit 2,1");   
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:100%;" colspan="2"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:315px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:320px;" <?php } ?>></td><?php }
?>
		</tr>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:235px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:240px;" <?php } ?>></td><?php }
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:260px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:270px;" <?php } ?>></td>	<?php } ?></tr>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:260px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:270px;" <?php } ?>></td><?php } ?>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:195px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:200px;" <?php } ?>></td>	<?php } ?></tr>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:195px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:200px;" <?php } ?>></td><?php } ?>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:250px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:250px;" <?php } ?>></td>	<?php } ?></tr>
...
while($ftaxreceipt1 = mysqli_fetch_array($ftaxreceipt))
{
?><td style="width:50%;"><img src="<?php echo $web_url; ?>documents/photocollect/<?php echo $ftaxreceipt1['file_name'];?>" <?php if($varialb>5){?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg); height:250px;" <?php } else {?> style="    width: 100%;border-radius: 20px;transform: skewX(-19deg);  height:250px;" <?php } ?>></td><?php } ?>
...
?>
    ...
    margin-left: -89px;
	    margin-top: 2px;
    padding-left: 12px;padding-top: 2px;">BO:81/10, Chairman Building, Ottametthai, Pallipalayam.</p>
	 </td>
