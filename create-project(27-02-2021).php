...
<tbody <?php if($countproper1>0) {?> class="newTR<?php echo $valdel; ?>" <?php } else { ?> class="newTR1"  <?php } ?>>
 ...
 <tr>
		           <td></td>  <td>Dimension of the<br><input  id="dimensionsite" name="dimensionsite[]"  type="text" value="<?php echo $dimensionsite[$countproper1];?>"></td>
					 ...
					 <td>Land Value Total<br><input  class="totallandvalue" id="totallandvalue" name="totallandvalue[]" readonly type="text" value="<?php echo $totallandvalue[$countproper1];?>">   <a href="#" id="remove_more" class="dnewTR<?php echo $valdel; ?>" <?php if($countproper1>0) {?> style="    float: right;color:red;" <?php } else {?> style="    float: right;color:red;display:none;" <?php } ?> >Remove(X)</a>   </td>
...
<?php } } else { ?> 
 ...
 <tr> <td></td>
		            <td>Dimension of the<br><input  id="dimensionsite" name="dimensionsite[]"  type="text" value=""></td>
					 ...
					 <td>Land Value Total<br><input  id="totallandvalue" class="totallandvalue" name="totallandvalue[]" readonly type="text" value="">   <a href="#" id="remove_more" class="" style="    float: right;color:red;display:none;" >Remove(X)</a>   </td>
					
                  </tr>		


 <tr> 
		            <td colspan="2">Type of Property </td><td colspan="2"><select name="typeofproperty" id="typeofproperty">
...
<?php if($project1['roof']!='' or $project1['roof']!='') 
{
$roof21=explode(",",$project1['roof']);	
foreach($roof21 as $countproper =>$key) {	

	?>
				<div class="row block s<?php echo $countproper; ?>" style="    width: 100%;margin-left: 2px;">
...
<?php } }  else { ?>
	...
	<div class="row block" style="    width: 100%;margin-left: 2px;">
...
<select name="reasonable_perce1" id="reasonable_perce1"> <option value="" selected>Percentage</option><?php
