...
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="width:50%;"<?php } ?>>    <select name="bank" id="bank"  class="select2" required  <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="width:50% !important; "<?php } ?>> 
...
foreach($ownerAddress2 as $lengthacountproper2 =>$key) {	?><div id="a">	<select name="first_cap[]" <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="display:block;width: 100%;" <?php } else {?>  style="display:block;width: 27%;" <?php } ?>><option value="">Select</option><option <?php if($first_cap[$lengthacountproper2]=='Mr.') {?> selected <?php } ?> value="Mr.">Mr.</option><option <?php if($first_cap[$lengthacountproper2]=='Mrs.') {?> selected <?php } ?>  value="Mrs.">Mrs.</option></select><input  id="ownerAddress" name="ownerAddress[]" type="text" value="<?php echo $key;?>"  style=" width: 70%;"><select name="second_cap[]" <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="display:block;width: 100%;" <?php } else {?>  style="display:block;width: 27%;" <?php } ?>><option value="">Select</option><option <?php if($second_cap[$lengthacountproper2]=='S/o.') {?> selected <?php } ?> value="S/o.">S/o.</option><option <?php if($second_cap[$lengthacountproper2]=='W/o.') {?> selected <?php } ?> value="W/o.">W/o.</option><option <?php if($second_cap[$lengthacountproper2]=='D/o.') {?> selected <?php } ?> value="D/o.">D/o.</option></select><input  id="ownerAddress1" name="ownerAddress1[]" type="text" value="<?php echo $ownerAddress1[$lengthacountproper2];?>" style="width:80%;"><input type="button" class="btnRemove" value="X" style=" width: 10%;background: red;color: white;border-color: red;font-weight: bold;"/></div> <?php } } else { ?> <div id="a"><select name="first_cap[]" <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="display:block;width: 100%;" <?php } else {?>  style="display:block;width: 27%;" <?php } ?>><option value="">Select</option><option value="Mr.">Mr.</option><option value="Mrs.">Mrs.</option></select><input  id="ownerAddress" name="ownerAddress[]" type="text" value=""><select name="second_cap[]" <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="display:block;width: 100%;" <?php } else {?>  style="display:block;width: 27%;" <?php } ?>><option value="">Select</option><option value="S/o.">S/o.</option><option value="W/o.">W/o.</option><option value="D/o.">D/o.</option></select><input  id="ownerAddress1" name="ownerAddress1[]" type="text" value=""></div> <?php } ?>
...
<?php } ?>
                </select><input  id="reasonable_perce" name="reasonable_perce" type="text"  value="<?php echo $project1['reasonable_perce'];?>" 	<?php if($deviceType=='phone' || $deviceType=='tablet') {?>style="width: 30%;margin-right: 112px;margin-top: -50px;" <?php } else {?> style="width: 30%;float: right;margin-right: 112px;margin-top: -50px;" <?php } ?>></td><td><input  id="reasonable_value" name="reasonable_value" type="text"  value="<?php echo $project1['reasonable_value'];?>"></td></tr>
