			...
			width: 95%" <?php } ?>>
              ...
              <tbody>
				...
				<tr>
                  ...
                  <td style="border:1px solid;"><?php if($estent1[$countproper1]!='0.00') {?><?php echo $estent1[$countproper1];?><?php } ?></td>
                  <td style="border:1px solid;"><?php if($estent2[$countproper1]!='0.00') {?> <?php echo $estent2[$countproper1];?> <?php } ?></td>
				  <td style="border:1px solid;"><?php if($estent3[$countproper1]!='0.00') {?><?php echo $estent3[$countproper1];?><?php } ?></td>
