...
<th>    <select name="bank" id="bank"  class="select2 browser-default" required data-error=".errorTxt1"> 
...
<?php echo $northboundary[$countproper1];?></textarea></td>
				    <td class="pattashow"><input  id="north1" name="north1[]" type="text"  value="<?php echo $north1[$countproper1];?>" style="width:25% !important;"><input  id="north2" name="north2[]" type="text" value="<?php echo $north2[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="north3" name="north3[]" type="text"  readonly value="<?php echo $north3[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="north4" name="north4[]" type="text" value="<?php echo $north4[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="north5" name="north5[]" type="text" value="<?php echo $north5[$countproper1];?>"style="width:25% !important;margin-left: 3px;"><input  id="north6" name="north6[]" type="text" readonly value="<?php echo $north6[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
					 <td><input  id="north7" name="north7[]" type="text" value="<?php echo $north7[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="north8" name="north8[]" type="text" value="<?php echo $north8[$countproper1];?>"style="width:25% !important;margin-left: 3px;"><input  id="north9" name="north9[]" type="text" readonly value="<?php echo $north9[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
...
<?php echo $southboundary[$countproper1];?></textarea></td>
				     <td class="pattashow"><input  id="south1" name="south1[]" type="text" value="<?php echo $south1[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="south2" name="south2[]" type="text" value="<?php echo $south2[$countproper1];?>"style="width:25% !important;margin-left: 3px;"><input  id="south3" name="south3[]" type="text" readonly value="<?php echo $south3[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="south4" name="south4[]" type="text" value="<?php echo $south4[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="south5" name="south5[]" type="text" value="<?php echo $south5[$countproper1];?>"style="width:25% !important;margin-left: 3px;"><input  id="south6" name="south6[]" type="text" readonly value="<?php echo $south6[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
					 <td><input  id="south7" name="south7[]" type="text" value="<?php echo $south7[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="south8" name="south8[]" type="text" value="<?php echo $south8[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="south9" name="south9[]" type="text" readonly value="<?php echo $south9[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
...
<?php echo $eastboundary[$countproper1];?></textarea></td>
				      <td class="pattashow"><input  id="east1" name="east1[]" type="text" value="<?php echo $east1[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="east2" name="east2[]" type="text" value="<?php echo $east2[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="east3" name="east3[]" type="text" readonly value="<?php echo $east3[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="east4" name="east4[]" type="text" value="<?php echo $east4[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="east5" name="east5[]" type="text" value="<?php echo $east5[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="east6" name="east6[]" type="text" readonly value="<?php echo $east6[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
					 <td><input  id="east7" name="east7[]" type="text" value="<?php echo $east7[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="east8" name="east8[]" type="text" value="<?php echo $east8[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="east9" name="east9[]" type="text" readonly value="<?php echo $east9[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
...
<?php echo $westboundary[$countproper1];?></textarea></td>
				     <td class="pattashow"><input  id="west1" name="west1[]" type="text" value="<?php echo $west1[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="west2" name="west2[]" type="text" value="<?php echo $west2[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="west3" name="west3[]" type="text" readonly value="<?php echo $west3[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="west4" name="west4[]" type="text" value="<?php echo $west4[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="west5" name="west5[]" type="text" value="<?php echo $west5[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="west6" name="west6[]" type="text" readonly value="<?php echo $west6[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
					 <td><input  id="west7" name="west7[]" type="text" value="<?php echo $west7[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="west8" name="west8[]" type="text" value="<?php echo $west8[$countproper1];?>" style="width:25% !important;margin-left: 3px;"><input  id="west9" name="west9[]" type="text" readonly value="<?php echo $west9[$countproper1];?>" style="width:25% !important;margin-left: 3px;"></td>
 ...
 <tbody class="newTR1">
           ...
           <td></td></tr>  
				   <tr >
				    ...
				    <td class="pattashow"><input  id="north1" name="north1[]" type="text"  value="" style="width:25% !important;"><input  id="north2" name="north2[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="north3" name="north3[]" type="text"  readonly value="" style="width:25% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="north4" name="north4[]" type="text" value="" style="width:25% !important;"><input  id="north5" name="north5" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="north6" name="north6[]" type="text" readonly value="" style="width:25% !important;margin-left: 3px;"></td>
					 <td><input  id="north7" name="north7[]" type="text" value="" style="width:25% !important;"><input  id="north8" name="north8[]" type="text" value="<?php echo $project1['hdlinefile'];?>" style="width:25% !important;margin-left: 3px;"><input  id="north9" name="north9[]" type="text" readonly value="" style="width:25% !important;margin-left: 3px;"></td>
                  ...
                  <tr>
					...
					<td colspan="2"><textarea id="southboundary" name="southboundary[]" rows="3" cols="23" style="    height: 4rem;">
				     ...
				     <td class="pattashow"><input  id="south1" name="south1[]" type="text" value="" style="width:25% !important;"><input  id="south2" name="south2[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="south3" name="south3[]" type="text" readonly value=""style="width:25% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="south4" name="south4[]" type="text" value="" style="width:25% !important;"><input  id="south5" name="south5[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="south6" name="south6[]" type="text" readonly value="" style="width:25% !important;margin-left: 3px;" style="width:25% !important;margin-left: 3px;"></td>
					 <td><input  id="south7" name="south7[]" type="text" value="" style="width:25% !important;"><input  id="south8" name="south8[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="south9" name="south9[]" type="text" readonly value="" style="width:25% !important;margin-left: 3px;"></td>
                 ...
                 <tr>
					...
					<td colspan="2"><textarea id="eastboundary" name="eastboundary[]" rows="3" cols="23" style="    height: 4rem;">
				      ...
				      <td class="pattashow"><input  id="east1" name="east1[]" type="text" value="" style="width:25% !important;"><input  id="east2" name="east2[]" type="text" value=""  style="width:25% !important;margin-left: 3px;"><input  id="east3" name="east3[]" type="text" readonly value="" style="width:25% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="east4" name="east4[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="east5" name="east5[]" type="text" value=""  style="width:25% !important;margin-left: 3px;"><input  id="east6" name="east6[]" type="text" readonly value="" style="width:25% !important;margin-left: 3px;"></td>
					 <td><input  id="east7" name="east7[]" type="text" value=""style="width:25% !important;"><input  id="east8" name="east8[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="east9" name="east9[]" type="text" readonly value=""style="width:25% !important;margin-left: 3px;"></td>
					...
					<td  colspan="2"><textarea id="westboundary" name="westboundary[]" rows="3" cols="23" style="    height: 4rem;">
				     ...
				     <td class="pattashow"><input  id="west1" name="west1[]" type="text" value="" style="width:25% !important;"><input  id="west2" name="west2[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="west3" name="west3[]" type="text" readonly value=""style="width:25% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="west4" name="west4[]" type="text" value=""  style="width:25% !important;margin-left: 3px;"><input  id="west5" name="west5[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="west6" name="west6[]" type="text" readonly value="" style="width:25% !important;margin-left: 3px;"></td>
					 <td><input  id="west7" name="west7[]" type="text" value=""  style="width:25% !important;"><input  id="west8" name="west8[]" type="text" value="" style="width:25% !important;margin-left: 3px;"><input  id="west9" name="west9[]" type="text" readonly value="" style="width:25% !important;margin-left: 3px;"></td>
