...
<input  id="call_client1" name="call_client" type="text" value="<?php echo $project1['call_client'];?>"  Style="margin-left: -14px !important;
    width: 104% !important;">
<label  for="call_client1" style="">Call Client</label>
</div>
