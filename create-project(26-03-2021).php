...
$ownerAddress1=implode("--,",$_POST['ownerAddress1']);
...
$distanceofbranch=$_POST['distanceofbranch'];
$distanceofrs=$_POST['distanceofrs']; 
...
<?php if($_REQUEST['step']=='step1' || $_REQUEST['step']==''){?>
 ...
 <thead>
<tr>
<th colspan="4" style="text-align: center;    background: #ddd;">PROVISIONAL	VALUATION REPORT</th>
</tr>	
<tr>
...
foreach($ownerAddress2 as $lengthacountproper2 =>$key) {	?><div id="a">	<select name="first_cap[]" style="display:block;width: 27%;"><option value="">Select</option><option <?php if($first_cap[$lengthacountproper2]=='Mr.') {?> selected <?php } ?> value="Mr.">Mr.</option><option <?php if($first_cap[$lengthacountproper2]=='Mrs.') {?> selected <?php } ?>  value="Mrs.">Mrs.</option></select><input  id="ownerAddress" name="ownerAddress[]" type="text" value="<?php echo $key;?>"  style=" width: 70%;"><select name="second_cap[]" style="display:block;width: 27%;"><option value="">Select</option><option <?php if($second_cap[$lengthacountproper2]=='S/o.') {?> selected <?php } ?> value="S/o.">S/o.</option><option <?php if($second_cap[$lengthacountproper2]=='W/o.') {?> selected <?php } ?> value="W/o.">W/o.</option></select><input  id="ownerAddress1" name="ownerAddress1[]" type="text" value="<?php echo $ownerAddress1[$lengthacountproper2];?>" style="width:80%;"><input type="button" class="btnRemove" value="X" style=" width: 10%;background: red;color: white;border-color: red;font-weight: bold;"/></div> <?php } } else { ?> <div id="a"><select name="first_cap[]" style="display:block;width: 27%;"><option value="">Select</option><option value="Mr.">Mr.</option><option value="Mrs.">Mrs.</option></select><input  id="ownerAddress" name="ownerAddress[]" type="text" value=""><select name="second_cap[]" style="display:block;width: 27%;"><option value="">Select</option><option value="S/o.">S/o.</option><option value="W/o.">W/o.</option></select><input  id="ownerAddress1" name="ownerAddress1[]" type="text" value=""></div> <?php } ?>
...
<th><div class="purchaseyescheck"><input  id="pdoorno" class="purchaseyescheck" name="pdoorno" type="text" value="<?php echo $project1['pdoorno'];?>"></div></th>
</tr>
<tr>
<th>ii) Street: </th>
...
<th><div class="purchaseyescheck"> <input  id="pstreet" class="purchaseyescheck" name="pstreet" type="text" value="<?php echo $project1['pstreet'];?>"></div></th>
</tr>
<tr>
<th>iii) Area: </th>
<th >   <input  id="oarea" name="oarea" type="text" value="<?php echo $project1['oarea'];?>"></th>
<th><div class="purchaseyescheck">iii) Area:	</div></th>
<th><div class="purchaseyescheck"><input  id="parea" class="purchaseyescheck" name="parea" type="text" value="<?php echo $project1['parea'];?>"></div></th>
</tr>
<tr>
<th>vi) Post: </th>
...
<th>ix) S.R.O <input  id="sro" name="sro" type="text" value="<?php echo $project1['sro'];?>"></th>
</tr>
<tr>
<th>iii) Area</th>
<th>  <input  id="propertyarea" name="propertyarea" type="text" value="<?php echo $project1['propertyarea'];?>"></th>
<th>iii) Patta No <input  id="pattano" name="pattano" type="text" value="<?php echo $project1['pattano'];?>"></th>
<th>x) Plot No  <input  id="plotno" name="plotno" type="text" value="<?php echo $project1['plotno'];?>"></th>
</tr>
<tr>
<th>iv) Village</th>
