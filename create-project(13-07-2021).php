...
if($report_name=='ARRUL ASSOCIATES') { $linkname="AA"; }if($report_name=='EVEREST ASSOCIATES') { $linkname="EA"; }
...
$lastfileno=str_replace("EA","",str_replace("AA","",$report_no1['file_no']));
...
<tr>
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> colspan="2"  <?php } else {?> colspan="1" <?php } ?> style="text-align: center;    background: white; border:1px solid #21058f;width:49%; "> PROVISIONAL VALUATION REPORT <?php if(1!=1) {?> <div class="input-field col s12 divheight loan firstborder" style="
    float: right;
    ">
...
</div> <?php } ?></th> <th style="width:0% "></th><th  colspan="1" style="text-align: center;     background: white;border:1px solid #f60707; width:49%; "> <div class="input-field divheight secondborder" style=""><select name="report_name" id="report_name"  class="select2 browser-default" style=" background: white;"> 
...
<option <?php if($project1['deed']=='Legal Deed') {?> Selected <?php } ?> value="Legal Deed">Legal Deed</option>
    ...
    margin-left: 10px;
    background: white;">Ref Document </label> </div> </td><td style="border:unset !important"><div class="input-field col s12 divheight  oldsf sixthborder" >  <input  id="deed_description" name="deed_description" type="text" value="<?php echo $project1['deed_description'];?>" style="margin-left: -14px !important;    width: 110%;"><label  for="deed_description" style=""></label></div></td></tr></table>	</th>
</tr>
</thead>
</table>
...
<br>
  <div class="file-field input-field" id="taxreceiptfile" style="    margin-top: -11px;">
              <div class="btn">
            <i class="material-icons dp48">file_upload</i>

           <input   name="taxreceiptfile[]" type="file" multiple>
              </div>
              <div class="file-path-wrapper">
			  <span class="taxreceiptfilepath" style="color: rgb(8, 44, 220);
    font-size: 10px;"></span>
	
                <input class="file-path validate" type="hidden" style="    width: 39%;
    background: green;
    font-size: 10px;
    color: white;
    padding: 0px;
...
{
?>
<div class="<?php echo $ftaxreceipt1['id']; ?>-444"><a target="_blank" href="<?php echo $web_url; ?>documents/tax/<?php echo $ftaxreceipt1['file_name'];?>">View</a> <a  class="switchery" id="<?php echo $ftaxreceipt1['id']; ?>-333" data-id="taxreceipt" style="cursor: pointer; " ><i class="material-icons">delete</i></a></div>
<?php } ?>
...
<br>
  ...
  <div class="file-field input-field" id="ebservicenofile" style="    margin-top: -11px;">
              <div class="btn">
            <i class="material-icons dp48">file_upload</i>

           <input   name="ebservicenofile[]" type="file" multiple>
              </div>
              <div class="file-path-wrapper">
			  <span class="ebservicenofilepath" style="color: rgb(8, 44, 220);
    font-size: 10px;"></span>
...
{
?>
<div class="<?php echo $ftaxreceipt1['id']; ?>-444"><a target="_blank" href="<?php echo $web_url; ?>documents/ebservice/<?php echo $ftaxreceipt1['file_name'];?>">View</a> <a  class="switchery" id="<?php echo $ftaxreceipt1['id']; ?>-333" data-id="ebservice" style="cursor: pointer; " ><i class="material-icons">delete</i></a></div>
<?php } ?>
...
<div class="file-field input-field" id="pattadtcpfile" style="    margin-top: -11px;">
              <div class="btn">
            <i class="material-icons dp48">file_upload</i>

           <input   name="pattadtcpfile[]" type="file" multiple>
              </div>
              <div class="file-path-wrapper">
			  <span class="pattadtcpfilepath" style="color: rgb(8, 44, 220);
    font-size: 10px;"></span>
...
{
?>
<div class="<?php echo $ftaxreceipt1['id']; ?>-444"><a target="_blank" href="<?php echo $web_url; ?>documents/pattadtcp/<?php echo $ftaxreceipt1['file_name'];?>">View</a> <a  class="switchery" id="<?php echo $ftaxreceipt1['id']; ?>-333" data-id="pattadtcp" style="cursor: pointer; " ><i class="material-icons">delete</i></a></div>
<?php } ?>
...
<div class="file-field input-field" id="approvalplanfile" style="    margin-top: -11px;">
              <div class="btn">
            <i class="material-icons dp48">file_upload</i>

           <input   name="approvalplanfile[]" type="file" multiple>
              </div>
              <div class="file-path-wrapper">
			  <span class="approvalplanfilepath" style="color: rgb(8, 44, 220);
    font-size: 10px;"></span>
...
{
?>
<div class="<?php echo $ftaxreceipt1['id']; ?>-444"><a target="_blank" href="<?php echo $web_url; ?>documents/approvalplan/<?php echo $ftaxreceipt1['file_name'];?>">View</a> <a  class="switchery" id="<?php echo $ftaxreceipt1['id']; ?>-333" data-id="approvalplan" style="cursor: pointer; " ><i class="material-icons">delete</i></a></div>
<?php } ?>
...
<div class="file-field input-field" id="hdlinefile" style="    margin-top: -11px;">
              <div class="btn">
            <i class="material-icons dp48">file_upload</i>

           <input   name="hdlinefile[]" type="file" multiple>
              </div>
              <div class="file-path-wrapper">
			  <span class="hdlinefilepath" style="color: rgb(8, 44, 220);
    font-size: 10px;"></span>
...
{
?>
<div class="<?php echo $ftaxreceipt1['id']; ?>-444"><a target="_blank" href="<?php echo $web_url; ?>documents/hdline/<?php echo $ftaxreceipt1['file_name'];?>">View</a> <a  class="switchery" id="<?php echo $ftaxreceipt1['id']; ?>-333" data-id="hdline" style="cursor: pointer; " ><i class="material-icons">delete</i></a></div>
<?php } ?>
...
<?php echo $westboundary[$countproper1];?></textarea></td>
 ...
 <tr>
					...
					<td colspan="2" style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;">As Per Manual<br><input  id="estent" name="estent[]"  type="number" value="<?php echo $estent[$countproper1];?>" style="width:60% !important;margin-left: 3px;"> <?php
	...
	<option value="" >Select</option>
                 <option <?php if($document_type[$countproper1]=='Sq ft') {?> selected <?php } ?> value="Sq ft" >Sq ft</option>
				  ...
				  <option <?php if($document_type[$countproper1]=='Sq m') {?> selected <?php } ?> value="Sq m" >Sq m</option>
					...
					</select><span id="pattatype"><?php echo $documentv; ?></span></td>
                  </tr>		
...
<?php echo $sale_details[$countproper1];?></textarea></td>
					<td colspan="2" style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;border-top: 1px solid gray;padding: 5px 8px !important;"><input  id="sale_from" name="sale_from[]"  type="number" value="<?php echo $sale_from[$countproper1];?>" style="    font-weight: bold;
    font-size: 18px;
    width: 30% !important;"> TO <input  id="sale_to" name="sale_to[]"  type="number" value="<?php echo $sale_to[$countproper1];?>"></td><td style="border-right: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;border-top: 1px solid gray;padding: 5px 8px !important;"><select name="sale_type[]" id="sale_type" style="display:block">
                  <option value="" >Select</option>
...
float:right;   
 ...
 <tr> <?php if(1!=1) {?>
				   ...
				   <td>Total Area if Any<input  id="anyarea" name="anyarea[]"  type="text" value="<?php echo $anyarea[$countproper1];?>"></td>
					...
					<td style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;">Total Area<br><input  id="totalarea" class="totalareatot" name="totalarea[]"  type="text" value="<?php echo $totalarea[$countproper1];?>"></td>
                     <td colspan="2" style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;" >Rate <span class="assignsq" id="assignsq"><?php echo $sale_type[$countproper1]; ?></span><br><input  id="totalrate" name="totalrate[]"  type="text" value="<?php echo $totalrate[$countproper1];?>"></td>
					 <td style="width:15%;border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;">Land Value Total<br><input  class="totallandvalue" id="totallandvalue" name="totallandvalue[]" readonly type="text" value="<?php echo $totallandvalue[$countproper1];?>">    </td>
...
if($('#taxreceipt').val() == "Yes" ){$('#taxreceiptfile').show(); $('#taxreceipt_name').show(); $('#call_client').show(); } 
...
$('#taxreceipt').change(function(){ if($(this).val() == "Yes" ){$('#taxreceiptfile').show(); $('#taxreceipt_name').show();  $('#call_client').show(); }else{$('#taxreceiptfile').hide(); $('#taxreceipt_name').val(''); $('#taxreceipt_name').hide();  $('#call_client').val(''); $('#call_client').hide();  }});
$('#ebserviceno').change(function(){ if($(this).val() == "Yes" ){$('#ebservicenofile').show(); $('#ebserviceno_name').show(); }else{$('#ebservicenofile').hide(); $('#ebserviceno_name').val(''); $('#ebserviceno_name').hide();}});
$('#pattadtcp').change(function(){ if($(this).val() == "Yes" ){$('#pattadtcpfile').show(); $('#pattadtcp_name').show();}else{$('#pattadtcpfile').hide();$('#pattadtcp_name').val(''); $('#pattadtcp_name').hide();}});
$('#approvalplan').change(function(){ if($(this).val() == "Yes" ){$('#approvalplanfile').show();   $('#approvalplan_name').show();}else{$('#approvalplanfile').hide();$('#approvalplan_name').val(''); $('#approvalplan_name').hide();}});
$('#hdline').change(function(){ if($(this).val() == "Yes" ){$('#hdlinefile').show();  $('#hdline_name').show(); }else{$('#hdlinefile').hide();  $('#hdline_name').val('');$('#hdline_name').hide();}});
