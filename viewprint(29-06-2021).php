...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-left:1px solid;border-right:1px solid;">Residential Address: </td>
                ...
                <tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>i)Door No</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>ii)Street</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>iii)Area</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>iv)Post</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>v)Taluk</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vi)District</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vi)Pincode</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vi)Contact</td>
...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-left:1px solid;border-right:1px solid;">Property Address: </td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>iv)Panchayat</td>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>: <?php echo ucwords($project1['propertyvillage']);?></td>
                </tr>
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>v)Taluk</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vii)Pincode</td>
				...
				<tr>
                  <td style="border:0px solid; height:20px;border-top: 1px solid;   width: 40%;">i)Land Mark</td>
                  <td style="border:0px solid;border-top: 1px solid;">: <?php echo ucwords($project1['landmark']);?></td>
                </tr>
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>ii) Nearest Bus Stop </td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>iii) Distance of Branch</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>iv) Distance of R.S</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>v) Nearest Main Road </td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?> <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vi) Civil Amenities</td>
...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;">Purchaser Address: </td>
                ...
                <tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>i) Door No</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>ii) Street</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>iii) Area</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>iv) Village</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>v) Taluk</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vi) District</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vi) Pincode</td>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vi) Contact</td>
...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;">Revenue Details: </td>
				 ...
				 <tr>
                  <td style="border:0px solid;height:20px;    width: 50%;">i) Old S.F No : <?php echo ucwords($project1['oldsfno']);?></td>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>viii) Ward No : <?php echo ucwords($project1['wardno']);?></td>

                </tr>
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>ii) S.F NO : <?php echo $project1['sfno'];?></td>
                  <td style="border:0px solid;">ix) Block No : <?php echo ucwords($project1['blockno']);?></td>
                </tr>
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>iii) R.S.F No : <?php echo ucwords($project1['rsfno']);?></td>
                  <td style="border:0px solid;">x) S.R.O:  <?php echo ucwords($project1['sro']);?></td>
                </tr>
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>> iv) Patta No : <?php echo $project1['pattano'];?></td>
                  <td style="border:0px solid;"></td>
                </tr>
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>v) Plot No: <?php echo ucwords($project1['plotno']);?></td>
                  <td style="border:0px solid;"></td>
                </tr>
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vi) Pymash No : <?php echo ucwords($project1['pymashno']);?></td>
                  <td style="border:0px solid;"></td>
                </tr>
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>vii) T.S.No : <?php echo ucwords($project1['tsno']);?></td>
                  <td style="border:0px solid;"></td>
                </tr>
	...
	?>	<div class="col m12 s12" style="">	
			...
			width: 95%" <?php } ?>>
              ...
              <tbody>
				...
				<tr>
                  <td style="border:0px solid;    border-right: 1px solid;    border-left: 1px solid;">Total Area <br> <span style="font-weight:bold;"><?php echo number_format($totalarea[$countproper1],2);?></td>
                  ...
                  <td style="border:0px solid;    border-right: 1px solid;">Guideline Rate<br><span style="font-weight:bold;">₹<?php echo number_format($guide_rate[$countproper1],2);?> <span style="font-weight:bold;"><?php echo number_format($guideselect[$countproper1],2);?></span></span>
</td>
				  <td style="border:0px solid;    border-right: 1px solid;">Guideline Value<br><span style="font-weight:bold;">₹<?php echo number_format($guidevalue[$countproper1],2);?></span>
</td>
			 ...
			 <?php if($countproper1!=$countotval)
				  {?>	<tr>
                  <td style="border-top:1px solid;    border-right: 1px solid;    border-left: 1px solid;">Type of Property <br> <span style="font-weight:bold;"><?php echo select_value_other("typeofproperty","name",$typeofproperty2[$countproper1]); ?></td>
                  <td style="border-top:1px solid;     border-right: 1px solid;">.Size of Plot<br><span style="font-weight:bold;"><?php echo select_value_other("sizeofplot","name",$sizeofplot2[$countproper1]); ?></span></td>
                  <td style="border-top:1px solid;     border-right: 1px solid;">Development to Site<br><span style="font-weight:bold;"><?php echo select_value_other("recentdevelopments","name",$recentdevelopmentsnear2[$countproper1]); ?></span></td>
                  <td style="border-top:1px solid;    border-right: 1px solid;">Class of Construction<br><span style="font-weight:bold;"><?php echo select_value_other("classofconstruction","name",$classofconstruction2[$countproper1]); ?></span>
</td>
				  <td style="border-top:1px solid;    border-right: 1px solid;">.Control Limit<br><span style="font-weight:bold;"><?php echo select_value_other("limits","name",$limits2[$countproper1]); ?></span>
</td>
...
<td style="border:1px solid;">1.Market Value</td><td style="border:1px solid;">₹<?php echo $project1['market_value'];?></td><?php } ?>
  ...
  <td <?php if($countproper1==$countotval)
    ...
    <?php if($countproper1==$countotval)
				  {?>
				  <td style="border:1px solid;">3.Forced value<br><?php if($project1['forced_percen1'])  {?><?php echo $project1['forced_percen1'];?>%<?php } ?></td><td style="border:1px solid;">₹<?php echo number_format($project1['forced_value'],2);?></td> <?php } ?>
