...
<tbody <?php if($countproper1>0) {?> class="newTR<?php echo $valdel; ?>" <?php } else { ?> class="newTR1"  <?php } ?>>
                 ...
                 <tr>
					...
					<td><input  id="westboundary" name="westboundary[]" type="text"  value="<?php echo $westboundary[$countproper1];?>"></td>
					 ...
					 <td><input  id="west7" name="west7[]" type="text" value="<?php echo $west7[$countproper1];?>"><input  id="west8" name="west8[]" type="text" value="<?php echo $west8[$countproper1];?>"><input  id="west9" name="west9[]" type="text" readonly value="<?php echo $west9[$countproper1];?>"></td>
...
if($project1['roof1']!='') {
	...
	<div id="a1" style="    margin-bottom: 11px;">
	<?php
foreach($roof2 as $lengthacountproper2 =>$key) {	?>	<div class="con1" style="  "><select name="roof1[]" id="roof" style="display:block;    border: 1px solid;
    margin-top: 33px;">
                  <option value="" selected>Roof</option>
				  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
...
if($project1['roof2']!='') {
	...
	<div id="a1" style="    margin-bottom: 11px;">
	<?php
foreach($roof2 as $lengthacountproper2 =>$key) {	?>	<div class="con1" style="  "><select name="roof2[]" id="roof" style="display:block;    border: 1px solid;
    margin-top: 33px;">
                  <option value="" selected>Roof</option>
				  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
...
if($project1['roof3']!='') {
	...
	<div id="a1" style="    margin-bottom: 11px;">
	<?php
foreach($roof2 as $lengthacountproper2 =>$key) {	?>	<div class="con1" style="  "><select name="roof3[]" id="roof" style="display:block;    border: 1px solid;
    margin-top: 33px;">
                  <option value="" selected>Roof</option>
				  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
...
if($project1['roof4']!='') {
	...
	<div id="a1" style="    margin-bottom: 11px;">
	<?php
foreach($roof2 as $lengthacountproper2 =>$key) {	?>	<div class="con1" style="  "><select name="roof4[]" id="roof" style="display:block;    border: 1px solid;
    margin-top: 33px;">
                  <option value="" selected>Roof</option>
				  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
