...
<section class="invoice-view-wrapper section">
  <div class="row">
    ...
    font-size: 15px;
    font-weight: bold;    margin-left: -100px;">VALUATION REPORT</span>
			 </div>
			 <div class="col m3 s3">
		     </div>
    ...
    <tbody>
				...
				<tr>
                  ...
                  <td style="border:0px solid;">:<?php $expld=explode("--",str_replace(","," ",$project1['ownerAddress']));?> 
				   <?php $i=0; foreach ($expld as $expld1) { $i++; echo $expld1; if($i>=1) { echo "<br>"; } } ?></td>
                </tr>
...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-left:1px solid;border-right:1px solid;">Property Address: </td>
				...
				<tr>
                  ...
                  <td style="border:0px solid;">: <?php echo $project1['distanceofbranch'];?> <?php if($project1['distanceofbranch']!='') {?>KM<?php } ?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;height:10px;">iv) Distance of R.S</td>
                  <td style="border:0px solid;height: 10px;">: <?php echo ucwords($project1['distanceofrs']);?> <?php if($project1['distanceofrs']!='') {?>KM<?php } ?></td>
                </tr>
				<tr>
...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;">Revenue Details: </td>
				 ...
				 <tr>
                  <td style="border:0px solid;height:10px;">i) Old S.F No : <?php echo ucwords($project1['oldsfno']);?></td>
                  <td style="border:0px solid;height:10px;">vii) Ward No : <?php echo ucwords($project1['wardno']);?></td>

                </tr>
				<tr>
                  <td style="border:0px solid;height: 10px;">ii) S.F NO : <?php echo $project1['sfno'];?></td>
                  <td style="border:0px solid;">vii) S.R.O:  <?php echo ucwords($project1['sro']);?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;height: 10px;">iii) Patta No : <?php echo $project1['pattano'];?></td>
                  <td style="border:0px solid;">vii) Plot No: <?php echo ucwords($project1['plotno']);?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;height: 10px;">iv) R.S.F No : <?php echo ucwords($project1['rsfno']);?></td>
                  <td style="border:0px solid;"></td>
                </tr>
				<tr>
                  <td style="border:0px solid;height: 10px;">v) Block No : <?php echo ucwords($project1['blockno']);?></td>
                  <td style="border:0px solid;"></td>
                </tr>
				<tr>
	...
	?>	<div class="col m12 s12" style="">		   
		...
		<!-- product details table-->
          <div class="invoice-product-details">
            <table class="striped responsive-table" style="border-right:1px solid;border-left:1px solid;width: 94.8%;margin-left:4px;">
