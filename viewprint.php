...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;">Revenue Details: </td>
	...
	<td <?php if($countot2=='1') {?>  style="border:0px solid;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>
	 <table style="border:unset !important;    margin-left: 0px;"><tr><td style="border:unset !important;    width: 50%;">  R.S.F No  <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['rsfno']);?></p></td></tr></table>
				...
				<tr>
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>Village<span style="float:right">:</span></td>
...
<?php 
 $total_asper_plan=0;
if($copy_project_table1['asperdesc_prop1']!='' ) 
{ ?>
<p style="line-height:30px;text-align:center;font-weight:bloder;">As Per Plan1</p>
            <table class="striped responsive-table" style="margin-left: -11px;
...
$asperdesc_prop1=explode(",",$copy_project_table1['asperdesc_prop1']);				
$asperlengtha1=explode(",",$copy_project_table1['asperlengtha1']);	
$asperlengthb1=explode(",",$copy_project_table1['asperlengthb1']);
$asperlength1=explode(",",$copy_project_table1['asperlength1']);
$asperbreadtha1=explode(",",$copy_project_table1['asperbreadtha1']);
$asperbreadthb1=explode(",",$copy_project_table1['asperbreadthb1']);
$asperbreadth1=explode(",",$copy_project_table1['asperbreadth1']);
$asperarea1=explode(",",$copy_project_table1['asperarea1']);
$asperrate1=explode(",",$copy_project_table1['asperrate1']);
$asperyear1=explode(",",$copy_project_table1['asperyear1']);
$asperage1=explode(",",$copy_project_table1['asperage1']);
$asperroofselect1=explode(",",$copy_project_table1['asperroofselect1']);
$asperdeprciation1=explode(",",$copy_project_table1['asperdeprciation1']);
$aspertotal1=explode(",",$copy_project_table1['aspertotal1']);
$asperspaceall1=explode(",",$copy_project_table1['asperspaceall1']);
$asperoveralltotal1=explode(",",$copy_project_table1['asperoveralltotal1']);
$asperamountval1=explode(",",$copy_project_table1['asperamountval1']);
$asperpercentage1=explode(",",$copy_project_table1['asperpercentage1']);
$asperdep_per1=explode(",",$copy_project_table1['asperdep_per1']);

$i=0;
foreach($asperlengtha1 as $lengthacountproper =>$key) {$i++;	

$roofselectid=$asperroofselect1[$lengthacountproper]; 
$roof = mysqli_query($conn,"SELECT * FROM `roof` where 1=1 and id='$roofselectid' ");   
$roof1 = mysqli_fetch_array($roof);
$total2a+=$total[$lengthacountproper];
...
?>	
                <tr>
                  <td style="border:1px solid;"><?php echo $i; ?></td>
				  <td style="border:1px solid;"> <?php echo $asperspaceall1[$lengthacountproper]; ?></td>
                  <td style="border:1px solid;"><?php echo $asperdesc_prop1[$lengthacountproper]; ?></td>
				    <td style="border:1px solid;"><?php echo $asperpercentage1[$lengthacountproper]; ?></td>
				    <td style="border:1px solid;"> <?php echo $asperlengtha1[$lengthacountproper]; ?></td> 
                  <td style="border:1px solid;"> <?php echo $asperbreadth1[$lengthacountproper]; ?></td>
				  <td style="border:1px solid;"><?php echo $asperarea1[$lengthacountproper]; ?></td>
				   <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperrate1[$lengthacountproper]); ?></td>
				  <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperamountval1[$lengthacountproper]); ?></td>
				    <td style="border:1px solid;"> <?php echo $asperyear1[$lengthacountproper]; ?></td>
					 <td style="border:1px solid;"> <?php echo $asperage1[$lengthacountproper]; ?></td>
					 <td style="border:1px solid;"> <?php echo $roof1['name']; ?></td>
					 <td style="border:1px solid;"> <?php if($asperdep_per1[$lengthacountproper]!='NaN') {?> <?php echo moneyFormatIndia($asperdep_per1[$lengthacountproper]); ?> <?php } ?></td>
					  <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperdeprciation1[$lengthacountproper]); ?></td>
					   <td style="border:1px solid;"> <?php echo moneyFormatIndia($aspertotal1[$lengthacountproper]); ?></td>
...
<?php } ?>			
				<tr>
                  ...
                  <td colspan="14" style="text-align:right;border:1px solid;">Grand Total	</td>
					   ...
					   <td colspan="1" style="text-align:left;border:1px solid;"> <?php
             if($copy_project_table1['asperoveralltotal1']!='' && $copy_project_table1['asperoveralltotal1'] !=0)
             {
              $total_asper_plan+=$copy_project_table1['asperoveralltotal1'];
             }
              echo moneyFormatIndia($copy_project_table1['asperoveralltotal1']);?></td>
...
if($copy_project_table1['asperdesc_prop2']!='' ) 
{ ?>
<p style="line-height:30px;text-align:center;font-weight:bloder;">As Per Plan2</p>
            <table class="striped responsive-table" style="    margin-left: -11px;border-top:1px solid black;
    width: 99%;">
              <thead>
...
$asperdesc_prop2=explode(",",$copy_project_table1['asperdesc_prop2']);				
$asperlengtha2=explode(",",$copy_project_table1['asperlengtha2']);	
$asperlengthb2=explode(",",$copy_project_table1['asperlengthb2']);
$asperlength2=explode(",",$copy_project_table1['asperlength2']);
$asperbreadtha2=explode(",",$copy_project_table1['asperbreadtha2']);
$asperbreadthb2=explode(",",$copy_project_table1['asperbreadthb2']);
$asperbreadth2=explode(",",$copy_project_table1['asperbreadth2']);
$asperarea2=explode(",",$copy_project_table1['asperarea2']);
$asperrate2=explode(",",$copy_project_table1['asperrate2']);
$asperyear2=explode(",",$copy_project_table1['asperyear2']);
$asperage2=explode(",",$copy_project_table1['asperage2']);
$asperroofselect2=explode(",",$copy_project_table1['asperroofselect2']);
$asperdeprciation2=explode(",",$copy_project_table1['asperdeprciation2']);
$aspertotal2=explode(",",$copy_project_table1['aspertotal2']);
$asperspaceall2=explode(",",$copy_project_table1['asperspaceall2']);
$asperoveralltotal2=explode(",",$copy_project_table1['asperoveralltotal2']);
$asperamountval2=explode(",",$copy_project_table1['asperamountval2']);
$asperpercentage2=explode(",",$copy_project_table1['asperpercentage2']);
$asperdep_per2=explode(",",$copy_project_table1['asperdep_per2']);

$i=0;
foreach($asperlengtha2 as $lengthacountproper =>$key) {$i++;	

$roofselectid=$asperroofselect2[$lengthacountproper]; 
$roof = mysqli_query($conn,"SELECT * FROM `roof` where 1=1 and id='$roofselectid' ");   
$roof1 = mysqli_fetch_array($roof);
$total2a+=$total[$lengthacountproper];
...
?>	
                <tr>
                  <td style="border:1px solid;"><?php echo $i; ?></td>
				  <td style="border:1px solid;"> <?php echo $asperspaceall2[$lengthacountproper]; ?></td>
                  <td style="border:1px solid;"><?php echo $asperdesc_prop2[$lengthacountproper]; ?></td>
				    <td style="border:1px solid;"><?php echo $asperpercentage2[$lengthacountproper]; ?></td>
				    <td style="border:1px solid;"> <?php echo $asperlengtha2[$lengthacountproper]; ?></td> 
                  <td style="border:1px solid;"> <?php echo $asperbreadth2[$lengthacountproper]; ?></td>
				  <td style="border:1px solid;"><?php echo $asperarea2[$lengthacountproper]; ?></td>
				   <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperrate2[$lengthacountproper]); ?></td>
				  <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperamountval2[$lengthacountproper]); ?></td>
				    <td style="border:1px solid;"> <?php echo $asperyear2[$lengthacountproper]; ?></td>
					 <td style="border:1px solid;"> <?php echo $asperage2[$lengthacountproper]; ?></td>
					 <td style="border:1px solid;"> <?php echo $roof1['name']; ?></td>
					 <td style="border:1px solid;"> <?php if($asperdep_per2[$lengthacountproper]!='NaN') {?> <?php echo moneyFormatIndia($asperdep_per2[$lengthacountproper]); ?> <?php } ?></td>
					  <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperdeprciation2[$lengthacountproper]); ?></td>
					   <td style="border:1px solid;"> <?php echo moneyFormatIndia($aspertotal2[$lengthacountproper]); ?></td>
...
<?php } ?>			
             ...
             if($copy_project_table1['asperoveralltotal2']!='' && $copy_project_table1['asperoveralltotal2'] !=0)
             {
              $total_asper_plan+=$copy_project_table1['asperoveralltotal2'];
             }
              echo moneyFormatIndia($copy_project_table1['asperoveralltotal2']);?></td>
...
if($copy_project_table1['asperdesc_prop3']!='' ) 
{ ?>
<p style="line-height:30px;text-align:center;font-weight:bloder;">As Per Plan3</p>
            <table class="striped responsive-table" style="    margin-left: -11px;border-top:1px solid black;
    width: 99%;">
              <thead>
...
$asperdesc_prop3=explode(",",$copy_project_table1['asperdesc_prop3']);				
$asperlengtha3=explode(",",$copy_project_table1['asperlengtha3']);	
$asperlengthb3=explode(",",$copy_project_table1['asperlengthb3']);
$asperlength3=explode(",",$copy_project_table1['asperlength3']);
$asperbreadtha3=explode(",",$copy_project_table1['asperbreadtha3']);
$asperbreadthb3=explode(",",$copy_project_table1['asperbreadthb3']);
$asperbreadth3=explode(",",$copy_project_table1['asperbreadth3']);
$asperarea3=explode(",",$copy_project_table1['asperarea3']);
$asperrate3=explode(",",$copy_project_table1['asperrate3']);
$asperyear3=explode(",",$copy_project_table1['asperyear3']);
$asperage3=explode(",",$copy_project_table1['asperage3']);
$asperroofselect3=explode(",",$copy_project_table1['asperroofselect3']);
$asperdeprciation3=explode(",",$copy_project_table1['asperdeprciation3']);
$aspertotal3=explode(",",$copy_project_table1['aspertotal3']);
$asperspaceall3=explode(",",$copy_project_table1['asperspaceall3']);
$asperoveralltotal3=explode(",",$copy_project_table1['asperoveralltotal3']);
$asperamountval3=explode(",",$copy_project_table1['asperamountval3']);
$asperpercentage3=explode(",",$copy_project_table1['asperpercentage3']);
$asperdep_per3=explode(",",$copy_project_table1['asperdep_per3']);

$i=0;
foreach($asperlengtha3 as $lengthacountproper =>$key) {$i++;	

$roofselectid=$asperroofselect3[$lengthacountproper]; 
$roof = mysqli_query($conn,"SELECT * FROM `roof` where 1=1 and id='$roofselectid' ");   
$roof1 = mysqli_fetch_array($roof);
$total2a+=$total[$lengthacountproper];
...
?>	
                <tr>
                  <td style="border:1px solid;"><?php echo $i; ?></td>
				  <td style="border:1px solid;"> <?php echo $asperspaceall3[$lengthacountproper]; ?></td>
                  <td style="border:1px solid;"><?php echo $asperdesc_prop3[$lengthacountproper]; ?></td>
				    <td style="border:1px solid;"><?php echo $asperpercentage3[$lengthacountproper]; ?></td>
				    <td style="border:1px solid;"> <?php echo $asperlengtha3[$lengthacountproper]; ?></td> 
                  <td style="border:1px solid;"> <?php echo $asperbreadth3[$lengthacountproper]; ?></td>
				  <td style="border:1px solid;"><?php echo $asperarea3[$lengthacountproper]; ?></td>
				   <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperrate3[$lengthacountproper]); ?></td>
				  <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperamountval3[$lengthacountproper]); ?></td>
				    <td style="border:1px solid;"> <?php echo $asperyear3[$lengthacountproper]; ?></td>
					 <td style="border:1px solid;"> <?php echo $asperage3[$lengthacountproper]; ?></td>
					 <td style="border:1px solid;"> <?php echo $roof1['nam3']; ?></td>
					 <td style="border:1px solid;"> <?php if($asperdep_per3[$lengthacountproper]!='NaN') {?> <?php echo moneyFormatIndia($asperdep_per3[$lengthacountproper]); ?> <?php } ?></td>
					  <td style="border:1px solid;"> <?php echo moneyFormatIndia($asperdeprciation3[$lengthacountproper]); ?></td>
					   <td style="border:1px solid;"> <?php echo moneyFormatIndia($aspertotal3[$lengthacountproper]); ?></td>
...
<?php } ?>			
             ...
             if($copy_project_table1['asperoveralltotal3']!='' && $copy_project_table1['asperoveralltotal3'] !=0)
             {
              $total_asper_plan+=$copy_project_table1['asperoveralltotal3'];
             }
             echo moneyFormatIndia($copy_project_table1['asperoveralltotal3']);?></td>
...
<?php $service_tot=0;$amenities_tot=0; $totalall=($copy_project_table1['overalltotal']+$copy_project_table1['overalltotal1']+$copy_project_table1['overalltotal2']+$copy_project_table1['overalltotal3']);?>
		  </div>
	
	  <div class="row invoice-info">

            <div class="col m6 s12 mr-0 pr-0" style="width: 48.3% !important;">
			<table class="striped responsive-table" style="border-right:0px solid;border-left:1px solid;border-top:1px solid;border-bottom:1px solid;margin-bottom: 5px;">
    <tbody>
	           <tr >
    ...
    margin-left: -6px;"> <tr><?php  $drivercheckedval=explode(",",$project1['waterall']);
				 ...
				 <td <?php if($cd==$countval) {?>  <?php } else {?> style="border-right:1px solid;text-align: center;" <?php } ?>><?php echo $project1[$namm];?></td>
                  ...
                  <td style="border:0px solid;border-bottom:1px solid;    height: 22px;border-right:1px solid; "><?php if($project1['watersupplyarrangementsRs']!='') {?> Rs. <?php 
                    $service_tot+=$project1['watersupplyarrangementsRs']; 
                    echo moneyFormatIndia($project1['watersupplyarrangementsRs']);?><?php } ?></td>
                </tr>
				 <tr>
                  <td style="border:0px solid;border-bottom:1px solid;border-right:1px solid;    height: 22px;">Drainage Arrangements (Rs)	</td>
                  <td style="border:0px solid;border-bottom:1px solid;    height: 22px;border-right:1px solid; "><?php if($project1['drainagearrangementsRs']!='') {?> Rs. <?php 
                    $service_tot+=$project1['drainagearrangementsRs']; 
                    echo moneyFormatIndia($project1['drainagearrangementsRs']);?><?php } ?></td>
                </tr>
				 <tr>
	...
	<tr><td style="border-top: 1px solid;;border-right:1px solid;    height: 17px;text-align: center;" ><?php echo $project1['compoundwallL1'];?></td><td style="border-top: 1px solid;border-right:1px solid;text-align: center;" ><?php echo $project1['compoundwallL2'];?></td><td style="border-top: 1px solid;border-right:1px solid;" ><?php echo $project1['compoundwallL'];?></td><td style="border-top: 1px solid;text-align: center;" ><?php echo moneyFormatIndia($project1['compoundwallrate']);?></td></tr>
                  ...
                  <td style="border:0px solid;border-bottom:1px solid;    height: 22px;border-right:1px solid; "><?php if($project1['compoundwallRs']!='') {?> Rs. <?php 
                    $service_tot+=$project1['compoundwallRs']; 
                    echo moneyFormatIndia($project1['compoundwallRs']);?><?php } ?></td>
                </tr>
				 <tr>
	...
	<tr><td style="border-top: 1px solid;;border-right:1px solid;    height: 17px;text-align: center;" ><?php echo $project1['pase1_service'];?></td><td style="border-top: 1px solid;border-right:1px solid;text-align: center;" ><?php echo $project1['pase1_rate'];?></td><td style="border-top: 1px solid;border-right:1px solid;text-align: center;" ><?php echo $project1['pase2_service'];?></td><td style="border-top: 1px solid;text-align: center;" ><?php echo $project1['pase2_rate'];?></td></tr>
                  ...
                  <td style="border:0px solid;border-bottom:1px solid;    height: 22px;border-right:1px solid; "><?php if($project1['ebdepositRs']!='') {?> Rs. <?php 
                    $service_tot+=$project1['ebdepositRs']; 
                    echo moneyFormatIndia($project1['ebdepositRs']);?><?php } ?></td>
                </tr>
				 <tr>
                  ...
                  <td style="border:0px solid;border-bottom:1px solid;    height: 22px;border-right:1px solid; "><?php if($project1['paverrs']!='') {?> Rs. <?php 
                    $service_tot+=$project1['paverrs']; 
                    echo moneyFormatIndia($project1['paverrs']);?><?php } ?></td>
                </tr>	

                <tr>
                  <td style="border:0px solid;border-bottom:1px solid;border-right:1px solid;    height: 22px;"> Total
                </td>
                  <td style="border:0px solid;border-bottom:1px solid;    height: 22px;border-right:1px solid; "> Rs. <?php echo moneyFormatIndia($service_tot);?></td>
                </tr> 		
     ...
     <div class="col m6 s12 ml-0 pl-0" style="width: 48.3% !important;">
      <table class="striped responsive-table" style="border-right:0px solid;border-left:0px solid;border-top:1px solid;border-bottom:1px solid;margin-bottom: 5px;">
    <tbody>
            <tr >
      
                  <td colspan="3" style="border:0px solid;border-bottom:1px solid;    font-size: 13px;text-align:center;border-right:1px solid;">Amenities       
</td>
...
<?php foreach($convert_to_array as $servicessadd) {$v++;?>
         <tr>
                  <td style="border:0px solid;border-bottom:1px solid;border-right:1px solid;border-left:1px solid;    height: 22px;"><?php echo $servicessadd;?> (Rs)  </td>
...
<?php } ?>
         <tr>
                  <td style="border:0px solid;border-right:1px solid;border-left:1px solid;    height: 22px;">Total</td>
                  <td style="border:0px solid;    height: 22px;border-right:1px solid; "><?php if($project1['serviceovertotal']!='') {?> Rs. <?php echo moneyFormatIndia($project1['serviceovertotal']-$service_tot);?><?php } ?></td>
                </tr>
...
<?php $asper_total_sum=0; ?>

    <div class="row invoice-info" style="    width: 91.6% !important;
    margin-top: 5px;margin-left: 20px;
    margin-bottom: 55px;">
        <p style="font-size: 13px;">Total Abstract of Entire Property</p>
      <table class="striped responsive-table">
        <tbody>
            <tr>
              <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;font-size: 11px;"></td>
              <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;font-size: 11px;">Description</td>
              <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;font-size: 11px;"></td>
              <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;font-size: 11px;">As per Plan</td>
              <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;font-size: 11px;">As per Actual</td>
            </tr>                          
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;">Part-A</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;">Land</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php 
                if($project1['landtotal']!='' && $project1['landtotal'] >0)
                {
                  $asper_total_sum+=$project1['landtotal'];
                }                
                echo moneyFormatIndia($project1['landtotal']);?></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($project1['landtotal']);?></td>
            </tr>
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;">Part-B</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;">Building</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php 
                if($total_asper_plan!='' && $total_asper_plan >0)
                {
                  $asper_total_sum+=$total_asper_plan;
                }
                echo moneyFormatIndia($total_asper_plan); ?></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($project1['buildingtotal']); ?></td>
            </tr>
                                   
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;">Part-C</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;">Service</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php 
              if($project1['serviceovertotal']!='' && $project1['serviceovertotal'] >0)
                {
                  $asper_total_sum+=$project1['serviceovertotal'];
                }
              echo moneyFormatIndia($service_tot);?> </td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($service_tot);?></td>
            </tr>
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;">Part-D</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;">Amenities</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">
              ₹ <?php echo moneyFormatIndia($project1['serviceovertotal']-$service_tot);?> </td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">
              ₹ <?php echo moneyFormatIndia($project1['serviceovertotal']-$service_tot);?></td>
            </tr>
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;"></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;"><b style="font-weight: 900;">Total</b></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($asper_total_sum); ?> </td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($project1['alltotal']);?></td>
            </tr>
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;"></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;"><b style="font-weight: 900;">Market Value of the Property</b></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($asper_total_sum);?> </td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($project1['newmarkettotal']);?></td>
            </tr>
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;"></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;"><b style="font-weight: 900;">Realizable Value of the Property
</b></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">
              ₹ <?php
              $cal_rea_amt=$asper_total_sum;
              $cal_rea_per=$project1['reasonable_perce1'];
              echo moneyFormatIndia($cal_rea_amt*$cal_rea_per/100); ?> </td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($project1['newreasontotal']); ?></td>
            </tr>
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;"></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;"><b style="font-weight: 900;">Forced Value of the Property
</b></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php
              if($project1['forced_percen1']!="")
              {
                $str_arr = explode ("%", $project1['forced_percen1']); 
                if($str_arr[0]!="")
                {
                  $cal_rea_amt=$asper_total_sum;
                  $cal_rea_per=$str_arr[0];  
                  echo moneyFormatIndia($cal_rea_amt*$cal_rea_per/100);
                }
             }
             else
              {
              ...
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($project1['newforcedtotal']);?></td>
            </tr>                          
            <tr>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:10%;"></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:35%;"><b style="font-weight: 900;">Guideline Value of the Property
</b></td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:5%;text-align:center;">:</td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ 
                <?php 
                $total_guide=0;
                if($project1['guideline_value']!="" && $project1['guideline_value']!=0)
                {
                  $total_guide+=$project1['guideline_value'];
                }
                if($total_asper_plan!="" && $total_asper_plan!=0)
                {
                  $total_guide+=$total_asper_plan;
                }
                if($project1['serviceovertotal']!="" && $project1['serviceovertotal']!=0)
                {
                  $total_guide+=$project1['serviceovertotal'];
                }
                echo moneyFormatIndia($total_guide); 
                ?> 
              </td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo  $alltot=moneyFormatIndia(($project1['newalltotal'])); ?></td>
            </tr>                          
        </tbody>
      </table> 
</div>
