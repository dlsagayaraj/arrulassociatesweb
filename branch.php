    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          <h4 class="card-title">BRANCH <a class="btn btn-outline-darker" style="    padding-right: 8px;
    padding-left: 8px;
    font-size: 14px;
    padding-top: 0px;
		  padding-bottom: 0px;float:right;" href="<?php echo $web_url; ?>create-branch">CREATE BRANCH </a></h4>
          <div class="row">
            <div class="col s12">
...
$i=0;
$user = mysqli_query($conn,"SELECT * FROM `branch` where 1=1 and delete_status='0' order by branch asc");   
...
?>
                    <tr class="post <?php echo $user1['id']; ?>-444" id="<?php echo $user1['id']; ?>-444">
					 <td><?php echo $i;?></td>
                     <td><a href="<?php echo $web_url; ?>create-branch-edit-<?php echo  base64_encode($user1['id']); ?>"><span style="color:orange;"><?php echo $user1['branch'];?></span></a></td>
				
						<td><a href="<?php echo $web_url; ?>create-branch-edit-<?php echo base64_encode($user1['id']); ?>" style="color:green"><i class="material-icons dp48">edit</i></td>
