...
.input-field label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;width: 29%;
}
.purchase  label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;width: 30%;
}
.company  label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;width: 21%;
}
.ins  label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;width: 13%;
}
.loan  label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;    width: 24%;
}
.ownera  label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;    width: 36%;
}
.ownera1  label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;    width: 36%;
}
.date  label.active {
width: 100%; color: rgba(48,48,48,.7);top: -7px;background: white;    width: 6%;
}
...
border:1px solid #f60707 !important ;box-shadow:0 1px 0 0 #f60707 !important ;
}
...
<?php if($_REQUEST['step']=='step1' || $_REQUEST['step']==''){?>
 ...
 <thead>
<tr>
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> colspan="2"  <?php } else {?> <?php } ?> style="text-align: center;background: white; border:1px solid #21058f;width:49%; ">PROVISIONAL VALUATION REPORT </th> <th style="width:1% "></th><th style="text-align: center;     background: white;border:1px solid #f60707; width:49%; "> <div class="input-field divheight secondborder"><select name="report_name" id="report_name"  class="select2 browser-default" style=" background: white;"> 
...
<th style="border:1px solid #f60707; "><div class="input-field col s12 divheight date secondborder" style="    height: 31px !important;"><input  id="date" name="date" type="date" value="<?php echo $project1['date'];?>"  style=" margin-left: -14px !important;
...
<tr>
<th style="border:1px solid #21058f;">  <div class="input-field col s12 divheight company firstborder"> <textarea id="companyName" name="companyName" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['companyName'];?>
</textarea><label  for="companyName" style="">Company Name</label></div></th><th></th>
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border:1px solid #f60707; "><div class="input-field col s12 divheight secondborder"><input  id="advanceAmount" name="advanceAmount" type="number" value="<?php echo $project1['advanceAmount'];?>"  style=" margin-left: -14px !important;
...
<th><div class="purchaseyescheck"><input  id="pcontact" class="purchaseyescheck" name="pcontact" type="text" value="<?php echo $project1['pcontact'];?>"></div></th>
	...
	<table class="highlight" style="    margin-top: 6px;">
 <thead>
<tr style="background: white;">
<th style="width:50%;border:1px solid #009933;">Residential Address: </th> <th style="width:1%;"></th>
...
<tr>
<th style="border:1px solid #009933;"><div class="input-field col s12 divheight  address thirdborder"><textarea id="odoorno" name="odoorno" rows="3" cols="23" style="    height: 3rem; margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['odoorno'];?>
</textarea><label  for="odoorno" style="">Door No </label></div></th>
<th style="width:1%;"></th>
<th style="border:1px solid #05529f;"><div class="input-field col s12 divheight address purchaseyescheck fourthborder"><textarea id="pdoorno" class="purchaseyescheck"  name="pdoorno" rows="3" cols="23" style="    height: 3rem; margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['pdoorno'];?>
...
<tr>
<th style="border:1px solid #009933;"> <div class="input-field col s12 divheight street thirdborder"><textarea id="oarea" name="oarea" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['oarea'];?>
</textarea><label  for="oarea" style="">Area  </label></div></th>
<th style="width:1%;"></th>
<th style="border:1px solid #05529f;"><div class="input-field col s12 divheight street purchaseyescheck fourthborder"><textarea id="parea" class="purchaseyescheck" name="parea"  rows="3" cols="23" style="   height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['parea'];?>
...
<tr>
<th style="border:1px solid #009933;"><div class="input-field col s12 divheight street thirdborder">  <input  id="otaluk" name="otaluk" type="text" value="<?php echo $project1['otaluk'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="otaluk" style="">Taluk </label></div></th>
	<th style="width:1%;"></th>
<th style="border:1px solid #05529f;"><div class="input-field col s12 divheight street purchaseyescheck fourthborder"><input  id="ptaluk" class="purchaseyescheck" name="ptaluk" type="text" value="<?php echo $project1['ptaluk'];?>" style="margin-left: -14px !important;
...
<tr>
<th style="border:1px solid #009933;"><div class="input-field col s12 divheight contact thirdborder"> <input  id="opincode" name="opincode" type="text" value="<?php echo $project1['opincode'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="opincode" style="">Pincode </label></div></th>
	<th style="width:1%;"></th>
<th style="border:1px solid #05529f;"><div class="input-field col s12 divheight contact purchaseyescheck fourthborder"><input  id="ppincode" class="purchaseyescheck" name="ppincode" type="text" value="<?php echo $project1['ppincode'];?>" style="margin-left: -14px !important;
...
<?php } else {?>
 ...
 <table class="highlight" style="    margin-top: 6px;    margin-bottom: 5px;    width: 101%;">
 <thead>
<tr style="">
...
<tr>
<th style="width: 39%;border:1px solid #ff0080;"><div class="input-field col s12 divheight  address fifthborder"><textarea id="propertydoorno" name="propertydoorno" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['propertydoorno'];?>
...
<tr>
<th style="border:1px solid #ff0080;">   <div class="input-field col s12 divheight  address fifthborder"><textarea id="propertyarea" name="propertyarea" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['propertyarea'];?>
...
<tr>
<th style="border:1px solid #ff0080;"><div class="input-field col s12 divheight  address fifthborder">  <input  id="propertytaluk" name="propertytaluk" type="text" value="<?php echo $project1['propertytaluk'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="propertytaluk" style="">Taluk </label> </div></th><th></th>
<th style="border:1px solid #c300dc;"><div class="input-field col s12 divheight  address sixthborder"><input  id="plotno" name="plotno" type="text" value="<?php echo $project1['plotno'];?>" style=" margin-left: -14px !important;
...
<tr>
<th style="border:1px solid #ff0080;"><div class="input-field col s12 divheight  contact fifthborder"> <input  id="propertypincode" name="propertypincode" type="text" value="<?php echo $project1['propertypincode'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="propertypincode" style="">Pincode</label> </div> </th><th></th>
<th style="border:1px solid #c300dc;"><div class="input-field col s12 divheight  address sixthborder"><input  id="sro" name="sro" type="text" value="<?php echo $project1['sro'];?>" style="margin-left: -14px !important;"><label  for="sro" style="">S.R.O </label></div></th>
</tr>
</thead>
</table>
 <table class="highlight" style="    margin-top: 6px;    margin-bottom: 5px;">
 <thead>
<tr>
<th style="border:1px solid #139830;width:50%;"><div class="input-field col s12 divheight  sro seventhborder"><input  id="landmark" name="landmark" type="text" value="<?php echo $project1['landmark'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="landmark" style="">Land Mark</label> </div></th>	<th style="width:1%;"></th>
...
<tr>
<th style="border:1px solid #139830;"><div class="input-field col s12 divheight  oldsf seventhborder"><input  id="nearestbustop" name="nearestbustop" type="text" value="<?php echo $project1['nearestbustop'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="nearestbustop" style="">Nearest Bus Stop</label> </div></th>	<th></th>
<th style="border:1px solid #082cdc;"><div class="input-field eighthborder"><select name="taxreceipt"  id="taxreceipt" style="display:block;">
<option value="" >Tax Receipt</option>
<option <?php if($project1['taxreceipt']=='Yes') {?> Selected <?php } ?>  value="Yes">Yes</option>
<option <?php if($project1['taxreceipt']=='No') {?> Selected <?php } ?> value="No">No</option>
</select>
...
<th style="border:1px solid #139830;"> <div class="input-field col s12 divheight  distanceofbranch seventhborder"><input  id="distanceofbranch" name="distanceofbranch" type="text" value="<?php echo $project1['distanceofbranch'];?>"style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="distanceofbranch" style="">Distance of Branch (KM) </label> </div></th>	<th></th>
...
<tr>
<th style="border:1px solid #139830;"><div class="input-field col s12 divheight  oldsf seventhborder"><input  id="distanceofrs" name="distanceofrs" type="text" value="<?php echo $project1['distanceofrs'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="distanceofrs" style="">Distance of R.S  (KM)</label></div>
</th>	<th></th>
<th style="border:1px solid #082cdc;"><div class="input-field eighthborder"><select name="pattadtcp" id="pattadtcp" style="display:block;">
<option value="" >Patta / DTCP</option>
<option <?php if($project1['pattadtcp']=='Yes') {?> Selected <?php } ?> value="Yes">Yes</option>
<option <?php if($project1['pattadtcp']=='No') {?> Selected <?php } ?> value="No">No</option>
</select><br><input  id="pattadtcpfile" name="pattadtcpfile" type="file" value="<?php echo $project1['pattadtcpfile'];?>">
...
<th style="border:1px solid #139830;"><div class="input-field col s12 divheight  oldsf seventhborder"><input  id="nearestmainroad" name="nearestmainroad" type="text" value="<?php echo $project1['nearestmainroad'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="nearestmainroad" style="">Nearest Main Road </label></div></th><th></th>	
...
<tr>
<th style="border:1px solid #139830;"><div class="input-field col s12 divheight  oldsf seventhborder"><input  id="civilamenities" name="civilamenities" type="text" value="<?php echo $project1['civilamenities'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="civilamenities" style="">Civil Amenities</label></div></th>	<th></th>
<th style="border:1px solid #082cdc;"><div class="input-field eighthborder"><select name="hdline" id="hdline" style="display:block;">
<option value="" >H.D Line</option>
<option <?php if($project1['hdline']=='Yes') {?> Selected <?php } ?> value="Yes">Yes</option>
<option <?php if($project1['hdline']=='No') {?> Selected <?php } ?> value="No">No</option>
</select><br><input  id="hdlinefile" name="hdlinefile" type="file" value="<?php echo $project1['hdlinefile'];?>">
     ...
     <!--  table Start Mobile end--> 
	  ...
	  <table class="highlight">
          ...
          <thead>
		  	...
		  	<tr style="background: #ddd;">
<th style="border: 1px solid gray;padding: 5px 8px !important;">Land</th>
<th colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;"></th>
<th style="border: 1px solid gray;padding: 5px 8px !important;">Patta<label>
...
<th style="border: 1px solid gray;padding: 5px 8px !important;">Document<label>
                <input type="checkbox" class="filled-in" name="documentvisible" id="documentvisible" <?php if($project1['documentvisible']=='Yes') { ?> checked<?php } ?> value="Yes"><span>Visible</span></label></th>
<th style="border: 1px solid gray;padding: 5px 8px !important;"></th>
</tr>
		   <tr>     <th style="border: 1px solid gray;padding: 5px 8px !important;">Direction</th>
		            <th colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;">Boundary Details</th>
				    <th class="pattashow" style="border: 1px solid gray;padding: 5px 8px !important;">Patta   </th>
                    <th class="documentshow" style="border: 1px solid gray;padding: 5px 8px !important;">Document </th>
					<th style="border: 1px solid gray;padding: 5px 8px !important;">Actual</th>
...
<?php } } else { ?> 
 ...
 <tbody class="newTR1">
				 <tr><td colspan="1">Descrption</td>
				    <td colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;"> <textarea id="land_description" name="land_description[]" rows="3" cols="23" style="    height: 3rem;">
</textarea></td>
					<td class="pattashow" style="border: 1px solid gray;padding: 5px 8px !important;"></td><td class="documentshow"></td>
           <td style="border: 1px solid gray;padding: 5px 8px !important;"></td></tr>  
				   <tr >
		            <td style="border: 1px solid gray;padding: 5px 8px !important;">North</td>
					<td colspan="2" style="    width: 24%;border: 1px solid gray;padding: 5px 8px !important;"><textarea id="boundary1" name="northboundary[]" rows="3" cols="23" style="    height: 4rem;">
</textarea></td>
				    <td class="pattashow" style="border: 1px solid gray;padding: 5px 8px !important;"><input  id="north1" name="north1[]" type="number"  value="" style="width:45% !important;"><input  id="north2" name="north2[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="north3" name="north3[]" type="number"  readonly value="" style="width:45% !important;margin-left: 3px;"></td>
                     <td class="documentshow" style="border: 1px solid gray;padding: 5px 8px !important;"><input  id="north4" name="north4[]" type="number" value="" style="width:45% !important;"><input  id="north5" name="north5" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="north6" name="north6[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
                  ...
                  <tr>
		            <td style="border: 1px solid gray;padding: 5px 8px !important;">South</td>
					<td colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;"><textarea id="southboundary" name="southboundary[]" rows="3" cols="23" style="    height: 4rem;">
</textarea></td>
                 ...
                 <tr>
		            <td style="border: 1px solid gray;padding: 5px 8px !important;">East</td>
					<td colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;"><textarea id="eastboundary" name="eastboundary[]" rows="3" cols="23" style="    height: 4rem;">
</textarea></td>
					 ...
					 <td style="border: 1px solid gray;padding: 5px 8px !important;"><input  id="east7" name="east7[]" type="number" value=""style="width:45% !important;"><input  id="east8" name="east8[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="east9" name="east9[]" type="number" readonly value=""style="width:45% !important;margin-left: 3px;"></td>
                      ...
                      <tr>
		            <td>West</td>
					<td  colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;"><textarea id="westboundary" name="westboundary[]" rows="3" cols="23" style="    height: 4rem;">
</textarea></td>
 ...
 <tr>
		            <td style="border: 1px solid gray;padding: 5px 8px !important;">Extent of Site </td>
					<td colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;">As Per Manual <br><input  id="estent" name="estent[]"  type="number" value="" style="width:60% !important;margin-left: 3px;"></td>
				     <td class="pattashow" style="border: 1px solid gray;padding: 5px 8px !important;">As Per Patta <br><input  id="estent1" name="estent1[]"  type="number" value="" style="width:60% !important;margin-left: 3px;"></td>
                     <td class="documentshow" style="border: 1px solid gray;padding: 5px 8px !important;">As Per Document<br> <input  id="estent2" name="estent2[]" type="number"  value="" style="width:60% !important;margin-left: 3px;"></td>
					 <td style="border: 1px solid gray;padding: 5px 8px !important;">As Per Actual<br><input  id="estent3" name="estent3[]" type="number"  value="" style="width:60% !important;margin-left: 3px;"></td>
					
                  </tr>		
				  
				  <tr><td colspan="1" style="border: 1px solid gray;padding: 5px 8px !important;">Resent Sale Details</td>
				    <td colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;"> <textarea id="sale_details[]" name="sale_details[]" rows="3" cols="23" style="    height: 3rem;">
</textarea></td>
					<td colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;"><input  id="sale_from" name="sale_from[]"  type="number" value="" style="font-weight:bold;font-size:18px;    width: 40% !important;"> TO <input  id="sale_to" name="sale_to[]"  type="number" value=""></td><td style="border: 1px solid gray;padding: 5px 8px !important;"><select name="sale_type[]" id="sale_type" style="display:block" class="assignast1">
                  <option value="" >Select</option>
...
<?php if(1!=1) {?>
		            <td  style="border:unset !important"></td>
				     ...
				     <td style="border: 1px solid gray;padding: 5px 8px !important;">Total Area<br><input  id="totalarea" name="totalarea[]" class="totalareatot" type="text" value=""></td>
                     <td colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;" >Rate <span class="assignsq" id="assignsq"></span><br><input  id="totalrate" name="totalrate[]"  type="text" value=""></td>
					 <td style="width:15%;border: 1px solid gray;padding: 5px 8px !important;">Land Value Total<br><input  id="totallandvalue" class="totallandvalue" name="totallandvalue[]" readonly type="text" value="">     </td>
					<td style="    width: 33%;">Guideline Rate<br><input  id="guide_rate" name="guide_rate[]"  class="guide_rate" type="number" value="" style="
    font-size: 18px;
    width: 45% !important;border: 1px solid gray;padding: 5px 8px !important;"><select name="guideselect[]" id="guideselect" style="display:block" class="guideselect">
                  <option value="" >Select</option>
				   <option value="Sq ft" >Sq ft</option>
					...
					<td style="border: 1px solid gray;padding: 5px 8px !important;">Guideline Value<br><input  id="guidevalue" class="guidevalue" name="guidevalue[]" readonly type="text" value="">   <input  id="guideupload" name="guideupload[]" type="file" value="" style="    width: 100% !important;">   </td>
                  </tr>		
...
<tr>
<th colspan="1" style="width:16%;border: 1px solid gray;padding: 5px 8px !important;">Type of Property <select name="typeofproperty[]" id="typeofproperty" style="display:block">
                  <option value="" >Type of Property </option>
				  <?php
				  $typeofproperty = mysqli_query($GLOBALS['connect'],"SELECT * FROM  typeofproperty order by id asc"); 
while ($typeofproperty1 = mysqli_fetch_array($typeofproperty)) {?>
...
<th colspan="1" style="width:20%; border: 1px solid gray;padding: 5px 8px !important;">Size of Plot <select name="sizeofplot[]" id="sizeofplot" style="display:block">
                  <option value="" >Size of Plot</option>
				  <?php
				  $sizeofplot = mysqli_query($GLOBALS['connect'],"SELECT * FROM  sizeofplot order by id asc"); 
while ($sizeofplot1 = mysqli_fetch_array($sizeofplot)) {?>
...
<?php } ?>
				...
				<th colspan="2" style="border: 1px solid gray;padding: 5px 8px !important;">Development to site <select name="recentdevelopmentsnear[]" id="recentdevelopmentsnear" style="display:block">
                  <option value="" >Select</option>
				  <?php
				  $recentdevelopments = mysqli_query($GLOBALS['connect'],"SELECT * FROM  recentdevelopments order by id asc"); 
while ($recentdevelopments1 = mysqli_fetch_array($recentdevelopments)) {?>
...
<th style="border: 1px solid gray;padding: 5px 8px !important;"> Control Limit <select name="limits[]" id="limits" style="display:block">
                  <option value="" selected>Limit</option>
				  <?php
				  $limits = mysqli_query($GLOBALS['connect'],"SELECT * FROM  limits order by id asc"); 
while ($limits1 = mysqli_fetch_array($limits)) {?>
...
<?php } ?>
				...
				<th style="border: 1px solid gray;padding: 5px 8px !important;">Class of Construction  <select name="classofconstruction[]" id="classofconstruction" style="display:block">
                  <option value="" selected>Class of Construction</option>
				  <?php
				  $classofconstruction = mysqli_query($GLOBALS['connect'],"SELECT * FROM  classofconstruction order by id asc"); 
while ($classofconstruction1 = mysqli_fetch_array($classofconstruction)) {?>
...
<tbody>
<tr><td style="border: 1px solid gray;padding: 5px 8px !important;">Total Sq.ft</td><td style="border: 1px solid gray;padding: 5px 8px !important;"><input id="totalareaval" name="totalareaval" type="text" value="<?php echo $project1['totalareaval'];?>"></td></tr>
<tr><td style="border: 1px solid gray;padding: 5px 8px !important;">Total Guideline value</td><td style="border: 1px solid gray;padding: 5px 8px !important;"><input  id="guideline_value" name="guideline_value" type="text"  value="<?php echo $project1['guideline_value'];?>"><input  id="guideline_rate" name="guideline_rate" type="hidden"  value="<?php echo $project1['guideline_rate'];?>"></td></tr>
<?php if(1!=1) {?>
...
<tr><td style="border: 1px solid gray;padding: 5px 8px !important;">1.Market Value</td><td style="border: 1px solid gray;padding: 5px 8px !important;"><input  id="market_value" name="market_value" type="text"  value="<?php echo $project1['market_value'];?>"></td></tr>
<tr><td style="border: 1px solid gray;padding: 5px 8px !important;">2.Reasonable value
