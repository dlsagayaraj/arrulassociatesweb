...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;">Revenue Details: </td>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>><?php echo $project1['ebserviceno']; ?><?php if( $project1['ebserviceno']=='Yes') {?> - <?php echo $project1['ebserviceno_name']; ?><?php } ?></td>
                </tr>
				<tr>
