...
if($edit_id=='/document/create-project')
{
...
$report_no = mysqli_query($conn,"SELECT * FROM `project_details` where delete_status=0 and report_name='$report_name' order by id desc  "); 
...
elseif($edit_id=='/document/create-project?step=step4')
{
...
$retval = mysqli_query($conn, $sql2);
     ...
     $query2 = "insert into project_table(project_id,compoundwallL1,compoundwallL2,compoundwallLtot,compoundwallrate,sump,oht,sintex,ebdepositI,ebdep1,pavertype,compoundwallL11,compoundwallL21,compoundwallLtot1,compoundwallrate1,sump1,oht1,sintex1,ebdepositI1,ebdep11,pavertype1,compoundwallL12,compoundwallL22,compoundwallLtot2,compoundwallrate2,sump2,oht2,sintex2,ebdepositI2,ebdep12,pavertype2,compoundwallL13,compoundwallL23,compoundwallLtot3,compoundwallrate3,sump3,oht3,sintex3,ebdepositI3,ebdep13,pavertype3,typeofconstruction,maintenanceofthebuilding,drainagearrangements,watersupplyarrangements,joineries,roadfacilities,roadfacilitiesyes,cornerplotintermittentplot,characteroflocality,floorselect,floorfinish,roofingselect,servicevisible,watersupplyarrangementsRs,drainagearrangementsRs,compoundwallRs,sumpohtRs,ebdepositRs,paverrs,interiorworkRs,openstaircaseRs,serviceovertotal,typeofconstruction1,maintenanceofthebuilding1,drainagearrangements1,watersupplyarrangements1,joineries1,roadfacilities1,roadfacilitiesyes1,cornerplotintermittentplot1,characteroflocality1,floorselect1,floorfinish1,roofingselect1,servicevisible1,watersupplyarrangementsRs1,drainagearrangementsRs1,compoundwallRs1,sumpohtRs1,ebdepositRs1,paverrs1,interiorworkRs1,openstaircaseRs1,serviceovertotal1,typeofconstruction2,maintenanceofthebuilding2,drainagearrangements2,watersupplyarrangements2,joineries2,roadfacilities2,roadfacilitiesyes2,cornerplotintermittentplot2,characteroflocality2,floorselect2,floorfinish2,roofingselect2,servicevisible2,watersupplyarrangementsRs2,drainagearrangementsRs2,compoundwallRs2,sumpohtRs2,ebdepositRs2,paverrs2,interiorworkRs2,openstaircaseRs2,serviceovertotal2,typeofconstruction3,maintenanceofthebuilding3,drainagearrangements3,watersupplyarrangements3,joineries3,roadfacilities3,roadfacilitiesyes3,cornerplotintermittentplot3,characteroflocality3,floorselect3,floorfinish3,roofingselect3,servicevisible3,watersupplyarrangementsRs3,drainagearrangementsRs3,compoundwallRs3,sumpohtRs3,ebdepositRs3,paverrs3,interiorworkRs3,openstaircaseRs3,serviceovertotal3,desc_prop,lengtha,lengthb,length,breadtha,breadthb,breadth,area,rate,year,percentage,roofselect,deprciation,total,overalltotal,desc_prop1,lengtha1,lengthb1,length1,breadtha1,breadthb1,breadth1,area1,rate1,year1,percentage1,roofselect1,deprciation1,total1,overalltotal1,desc_prop2,lengtha2,lengthb2,length2,breadtha2,breadthb2,breadth2,area2,rate2,year2,percentage2,roofselect2,deprciation2,total2,overalltotal2,desc_prop3,lengtha3,lengthb3,length3,breadtha3,breadthb3,breadth3,area3,rate3,year3,percentage3,roofselect3,deprciation3,total3,overalltotal3,date_time,log_id) values ('$edit_id','$compoundwallL1','$compoundwallL2','$compoundwallLtot','$compoundwallrate','$sump','$oht','$sintex','$ebdepositI','$ebdep1','$pavertype','$compoundwallL11','$compoundwallL21','$compoundwallLtot1','$compoundwallrate1','$sump1','$oht1','$sintex1','$ebdepositI1','$ebdep11','$pavertype1','$compoundwallL12','$compoundwallL22','$compoundwallLtot2','$compoundwallrate2','$sump2','$oht2','$sintex2','$ebdepositI2','$ebdep12','$pavertype2','$compoundwallL13','$compoundwallL23','$compoundwallLtot3','$compoundwallrate3','$sump3','$oht3','$sintex3','$ebdepositI3','$ebdep13','$pavertype3','$typeofconstruction','$maintenanceofthebuilding','$drainagearrangements','$watersupplyarrangements','$joineries','$roadfacilities','$roadfacilitiesyes','$cornerplotintermittentplot','$characteroflocality','$floorselect','$floorfinish','$roofingselect','$servicevisible','$watersupplyarrangementsRs','$drainagearrangementsRs','$compoundwallRs','$sumpohtRs','$ebdepositRs','$paverrs','$interiorworkRs','$openstaircaseRs','$serviceovertotal','$typeofconstruction1','$maintenanceofthebuilding1','$drainagearrangements1','$watersupplyarrangements1','$joineries1','$roadfacilities1','$roadfacilitiesyes1','$cornerplotintermittentplot1','$characteroflocality1','$floorselect1','$floorfinish1','$roofingselect1','$servicevisible1','$watersupplyarrangementsRs1','$drainagearrangementsRs1','$compoundwallRs1','$sumpohtRs1','$ebdepositRs1','$paverrs1','$interiorworkRs1','$openstaircaseRs1','$serviceovertotal1','$typeofconstruction2','$maintenanceofthebuilding2','$drainagearrangements2','$watersupplyarrangements2','$joineries2','$roadfacilities2','$roadfacilitiesyes2','$cornerplotintermittentplot2','$characteroflocality2','$floorselect2','$floorfinish2','$roofingselect2','$servicevisible2','$watersupplyarrangementsRs2','$drainagearrangementsRs2','$compoundwallRs2','$sumpohtRs2','$ebdepositRs2','$paverrs2','$interiorworkRs2','$openstaircaseRs2','$serviceovertotal2','$typeofconstruction3','$maintenanceofthebuilding3','$drainagearrangements3','$watersupplyarrangements3','$joineries3','$roadfacilities3','$roadfacilitiesyes3','$cornerplotintermittentplot3','$characteroflocality3','$floorselect3','$floorfinish3','$roofingselect3','$servicevisible3','$watersupplyarrangementsRs3','$drainagearrangementsRs3','$compoundwallRs3','$sumpohtRs3','$ebdepositRs3','$paverrs3','$interiorworkRs3','$openstaircaseRs3','$serviceovertotal3','$desc_prop','$lengtha','$lengthb','$length','$breadtha','$breadthb','$breadth','$area','$rate','$year','$percentage','$roofselect','$deprciation','$total','$overalltotal','$desc_prop1','$lengtha1','$lengthb1','$length1','$breadtha1','$breadthb1','$breadth1','$area1','$rate1','$year1','$percentage1','$roofselect1','$deprciation1','$total1','$overalltotal1','$desc_prop2','$lengtha2','$lengthb2','$length2','$breadtha2','$breadthb2','$breadth2','$area2','$rate2','$year2','$percentage2','$roofselect2','$deprciation2','$total2','$overalltotal2','$desc_prop3','$lengtha3','$lengthb3','$length3','$breadtha3','$breadthb3','$breadth3','$area3','$rate3','$year3','$percentage3','$roofselect3','$deprciation3','$total3','$overalltotal3','$date_time','$log_id')";
...
<tr>
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> colspan="2"  <?php } else {?> colspan="1" <?php } ?> style="text-align: center;    background: white; border:1px solid #21058f;width:49%; "> <div>PROVISIONAL VALUATION REPORT</div>  <div class="input-field col s12 divheight loan firstborder" style="
    width:48%;
    ">
                    <input  id="created_by" name="created_by" type="text" value="<?php echo $project1['created_by'];?>" style=" margin-left: -14px !important;
    width: 104% !important;">
                    <label  for="created_by" style="">Created by</label>
</div> <div class="input-field col s12 divheight loan firstborder" style="
    width:48%;
    ">
                    <input  id="typed_by" name="typed_by" type="text" value="<?php echo $project1['typed_by'];?>" style=" margin-left: -14px !important;
    width: 119% !important;">
                    <label  for="typed_by" style="">Typed by</label>
</div></th> <th style="width:0% "></th><th  colspan="1" style="text-align: center;     background: white;border:1px solid #f60707; width:49%; "> <div class="input-field divheight secondborder" style=""><select name="report_name" id="report_name"  class="select2 browser-default" style=" background: white;"> 
...
<div class="input-field col s12 divheight ins secondborder">	<input  id="inspect_contactno" name="inspect_contactno" type="number" value="<?php echo $project1['inspect_contactno'];?>" required style=" margin-left: -14px !important;
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border-left:1px solid #f60707; border-right:1px solid #f60707; "><div class="input-field col s12 divheight secondborder amountcal" style="width:35% !important;"><input  id="totamount" name="totamount" type="number" value="<?php echo $project1['totamount'];?>"  style=" margin-left: -14px !important;
    width: 104% !important;"> <label  for="totamount" style="">Total Amount (Rs.)</label></div>
	
	<div class="input-field col s12 divheight secondborder amountcal" style="width:35% !important;"><input  id="advanceAmount" name="advanceAmount" type="number" value="<?php echo $project1['advanceAmount'];?>"  style=" margin-left: -14px !important;
    width: 104% !important;"> <label  for="advanceAmount" style="">Advance (Rs.)</label></div>
	
	
	<div class="input-field col s12 divheight secondborder amountcal amtlab" style="width:30% !important;"><input  id="balanceamount" name="balanceamount" type="number" value="<?php echo $project1['balanceamount'];?>" readonly style=" margin-left: -14px !important;
...
<?php echo $land_description[$countproper1];?>
					...
					<td class="pattashow" style="border-bottom: 1px solid gray;padding: 5px 8px !important;" ></td><td class="documentshow" style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;"></td>
...
<?php echo $northboundary[$countproper1];?></textarea></td>
		 <td style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;"><input  id="north7" name="north7[]" type="number" value="<?php echo $north7[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="north8" name="north8[]" type="number" value="<?php echo $north8[$countproper1];?>"style="width:45% !important;margin-left: 3px;"><input  id="north9" name="north9[]" type="number" readonly value="<?php echo $north9[$countproper1];?>" <?php if($north9[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    ...
    text-align: center;" <?php } ?>></td>
				    <td class="pattashow" style="border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;"><input  id="north1" name="north1[]" type="number"  value="<?php echo $north1[$countproper1];?>" style="width:45% !important;"><input  id="north2" name="north2[]" type="number" value="<?php echo $north2[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="north3" name="north3[]" type="number"  readonly value="<?php echo $north3[$countproper1];?>" <?php if($north3[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
    ...
    border-radius: 2px !important;
    text-align: center;" <?php } ?>></td>
                     <td class="documentshow" style="border-right: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;"><input  id="north4" name="north4[]" type="number" value="<?php echo $north4[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="north5" name="north5[]" type="number" value="<?php echo $north5[$countproper1];?>"style="width:45% !important;margin-left: 3px;"><input  id="north6" name="north6[]" type="number" readonly value="<?php echo $north6[$countproper1];?>" <?php if($north6[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
...
<?php echo $southboundary[$countproper1];?></textarea></td>
 ...
 <td style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;"> <input  id="south7" name="south7[]" type="number" value="<?php echo $south7[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="south8" name="south8[]" type="number" value="<?php echo $south8[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="south9" name="south9[]" type="number" readonly value="<?php echo $south9[$countproper1];?>" <?php if($south9[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
    ...
    border-radius: 2px !important;
    text-align: center;" <?php } ?>></td>
				     <td class="pattashow" style="border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;"><input  id="south1" name="south1[]" type="number" value="<?php echo $south1[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="south2" name="south2[]" type="number" value="<?php echo $south2[$countproper1];?>"style="width:45% !important;margin-left: 3px;"><input  id="south3" name="south3[]" type="number" readonly value="<?php echo $south3[$countproper1];?>" <?php if($south3[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
    ...
    border-radius: 2px !important;
    text-align: center;" <?php } ?>></td>
                     <td class="documentshow" style="border-right: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;"><input  id="south4" name="south4[]" type="number" value="<?php echo $south4[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="south5" name="south5[]" type="number" value="<?php echo $south5[$countproper1];?>"style="width:45% !important;margin-left: 3px;"><input  id="south6" name="south6[]" type="number" readonly value="<?php echo $south6[$countproper1];?>" <?php if($south6[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
...
<?php echo $eastboundary[$countproper1];?></textarea></td>
 <td style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;"><input  id="east7" name="east7[]" type="number" value="<?php echo $east7[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="east8" name="east8[]" type="number" value="<?php echo $east8[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="east9" name="east9[]" type="number" readonly value="<?php echo $east9[$countproper1];?>" <?php if($east9[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
    ...
    border-radius: 2px !important;
    text-align: center;" <?php } ?>></td>
				      <td class="pattashow" style="border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;"><input  id="east1" name="east1[]" type="number" value="<?php echo $east1[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="east2" name="east2[]" type="number" value="<?php echo $east2[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="east3" name="east3[]" type="number" readonly value="<?php echo $east3[$countproper1];?>" <?php if($east3[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
    ...
    border-radius: 2px !important;
    text-align: center;" <?php } ?>></td>
                     <td class="documentshow" style="border-right: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;"><input  id="east4" name="east4[]" type="number" value="<?php echo $east4[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="east5" name="east5[]" type="number" value="<?php echo $east5[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="east6" name="east6[]" type="number" readonly value="<?php echo $east6[$countproper1];?>" <?php if($east6[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
...
<?php echo $westboundary[$countproper1];?></textarea></td>
	 <td style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;"><input  id="west7" name="west7[]" type="number" value="<?php echo $west7[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="west8" name="west8[]" type="number" value="<?php echo $west8[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="west9" name="west9[]" type="number" readonly value="<?php echo $west9[$countproper1];?>" <?php if($west9[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
    ...
    border-radius: 2px !important;
    text-align: center;" <?php } ?>></td>
				     <td class="pattashow" style="border-bottom: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;"><input  id="west1" name="west1[]" type="number" value="<?php echo $west1[$countproper1];?>" style="width:45% !important;margin-left: 3px;" ><input  id="west2" name="west2[]" type="number" value="<?php echo $west2[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="west3" name="west3[]" type="number" readonly value="<?php echo $west3[$countproper1];?>" <?php if($west3[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
    ...
    border-radius: 2px !important;
    text-align: center;" <?php } ?>></td>
                     <td class="documentshow" style="border-right: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;"><input  id="west4" name="west4[]" type="number" value="<?php echo $west4[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="west5" name="west5[]" type="number" value="<?php echo $west5[$countproper1];?>" style="width:45% !important;margin-left: 3px;"><input  id="west6" name="west6[]" type="number" readonly value="<?php echo $west6[$countproper1];?>" <?php if($west6[$countproper1]!='') {?> style="width:45% !important;margin-left: 3px;  background: #3d7509;
    color: white;
    border: unset !important;
    border-radius: 2px !important;
    text-align: center;" <?php } else {?> style="width:45% !important;margin-left: 3px;display:none;  background: #3d7509;
 ...
 <tr>
					...
					<td colspan="2" style="border-left: 1px solid gray;padding: 5px 8px !important;padding: 5px 8px !important;">As Per Manual<br><input  id="estent" name="estent[]"  type="number" value="<?php echo $estent[$countproper1];?>" style="width:60% !important;margin-left: 3px;"> <?php
 ...
 if($manual_type[$countproper1]=='Sq m') { $manulv=$estent[$countproper1]*10.7639;  } ?>
    ...
    height: 33px;" class="assignast1">
				  ...
				  <option <?php if($manual_type[$countproper1]=='Sq m') {?> selected <?php } ?> value="Sq m" >Sq m</option>
						 ...
						 <td style="border-left: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;width:21%;">	As Per Actual<input type="radio" id="est3" name="est3" value="ON"><label style="margin-left: 21px;font-size: 12px;color: black;">ON</label> <input type="radio" id="est3" name="est3" value="OFF"> <label style="margin-left: 21px;font-size: 12px;color: black;">OFF</label><br><input  id="estent3" name="estent3[]" type="number"  value="<?php echo $estent3[$countproper1];?>" style="width:60% !important;margin-left: 3px;">
 ...
 if($actual_type[$countproper1]=='Sq m') { $actualv=$estent3[$countproper1]*10.7639;  }  ?>
	...
	<option value="" >Select</option>
				  ...
				  <option <?php if($actual_type[$countproper1]=='Sq m') {?> selected <?php } ?> value="Sq m" >Sq m</option>
				     ...
				     <td class="pattashow" style="border-right: 1px solid gray;padding: 5px 8px !important;width: 23%;">As Per Patta<input type="radio" id="est1" name="est1" value="ON"><label style="margin-left: 21px;font-size: 12px;color: black;">ON</label> <input type="radio" id="est1" name="est1" value="OFF"> <label style="margin-left: 21px;font-size: 12px;color: black;">OFF</label><br><input  id="estent1" name="estent1[]"  type="number" value="<?php echo $estent1[$countproper1];?>" style="width:60% !important;margin-left: 3px;"> <?php  if($patta_type[$countproper1]=='Sq ft') { $pattav=$estent1[$countproper1]; }  if($patta_type[$countproper1]=='Cent') { $pattav=$estent1[$countproper1]*435.6; } if($patta_type[$countproper1]=='Acre') { $pattav=$estent1[$countproper1]*43560;  } if($patta_type[$countproper1]=='Hectare') {  $pattav=$estent1[$countproper1]*107639; } if($patta_type[$countproper1]=='Sq m') { $pattav=$estent1[$countproper1]*10.7639;  }  ?><select name="patta_type[]" id="patta_type" style="display:block;display: block;
    width: 37%;
    margin-top: -41px;
    float: right;
    height: 33px;" class="assignast1">
...
<?php echo $sale_details[$countproper1];?></textarea></td>
					<td colspan="2" style="border-left: 2px solid red;padding: 5px 8px !important;border-bottom: 2px solid red;padding: 5px 8px !important;border-right: 2px solid red;padding: 5px 8px !important;border-top: 2px solid red;padding: 5px 8px !important;"><input  id="sale_from" name="sale_from[]"  type="number" value="<?php echo $sale_from[$countproper1];?>" style="    font-weight: bold;
    font-size: 18px;
    width: 48% !important;"> TO <input  id="sale_to" name="sale_to[]"  type="number" value="<?php echo $sale_to[$countproper1];?>" style=" width: 44% !important;"></td><td style="border-right: 2px solid red;padding: 5px 8px !important;border-bottom: 2px solid red;padding: 5px 8px !important;border-top: 2px solid red;padding: 5px 8px !important;"><select name="sale_type[]" id="sale_type" style="display:block">
                  <option value="" >Select</option>
...
float:right;   
 ...
 <tr> <?php if(1!=1) {?>
				   ...
				   <td>Total Area if Any<input  id="anyarea" name="anyarea[]"  type="text" value="<?php echo $anyarea[$countproper1];?>"></td>
					...
					<td style="width: 23%;border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;">Guideline Rate<br><input  id="guide_rate" name="guide_rate[]" class="guide_rate" type="number" value="<?php echo $guide_rate[$countproper1];?>" style="
    font-size: 18px;
...
<?php } } else { ?> 
 ...
 <tr>
		            <td style="border-left: 1px solid gray;padding: 5px 8px !important;padding: 5px 8px !important;">Extent of Site </td>
					<td colspan="2" style="border-left: 1px solid gray;padding: 5px 8px !important;padding: 5px 8px !important;">As Per Manual<br><input  id="estent" name="estent[]"  type="number" value="" style="width:60% !important;margin-left: 3px;"><select name="manual_type[]" id="manual_type" style="display:block;display: block;
    width: 37%;
    margin-top: -41px;
    float: right;
    height: 33px;" class="assignast1">
...
">As Per Patta<input type="radio" id="est1" name="est1" value="ON"><label style="margin-left: 21px;font-size: 12px;color: black;">ON</label> <input type="radio" id="est1" name="est1" value="OFF"> <label style="margin-left: 21px;font-size: 12px;color: black;">OFF</label><br><input  id="estent1" name="estent1[]"  type="number" value="" style="width:60% !important;margin-left: 3px;"><select name="patta_type[]" id="patta_type" style="display:block;display: block;
    ...
    height: 33px;" class="assignast1">
				  ...
				  <tr><td colspan="1" style="border-left: 2px solid red;padding: 5px 8px !important;border-bottom: 2px solid red;padding: 5px 8px !important;border-top: 2px solid red;">Resent Sale Details</td>
					...
					<td colspan="2" style="border-left: 2px solid red;padding: 5px 8px !important;border-bottom: 2px solid red;padding: 5px 8px !important;border-top: 2px solid red;padding: 5px 8px !important;"><input  id="sale_from" name="sale_from[]"  type="number" value="" style="font-weight:bold;font-size:18px;    width: 48% !important;"> TO <input  id="sale_to" name="sale_to[]"  type="number" value="" style="width: 44% !important;"></td><td style="border-left: 2px solid red;padding: 5px 8px !important;border-bottom: 2px solid red;padding: 5px 8px !important;border-right: 2px solid red;padding: 5px 8px !important;border-top: 2px solid red;padding: 5px 8px !important;"><select name="sale_type[]" id="sale_type" style="display:block" class="assignast1">
                  <option value="" >Select</option>
				  <option value="Sq ft" >Sq ft</option>
				  <option value="Cent" >Cent</option>
				  <option value="Acre" >Acre</option>
...
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> colspan="2"  <?php } else {?> colspan="1" <?php } ?> style="text-align: center;    background: white; border:1px solid #21058f;width:49%; "> General Information <?php if(1!=1) {?> <div class="input-field col s12 divheight loan firstborder" style="
    float: right;
    ">
                    <input  id="file_no" name="file_no" type="number" value="<?php echo $project1['file_no'];?>" style=" margin-left: -14px !important;
    width: 104% !important;">
                    <label  for="file_no" style="">File No</label>
</div> <?php } ?></th> <th style="width:0% "></th><th  colspan="1" style="text-align: center;     background: white;border:1px solid #f60707; width:49%; "> </th>
</tr>	
...
while ($typeofconstruction1 = mysqli_fetch_array($typeofconstruction)) {?>
                  <option value="<?php echo $typeofconstruction1['id'];?>" <?php if($typeofconstruction1['id']==$project_table1['typeofconstruction']) {?> selected <?php } ?>><?php echo $typeofconstruction1['name'];?></option>
<?php } ?>
...
<th style="border-left:1px solid #f60707; border-right:1px solid #f60707;"><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;;"> <select name="maintenanceofthebuilding" id="maintenanceofthebuilding" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
...
while ($maintananceofthebuilding1 = mysqli_fetch_array($maintananceofthebuilding)) {?>
                  <option value="<?php echo $maintananceofthebuilding1['id'];?>" <?php if($maintananceofthebuilding1['id']==$project_table1['maintenanceofthebuilding']) {?> selected <?php } ?>><?php echo $maintananceofthebuilding1['name'];?></option>
<?php } ?>
...
<th style="border:1px solid #21058f;">
<div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;height: 55px !important;"> <select name="drainagearrangements" id="drainagearrangements" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
...
while ($drainagearrangements1 = mysqli_fetch_array($drainagearrangements)) {?>
                  <option value="<?php echo $drainagearrangements1['id'];?>" <?php if($drainagearrangements1['id']==$project_table1['drainagearrangements']) {?> selected <?php } ?>><?php echo $drainagearrangements1['name'];?></option>
<?php } ?>
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border:1px solid #f60707; "><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;;"> <select name="watersupplyarrangements[]" id="watersupplyarrangements" multiple="multiple" style="display:block;height:67px !important;width: 109% !important;margin-left: -14px !important;margin-top: -13px;">
  <?php
				  $drivercheckedval=explode(",",$project_table1['watersupplyarrangements']);
...
<?php } ?>
</select><label  for="watersupplyarrangements" style="    margin-top: -29px;
    margin-left: 10px;
    background: white;">Water Supply Arrangements</label> </div>
	
	</th>
</tr>
<tr>
<th style="border-left:1px solid #21058f;border-right:1px solid #21058f;">  <div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;;"> <select name="joineries[]" id="joineries" multiple="multiple" style="display:block;height:67px !important;width: 109% !important;margin-left: -14px !important;margin-top: -13px;">
  	  <?php
				   $joineriesedval=explode(",",$project_table1['joineries']);
...
<?php } ?>
</select><label  for="joineries" style="    margin-top: -29px;
    margin-left: 10px;
    background: white;">Joineries</label> </div></th><th></th>
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border-left:1px solid #f60707; border-right:1px solid #f60707; "><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;height: 22px  !important;"> <select name="roadfacilities" id="roadfacilities" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Road Type</option>
<option value="" >Wide</option>
<option <?php if($project_table1['roadfacilities']=='Public') {?> <?php } ?> value="Public" >Public</option>
<option <?php if($project_table1['roadfacilities']=='Private') {?> <?php } ?> value="Private" >Private</option>
...
while ($roadfacilities1 = mysqli_fetch_array($roadfacilities)) {?>
                  <option value="<?php echo $roadfacilities1['id'];?>" <?php if($roadfacilities1['id']==$project_table1['roadfacilitiesyes']) {?> selected <?php } ?>><?php echo $roadfacilities1['name'];?></option>
<?php } ?>
...
<tr>
<th style="width:50%;border:1px solid #21058f;">
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border:1px solid #f60707; "><div class="input-field col s12 purchase secondborder"><select name="characteroflocality" id="characteroflocality" style="display:block;height:33px !important;width: 103% !important;margin-left: -14px !important;">
...
while ($characteroflocality1 = mysqli_fetch_array($characteroflocality)) {?>
                  <option value="<?php echo $characteroflocality1['id'];?>" <?php if($characteroflocality1['id']==$project_table1['characteroflocality']) {?> selected <?php } ?>><?php echo $characteroflocality1['name'];?></option>
<?php } ?>
</select><label  for="characteroflocality" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Character of Locality </label></div></th>
</tr>
...
<table id="b"><tr  id="c"><td style="border-left:1px solid gray;border-top:1px solid gray;border-bottom:1px solid gray;border-right:1px solid gray; ">Floor</td><td style="border-top:1px solid gray;border-bottom:1px solid gray;border-right:1px solid gray; ">Floor Finishing</td><td style="border-top:1px solid gray;border-bottom:1px solid gray;border-right:1px solid gray; ">Roofing</td></tr>

<?php 
 $floorselect=explode(",",$project_table1['floorselect']);
$floorfinish=explode(",",$project_table1['floorfinish']);
$roofingselect=explode(",",$project_table1['roofingselect']);
if($project_table1['floorselect']!='') {
foreach($floorselect as $floorselectcount =>$key) {  echo $floorselect[$floorselectcount]; ?>

<tr><td><select class="selectin" name="floorselect[]" id="floorselect"  style="    display: block;"><option value="" selected>Select</option>
				  ...
				  </select></td><td><select class="selectin" name="floorfinish[]" id="floorfinish" style="    display: block;"><option value="" selected >Select</option>
...
</select></td><td style="border-right:1px solid gray;border-bottom:1px solid gray;"><select name="floorfinish[]" id="floorfinish" style="display:block;height:33px !important;">
   <option value="" selected>Select</option>
...
<thead>
<tr>
<th style="border: 1px solid gray;">Services  <label><input type="checkbox" class="filled-in" name="servicevisible" id="servicevisible" <?php if($project_table1['servicevisible']=='Yes') { ?> checked<?php } ?> value="Yes"><span>Visible</span></label> </th><th style="border: 1px solid gray;"></th>
</tr>
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;width:60%;">Water Supply Arrangements (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="watersupplyarrangementsRs" name="watersupplyarrangementsRs" type="number" value="<?php echo $project_table1['watersupplyarrangementsRs'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="drainagearrangementsRs" name="drainagearrangementsRs" type="number" value="<?php echo $project_table1['drainagearrangementsRs'];?>"></th>
...
<br>
<input  class="compoundwalltotal" id="compoundwallL1" name="compoundwallL1" type="text" value="<?php echo $project_table1['compoundwallL1'];?>" style="    width: 10%;" placeholder="L" value="">
<input  class="compoundwalltotal" id="compoundwallL2" name="compoundwallL2" type="text" value="<?php echo $project_table1['compoundwallL2'];?>" style="    width: 10%;"  placeholder="B"  value="">
<input  class="compoundwalltotal" id="compoundwallLtot" name="compoundwallLtot" type="text" value="<?php echo $project_table1['compoundwallLtot'];?>" style="    width: 30%;"  placeholder="Sqft">
<input  class="compoundwalltotal" id="compoundwallrate" name="compoundwallrate" type="number" value="<?php echo $project_table1['compoundwallrate'];?>" style="    width: 30%;"  placeholder="Rate">

</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="compoundwallRs" name="compoundwallRs" type="text" value="<?php echo $project_table1['compoundwallRs'];?>"></th>
...
Sump<input  class="sumpclass" id="sump" name="sump" type="text" value="<?php echo $project_table1['sump'];?>" placeholder="Rs" style="width: 40%;margin-left: 52px;" value="">
<br>OH Tank<input class="sumpclass" id="oht" name="oht" type="text" value="<?php echo $project_table1['oht'];?>"  placeholder="Rs" style="width: 31%;margin-left: 30px;" value="">
<br>Sintex<input class="sumpclass" id="sintex" name="sintex" type="text" value="<?php echo $project_table1['sintex'];?>" placeholder="Rs" style="width: 39%;margin-left: 47px;" value=""></th>

<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="sumpohtRs" name="sumpohtRs" type="number" value="<?php echo $project_table1['sumpohtRs'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">E.B Deposit <div style="    width: 150px !important;
    margin-left: 114px;
    margin-top: -20px;"><select name="ebdepositI" id="ebdepositI" style="    width: 100%;display:block;">
                  <option value="" >Select</option>
                  <option <?php if($project_table1['ebdepositI']=='I Phase') {?> selected <?php } ?> value="I Phase" >I Phase</option>
				  <option <?php if($project_table1['ebdepositI']=='III Phase') {?> selected <?php } ?>  value="III Phase" >III Phase</option>
                </select></div>
No.of Services <input class="compoundwalltotal" id="ebdep1" name="ebdep1" type="text" value="<?php echo $project_table1['ebdep1'];?>" style="    width: 40%;margin-top: 4%;" placeholder="No.of Services">
		</th>
				<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="ebdepositRs" name="ebdepositRs" type="number" value="<?php echo $project_table1['ebdepositRs'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Pavar/Cement/Tiles    <p class="mb-1">
              ...
              <label>
                <input type="checkbox" <?php  $checkedval=explode(",",$project_table1['pavertype']);	 if (in_array('Pavements', $checkedval))
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="paverrs" name="paverrs" type="number" value="<?php echo $project_table1['paverrs'];?>">
</th>
...
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;"> Interior / Exterior (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="servicetotal" id="interiorworkRs" name="interiorworkRs" type="number" value="<?php echo $project_table1['interiorworkRs'];?>"></th>
</tr>
<tr>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="servicetotal" id="openstaircaseRs" name="openstaircaseRs" type="number" value="<?php echo $project_table1['openstaircaseRs'];?>"></th>

</tr>
<tr>
<th style="width: 25%;border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;" class="serviceshow" id="serviceshow">Total</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="serviceovertotal" id="serviceovertotal" name="serviceovertotal" type="text" value="<?php echo $project_table1['serviceovertotal'];?>"></th>
</tr>
...
<thead>
 <tr>
				    ...
				    <th style="border-left:1px solid gray;border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Descrption of the Property </th>
                    <th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Size<br>L W</th>
					<th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Area</th>
					<th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Rate</th>
                    <th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Year</th>
					<th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Percentage</th>
                    <th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Type Of Roofing</th>	
                    <th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Deprciation</th>
                    <th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Total</th>					
...
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="width:50%;"<?php } else { ?> style="border-left:1px solid #21058f;border-right:1px solid #21058f;"  <?php } ?>> <div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;;"> <select name="typeofconstruction1" id="typeofconstruction" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Type of Construction</option>
<?php
				  $typeofconstruction = mysqli_query($GLOBALS['connect'],"SELECT * FROM  typeofconstruction order by id asc"); 
while ($typeofconstruction1 = mysqli_fetch_array($typeofconstruction)) {?>
                  <option value="<?php echo $typeofconstruction1['id'];?>" <?php if($typeofconstruction1['id']==$project_table1['typeofconstruction1']) {?> selected <?php } ?>><?php echo $typeofconstruction1['name'];?></option>
<?php } ?>
</select><label  for="typeofconstruction" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Type of Construction </label> </div></th><th></th>
...
<th style="border-left:1px solid #f60707; border-right:1px solid #f60707;"><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;;"> <select name="maintenanceofthebuilding1" id="maintenanceofthebuilding" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Building Maintenance</option>
 <?php
				  $maintananceofthebuilding = mysqli_query($GLOBALS['connect'],"SELECT * FROM  maintananceofthebuilding order by id asc"); 
while ($maintananceofthebuilding1 = mysqli_fetch_array($maintananceofthebuilding)) {?>
                  <option value="<?php echo $maintananceofthebuilding1['id'];?>" <?php if($maintananceofthebuilding1['id']==$project_table1['maintenanceofthebuilding1']) {?> selected <?php } ?>><?php echo $maintananceofthebuilding1['name'];?></option>
<?php } ?>
</select><label  for="maintenanceofthebuilding" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Building Maintenance</label> </div></th>
...
<th style="border:1px solid #21058f;">
<div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;height: 55px !important;"> <select name="drainagearrangements1" id="drainagearrangements" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Drainage Arrangements</option>
 <?php
				  $drainagearrangements = mysqli_query($GLOBALS['connect'],"SELECT * FROM  drainagearrangements order by id asc"); 
while ($drainagearrangements1 = mysqli_fetch_array($drainagearrangements)) {?>
                  <option value="<?php echo $drainagearrangements1['id'];?>" <?php if($drainagearrangements1['id']==$project_table1['drainagearrangements1']) {?> selected <?php } ?>><?php echo $drainagearrangements1['name'];?></option>
<?php } ?>
</select><label  for="drainagearrangements" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Drainage Arrangements</label> </div>
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border:1px solid #f60707; "><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;;"> <select name="watersupplyarrangements1[]" id="watersupplyarrangements" multiple="multiple" style="display:block;height:67px !important;width: 109% !important;margin-left: -14px !important;margin-top: -13px;">
  <?php
				  $drivercheckedval=explode(",",$project_table1['watersupplyarrangements1']);
				  $watersupplyarrangements = mysqli_query($GLOBALS['connect'],"SELECT * FROM  watersupplyarrangements order by id asc"); 
while ($watersupplyarrangements1 = mysqli_fetch_array($watersupplyarrangements)) {?>
                  <option value="<?php echo $watersupplyarrangements1['name'];?>" <?php  if (in_array($watersupplyarrangements1['name'], $drivercheckedval))
  {?> selected <?php } ?>><?php echo $watersupplyarrangements1['name'];?></option>
...
<tr>
<th style="border-left:1px solid #21058f;border-right:1px solid #21058f;">  <div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;;"> <select name="joineries1[]" id="joineries" multiple="multiple" style="display:block;height:67px !important;width: 109% !important;margin-left: -14px !important;margin-top: -13px;">
  	  <?php
				   $joineriesedval=explode(",",$project_table1['joineries1']);
				  $joineries = mysqli_query($GLOBALS['connect'],"SELECT * FROM  joineries order by id asc"); 
while ($joineries1 = mysqli_fetch_array($joineries)) {?>
                  <option value="<?php echo $joineries1['name'];?>" <?php  if (in_array($joineries1['name'], $joineriesedval))
  {?> selected <?php } ?>><?php echo $joineries1['name'];?></option>
<?php } ?>
    ...
    background: white;">Joineries</label> </div></th><th></th>
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border-left:1px solid #f60707; border-right:1px solid #f60707; "><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;height: 22px  !important;"> <select name="roadfacilities1" id="roadfacilities" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Road Type</option>
<option value="" >Wide</option>
<option <?php if($project_table1['roadfacilities1']=='Public') {?> <?php } ?> value="Public" >Public</option>
<option <?php if($project_table1['roadfacilities1']=='Private') {?> <?php } ?> value="Private" >Private</option>
</select><label  for="roadfacilities" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Road Facilities</label> </div>
	
	
<div class="input-field col s12 divheight  address secondborder roadfacilitiesyes"  style="width:95%;height: 22px  !important;"> <select name="roadfacilitiesyes1" id="roadfacilitiesyes" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<?php
				  $roadfacilities = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roadfacilities order by id asc"); 
while ($roadfacilities1 = mysqli_fetch_array($roadfacilities)) {?>
                  <option value="<?php echo $roadfacilities1['id'];?>" <?php if($roadfacilities1['id']==$project_table1['roadfacilitiesyes1']) {?> selected <?php } ?>><?php echo $roadfacilities1['name'];?></option>
<?php } ?>
</select><label  for="roadfacilitiesyes" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Road Facilities</label> </div>	
...
<tr>
<th style="width:50%;border:1px solid #21058f;">
<div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;;"> <select name="cornerplotintermittentplot1" id="cornerplotintermittentplot" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Type of Plot</option>
<?php
				  $typeofconstruction = mysqli_query($GLOBALS['connect'],"SELECT * FROM  cornerintermittentcommerciallot where delete_status='0' order by id asc"); 
while ($typeofconstruction1 = mysqli_fetch_array($typeofconstruction)) {?>
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border:1px solid #f60707; "><div class="input-field col s12 purchase secondborder"><select name="characteroflocality1" id="characteroflocality" style="display:block;height:33px !important;width: 103% !important;margin-left: -14px !important;">
<option value="" >Character of Locality</option>
  <?php
				  $characteroflocality = mysqli_query($GLOBALS['connect'],"SELECT * FROM  characteroflocality order by id asc"); 
while ($characteroflocality1 = mysqli_fetch_array($characteroflocality)) {?>
                  <option value="<?php echo $characteroflocality1['id'];?>" <?php if($characteroflocality1['id']==$project_table1['characteroflocality1']) {?> selected <?php } ?>><?php echo $characteroflocality1['name'];?></option>
<?php } ?>
</select><label  for="characteroflocality" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Character of Locality </label></div></th>
...
<?php 
 $floorselect=explode(",",$project_table1['floorselect1']);
$floorfinish=explode(",",$project_table1['floorfinish1']);
$roofingselect=explode(",",$project_table1['roofingselect1']);
if($project_table1['floorselect']!='') {
foreach($floorselect as $floorselectcount =>$key) {  echo $floorselect[$floorselectcount]; ?>

<tr><td><select class="selectin" name="floorselect1[]" id="floorselect"  style="    display: block;"><option value="" selected>Select</option>
                  <option value="Basement" <?php if($floorselect[$floorselectcount]=='Basement') {?> selected <?php } ?>>Basement</option>
                  <option value="Ground" <?php if($floorselect[$floorselectcount]=='Ground') {?> selected <?php } ?>>Ground</option><option value="First" <?php if($floorselect[$floorselectcount]=='First') {?> selected <?php } ?>>First</option><option value="Second" <?php if($floorselect[$floorselectcount]=='Second') {?> selected <?php } ?>>Second</option>
				  <option value="Third" <?php if($floorselect[$floorselectcount]=='Third') {?> selected <?php } ?>>Third</option>
				  <option value="Third" <?php if($floorselect[$floorselectcount]=='4th') {?> selected <?php } ?>>4th</option>
				  <option value="Third" <?php if($floorselect[$floorselectcount]=='5th') {?> selected <?php } ?>>5th</option>
				  </select></td><td><select class="selectin" name="floorfinish1[]" id="floorfinish" style="    display: block;"><option value="" selected >Select</option>
                  <option value="Tiles" <?php if($floorfinish[$floorselectcount]=='Tiles') {?> selected <?php } ?>>Tiles</option><option value="Mosaic" <?php if($floorfinish[$floorselectcount]=='Mosaic') {?> selected <?php } ?>>Mosaic</option><option value="C.M" <?php if($floorfinish[$floorselectcount]=='C.M') {?> selected <?php } ?>>C.M
</option><option value="Granite" <?php if($floorfinish[$floorselectcount]=='Granite') {?> selected <?php } ?>>Granite</option><option value="Marble" <?php if($floorfinish[$floorselectcount]=='Marble') {?> selected <?php } ?>>Marble</option><option value="Italian Marble" <?php if($floorfinish[$floorselectcount]=='Italian Marble') {?> selected <?php } ?>>Italian Marble</option><option value="Co Stone" <?php if($floorfinish[$floorselectcount]=='Co Stone') {?> selected <?php } ?>>Co Stone</option></select></td><td><select class="selectin" name="roofingselect1[]" id="roofingselect" style="    display: block;">
                  <option value="" selected>Select</option>
				  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
while ($roof1 = mysqli_fetch_array($roof)) {?>
...
<tr>
<td style="border-left:1px solid gray;border-right:1px solid gray;border-bottom:1px solid gray;    padding: 10px;">	<select name="floorselect1[]" id="floorselect" style="display:block;height:33px !important;">
<option value="" selected>Select</option>
<option value="Basement">Basement</option>
<option value="Ground">Ground</option>
<option value="First">First</option>
...
<option value="4th">4th</option>
<option value="5th">5th</option>
</select></td><td style="border-right:1px solid gray;border-bottom:1px solid gray;"><select name="floorfinish1[]" id="floorfinish" style="display:block;height:33px !important;">
   <option value="" selected>Select</option>
 <option value="Tiles">Tiles</option><option value="Mosaic">Mosaic</option><option value="C.M">C.M
</option><option value="Granite">Granite</option><option value="Marble">Marble</option><option value="Italian Marble">Italian Marble</option><option value="Co Stone">Co Stone</option>
</select></td><td style="border-right:1px solid gray;border-bottom:1px solid gray;"><select name="roofingselect1[]" id="roofingselect" style="display:block;height:33px !important;">
   <option value="" selected>Select</option>
  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
while ($roof1 = mysqli_fetch_array($roof)) {?>
...
<thead>
<tr>
<th style="border: 1px solid gray;">Services  <label><input type="checkbox" class="filled-in" name="servicevisible1" id="servicevisible" <?php if($project_table1['servicevisible1']=='Yes') { ?> checked<?php } ?> value="Yes"><span>Visible</span></label> </th><th style="border: 1px solid gray;"></th>
</tr>
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;width:60%;">Water Supply Arrangements (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="watersupplyarrangementsRs" name="watersupplyarrangementsRs1" type="number" value="<?php echo $project_table1['watersupplyarrangementsRs1'];?>"></th>
...
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Drainage Arrangements (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="drainagearrangementsRs" name="drainagearrangementsRs1" type="number" value="<?php echo $project_table1['drainagearrangementsRs1'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Compound Wall L
<br>
<input  class="compoundwalltotal" id="compoundwallL1" name="compoundwallL11" type="text" value="<?php echo $project_table1['compoundwallL11'];?>" style="    width: 10%;" placeholder="L" value="">
<input  class="compoundwalltotal" id="compoundwallL2" name="compoundwallL21" type="text" value="<?php echo $project_table1['compoundwallL21'];?>" style="    width: 10%;"  placeholder="B"  value="">
<input  class="compoundwalltotal" id="compoundwallLtot" name="compoundwallLtot1" type="text" value="<?php echo $project_table1['compoundwallLtot1'];?>" style="    width: 30%;"  placeholder="Sqft">
<input  class="compoundwalltotal" id="compoundwallrate" name="compoundwallrate1" type="number" value="<?php echo $project_table1['compoundwallrate1'];?>" style="    width: 30%;"  placeholder="Rate">

</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="compoundwallRs" name="compoundwallRs1" type="text" value="<?php echo $project_table1['compoundwallRs1'];?>"></th>

</tr>

<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">
Sump<input  class="sumpclass" id="sump" name="sump1" type="text" value="<?php echo $project_table1['sump1'];?>" placeholder="Rs" style="width: 40%;margin-left: 52px;" value="">
<br>OH Tank<input class="sumpclass" id="oht" name="oht1" type="text" value="<?php echo $project_table1['oht1'];?>"  placeholder="Rs" style="width: 31%;margin-left: 30px;" value="">
<br>Sintex<input class="sumpclass" id="sintex" name="sintex1" type="text" value="<?php echo $project_table1['sintex1'];?>" placeholder="Rs" style="width: 39%;margin-left: 47px;" value=""></th>

<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="sumpohtRs" name="sumpohtRs1" type="number" value="<?php echo $project_table1['sumpohtRs1'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">E.B Deposit <div style="    width: 150px !important;
    margin-left: 114px;
    margin-top: -20px;"><select name="ebdepositI1" id="ebdepositI" style="    width: 100%;display:block;">
                  <option value="" >Select</option>
                  <option <?php if($project_table1['ebdepositI1']=='I Phase') {?> selected <?php } ?> value="I Phase" >I Phase</option>
				  <option <?php if($project_table1['ebdepositI1']=='III Phase') {?> selected <?php } ?>  value="III Phase" >III Phase</option>
                </select></div>
No.of Services <input class="compoundwalltotal" id="ebdep1" name="ebdep11" type="text" value="<?php echo $project_table1['ebdep11'];?>" style="    width: 40%;margin-top: 4%;" placeholder="No.of Services">
		</th>
				<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="ebdepositRs" name="ebdepositRs1" type="number" value="<?php echo $project_table1['ebdepositRs1'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Pavar/Cement/Tiles    <p class="mb-1">
              ...
              <label>
                <input type="checkbox" <?php  $checkedval=explode(",",$project_table1['pavertype1']);	 if (in_array('Pavements', $checkedval))
  {?> checked <?php } ?>  value="Pavements" name="pavertype1[]" id="pavertype"/>
                <span style="color: black;">Pavar</span>
              </label>
			  
			    <label>
                <input type="checkbox" <?php 	 if (in_array('Cement', $checkedval))
  {?> checked <?php } ?>  value="Cement" name="pavertype1[]" id="pavertype"/>
                <span style="color: black;">Cement</span>
              </label>
		    ...
		    <label>
                <input type="checkbox" <?php  	 if (in_array('Tiles', $checkedval))
  {?> checked <?php } ?>  value="Tiles" name="pavertype1[]" id="pavertype"/>
                <span style="color: black;">Tiles</span>
              </label>
		  
		  
            </p></th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="paverrs" name="paverrs1" type="number" value="<?php echo $project_table1['paverrs1'];?>">
</th>
...
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;"> Interior / Exterior (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="servicetotal" id="interiorworkRs" name="interiorworkRs1" type="number" value="<?php echo $project_table1['interiorworkRs1'];?>"></th>
</tr>
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Open / Stair head (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="servicetotal" id="openstaircaseRs" name="openstaircaseRs1" type="number" value="<?php echo $project_table1['openstaircaseRs1'];?>"></th>

</tr>
<tr>
<th style="width: 25%;border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;" class="serviceshow" id="serviceshow">Total</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="serviceovertotal" id="serviceovertotal" name="serviceovertotal1" type="text" value="<?php echo $project_table1['serviceovertotal1'];?>"></th>
</tr>
...
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="width:50%;"<?php } else { ?> style="border-left:1px solid #21058f;border-right:1px solid #21058f;"  <?php } ?>> <div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;;"> <select name="typeofconstruction2" id="typeofconstruction" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Type of Construction</option>
<?php
				  $typeofconstruction = mysqli_query($GLOBALS['connect'],"SELECT * FROM  typeofconstruction order by id asc"); 
while ($typeofconstruction1 = mysqli_fetch_array($typeofconstruction)) {?>
                  <option value="<?php echo $typeofconstruction1['id'];?>" <?php if($typeofconstruction1['id']==$project_table1['typeofconstruction2']) {?> selected <?php } ?>><?php echo $typeofconstruction1['name'];?></option>
<?php } ?>
</select><label  for="typeofconstruction" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Type of Construction </label> </div></th><th></th>
...
<th style="border-left:1px solid #f60707; border-right:1px solid #f60707;"><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;;"> <select name="maintenanceofthebuilding2" id="maintenanceofthebuilding" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Building Maintenance</option>
 <?php
				  $maintananceofthebuilding = mysqli_query($GLOBALS['connect'],"SELECT * FROM  maintananceofthebuilding order by id asc"); 
while ($maintananceofthebuilding1 = mysqli_fetch_array($maintananceofthebuilding)) {?>
                  <option value="<?php echo $maintananceofthebuilding1['id'];?>" <?php if($maintananceofthebuilding1['id']==$project_table1['maintenanceofthebuilding2']) {?> selected <?php } ?>><?php echo $maintananceofthebuilding1['name'];?></option>
<?php } ?>
</select><label  for="maintenanceofthebuilding" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Building Maintenance</label> </div></th>
...
<th style="border:1px solid #21058f;">
<div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;height: 55px !important;"> <select name="drainagearrangements2" id="drainagearrangements" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Drainage Arrangements</option>
 <?php
				  $drainagearrangements = mysqli_query($GLOBALS['connect'],"SELECT * FROM  drainagearrangements order by id asc"); 
while ($drainagearrangements1 = mysqli_fetch_array($drainagearrangements)) {?>
                  <option value="<?php echo $drainagearrangements1['id'];?>" <?php if($drainagearrangements1['id']==$project_table1['drainagearrangements2']) {?> selected <?php } ?>><?php echo $drainagearrangements1['name'];?></option>
<?php } ?>
</select><label  for="drainagearrangements" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Drainage Arrangements</label> </div>
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border:1px solid #f60707; "><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;;"> <select name="watersupplyarrangements2[]" id="watersupplyarrangements" multiple="multiple" style="display:block;height:67px !important;width: 109% !important;margin-left: -14px !important;margin-top: -13px;">
  <?php
				  $drivercheckedval=explode(",",$project_table1['watersupplyarrangements2']);
				  $watersupplyarrangements = mysqli_query($GLOBALS['connect'],"SELECT * FROM  watersupplyarrangements order by id asc"); 
while ($watersupplyarrangements1 = mysqli_fetch_array($watersupplyarrangements)) {?>
                  <option value="<?php echo $watersupplyarrangements1['name'];?>" <?php  if (in_array($watersupplyarrangements1['name'], $drivercheckedval))
  {?> selected <?php } ?>><?php echo $watersupplyarrangements1['name'];?></option>
...
<tr>
<th style="border-left:1px solid #21058f;border-right:1px solid #21058f;">  <div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;;"> <select name="joineries2[]" id="joineries" multiple="multiple" style="display:block;height:67px !important;width: 109% !important;margin-left: -14px !important;margin-top: -13px;">
  	  <?php
				   $joineriesedval=explode(",",$project_table1['joineries2']);
				  $joineries = mysqli_query($GLOBALS['connect'],"SELECT * FROM  joineries order by id asc"); 
while ($joineries1 = mysqli_fetch_array($joineries)) {?>
                  <option value="<?php echo $joineries1['name'];?>" <?php  if (in_array($joineries1['name'], $joineriesedval))
  {?> selected <?php } ?>><?php echo $joineries1['name'];?></option>
<?php } ?>
    ...
    background: white;">Joineries</label> </div></th><th></th>
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border-left:1px solid #f60707; border-right:1px solid #f60707; "><div class="input-field col s12 divheight  address secondborder property_address_limit"  style="width:95%;height: 22px  !important;"> <select name="roadfacilities2" id="roadfacilities" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Road Type</option>
<option value="" >Wide</option>
<option <?php if($project_table1['roadfacilities2']=='Public') {?> <?php } ?> value="Public" >Public</option>
<option <?php if($project_table1['roadfacilities2']=='Private') {?> <?php } ?> value="Private" >Private</option>
</select><label  for="roadfacilities" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Road Facilities</label> </div>
	
	
<div class="input-field col s12 divheight  address secondborder roadfacilitiesyes"  style="width:95%;height: 22px  !important;"> <select name="roadfacilitiesyes2" id="roadfacilitiesyes" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<?php
				  $roadfacilities = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roadfacilities order by id asc"); 
while ($roadfacilities1 = mysqli_fetch_array($roadfacilities)) {?>
                  <option value="<?php echo $roadfacilities1['id'];?>" <?php if($roadfacilities1['id']==$project_table1['roadfacilitiesyes2']) {?> selected <?php } ?>><?php echo $roadfacilities1['name'];?></option>
<?php } ?>
</select><label  for="roadfacilitiesyes" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Road Facilities</label> </div>	
...
<tr>
<th style="width:50%;border:1px solid #21058f;">
<div class="input-field col s12 divheight  address firstborder property_address_limit"  style="width:95%;;"> <select name="cornerplotintermittentplot2" id="cornerplotintermittentplot" style="display:block;height:33px !important;width: 109% !important;margin-left: -14px !important;">
<option value="" >Type of Plot</option>
<?php
				  $typeofconstruction = mysqli_query($GLOBALS['connect'],"SELECT * FROM  cornerintermittentcommerciallot where delete_status='0' order by id asc"); 
while ($typeofconstruction1 = mysqli_fetch_array($typeofconstruction)) {?>
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border:1px solid #f60707; "><div class="input-field col s12 purchase secondborder"><select name="characteroflocality2" id="characteroflocality" style="display:block;height:33px !important;width: 103% !important;margin-left: -14px !important;">
<option value="" >Character of Locality</option>
  <?php
				  $characteroflocality = mysqli_query($GLOBALS['connect'],"SELECT * FROM  characteroflocality order by id asc"); 
while ($characteroflocality1 = mysqli_fetch_array($characteroflocality)) {?>
                  <option value="<?php echo $characteroflocality1['id'];?>" <?php if($characteroflocality1['id']==$project_table1['characteroflocality2']) {?> selected <?php } ?>><?php echo $characteroflocality1['name'];?></option>
<?php } ?>
</select><label  for="characteroflocality" style="margin-top: -14px;
    margin-left: 10px;
    background: white;">Character of Locality </label></div></th>
...
<?php 
 $floorselect=explode(",",$project_table1['floorselect2']);
$floorfinish=explode(",",$project_table1['floorfinish2']);
$roofingselect=explode(",",$project_table1['roofingselect2']);
if($project_table1['floorselect']!='') {
foreach($floorselect as $floorselectcount =>$key) {  echo $floorselect[$floorselectcount]; ?>

<tr><td><select class="selectin" name="floorselect2[]" id="floorselect"  style="    display: block;"><option value="" selected>Select</option>
                  <option value="Basement" <?php if($floorselect[$floorselectcount]=='Basement') {?> selected <?php } ?>>Basement</option>
                  <option value="Ground" <?php if($floorselect[$floorselectcount]=='Ground') {?> selected <?php } ?>>Ground</option><option value="First" <?php if($floorselect[$floorselectcount]=='First') {?> selected <?php } ?>>First</option><option value="Second" <?php if($floorselect[$floorselectcount]=='Second') {?> selected <?php } ?>>Second</option>
				  <option value="Third" <?php if($floorselect[$floorselectcount]=='Third') {?> selected <?php } ?>>Third</option>
				  <option value="Third" <?php if($floorselect[$floorselectcount]=='4th') {?> selected <?php } ?>>4th</option>
				  <option value="Third" <?php if($floorselect[$floorselectcount]=='5th') {?> selected <?php } ?>>5th</option>
				  </select></td><td><select class="selectin" name="floorfinish2[]" id="floorfinish" style="    display: block;"><option value="" selected >Select</option>
                  <option value="Tiles" <?php if($floorfinish[$floorselectcount]=='Tiles') {?> selected <?php } ?>>Tiles</option><option value="Mosaic" <?php if($floorfinish[$floorselectcount]=='Mosaic') {?> selected <?php } ?>>Mosaic</option><option value="C.M" <?php if($floorfinish[$floorselectcount]=='C.M') {?> selected <?php } ?>>C.M
</option><option value="Granite" <?php if($floorfinish[$floorselectcount]=='Granite') {?> selected <?php } ?>>Granite</option><option value="Marble" <?php if($floorfinish[$floorselectcount]=='Marble') {?> selected <?php } ?>>Marble</option><option value="Italian Marble" <?php if($floorfinish[$floorselectcount]=='Italian Marble') {?> selected <?php } ?>>Italian Marble</option><option value="Co Stone" <?php if($floorfinish[$floorselectcount]=='Co Stone') {?> selected <?php } ?>>Co Stone</option></select></td><td><select class="selectin" name="roofingselect2[]" id="roofingselect" style="    display: block;">
                  <option value="" selected>Select</option>
				  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
while ($roof1 = mysqli_fetch_array($roof)) {?>
...
<tr>
<td style="border-left:1px solid gray;border-right:1px solid gray;border-bottom:1px solid gray;    padding: 10px;">	<select name="floorselect2[]" id="floorselect" style="display:block;height:33px !important;">
<option value="" selected>Select</option>
<option value="Basement">Basement</option>
<option value="Ground">Ground</option>
<option value="First">First</option>
...
<option value="4th">4th</option>
<option value="5th">5th</option>
</select></td><td style="border-right:1px solid gray;border-bottom:1px solid gray;"><select name="floorfinish2[]" id="floorfinish" style="display:block;height:33px !important;">
   <option value="" selected>Select</option>
 <option value="Tiles">Tiles</option><option value="Mosaic">Mosaic</option><option value="C.M">C.M
</option><option value="Granite">Granite</option><option value="Marble">Marble</option><option value="Italian Marble">Italian Marble</option><option value="Co Stone">Co Stone</option>
</select></td><td style="border-right:1px solid gray;border-bottom:1px solid gray;"><select name="roofingselect2[]" id="roofingselect" style="display:block;height:33px !important;">
   <option value="" selected>Select</option>
  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
while ($roof1 = mysqli_fetch_array($roof)) {?>
...
<thead>
<tr>
<th style="border: 1px solid gray;">Services  <label><input type="checkbox" class="filled-in" name="servicevisible2" id="servicevisible" <?php if($project_table1['servicevisible2']=='Yes') { ?> checked<?php } ?> value="Yes"><span>Visible</span></label> </th><th style="border: 1px solid gray;"></th>
</tr>
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;width:60%;">Water Supply Arrangements (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="watersupplyarrangementsRs" name="watersupplyarrangementsRs2" type="number" value="<?php echo $project_table1['watersupplyarrangementsRs2'];?>"></th>
...
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Drainage Arrangements (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="drainagearrangementsRs" name="drainagearrangementsRs2" type="number" value="<?php echo $project_table1['drainagearrangementsRs2'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Compound Wall L
<br>
<input  class="compoundwalltotal" id="compoundwallL1" name="compoundwallL12" type="text" value="<?php echo $project_table1['compoundwallL12'];?>" style="    width: 10%;" placeholder="L" value="">
<input  class="compoundwalltotal" id="compoundwallL2" name="compoundwallL22" type="text" value="<?php echo $project_table1['compoundwallL22'];?>" style="    width: 10%;"  placeholder="B"  value="">
<input  class="compoundwalltotal" id="compoundwallLtot" name="compoundwallLtot2" type="text" value="<?php echo $project_table1['compoundwallLtot2'];?>" style="    width: 30%;"  placeholder="Sqft">
<input  class="compoundwalltotal" id="compoundwallrate" name="compoundwallrate2" type="number" value="<?php echo $project_table1['compoundwallrate2'];?>" style="    width: 30%;"  placeholder="Rate">

</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="compoundwallRs" name="compoundwallRs2" type="text" value="<?php echo $project_table1['compoundwallRs2'];?>"></th>

</tr>

<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">
Sump<input  class="sumpclass" id="sump" name="sump2" type="text" value="<?php echo $project_table1['sump2'];?>" placeholder="Rs" style="width: 40%;margin-left: 52px;" value="">
<br>OH Tank<input class="sumpclass" id="oht" name="oht2" type="text" value="<?php echo $project_table1['oht2'];?>"  placeholder="Rs" style="width: 31%;margin-left: 30px;" value="">
<br>Sintex<input class="sumpclass" id="sintex" name="sintex2" type="text" value="<?php echo $project_table1['sintex2'];?>" placeholder="Rs" style="width: 39%;margin-left: 47px;" value=""></th>

<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="sumpohtRs" name="sumpohtRs2" type="number" value="<?php echo $project_table1['sumpohtRs2'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">E.B Deposit <div style="    width: 150px !important;
    margin-left: 114px;
    margin-top: -20px;"><select name="ebdepositI2" id="ebdepositI" style="    width: 100%;display:block;">
                  <option value="" >Select</option>
                  <option <?php if($project_table1['ebdepositI2']=='I Phase') {?> selected <?php } ?> value="I Phase" >I Phase</option>
				  <option <?php if($project_table1['ebdepositI2']=='III Phase') {?> selected <?php } ?>  value="III Phase" >III Phase</option>
                </select></div>
No.of Services <input class="compoundwalltotal" id="ebdep1" name="ebdep12" type="text" value="<?php echo $project_table1['ebdep12'];?>" style="    width: 40%;margin-top: 4%;" placeholder="No.of Services">
		</th>
				<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="ebdepositRs" name="ebdepositRs2" type="number" value="<?php echo $project_table1['ebdepositRs2'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Pavar/Cement/Tiles    <p class="mb-1">
              ...
              <label>
                <input type="checkbox" <?php  $checkedval=explode(",",$project_table1['pavertype2']);	 if (in_array('Pavements', $checkedval))
  {?> checked <?php } ?>  value="Pavements" name="pavertype2[]" id="pavertype"/>
                <span style="color: black;">Pavar</span>
              </label>
			  
			    <label>
                <input type="checkbox" <?php 	 if (in_array('Cement', $checkedval))
  {?> checked <?php } ?>  value="Cement" name="pavertype2[]" id="pavertype"/>
                <span style="color: black;">Cement</span>
              </label>
		    ...
		    <label>
                <input type="checkbox" <?php  	 if (in_array('Tiles', $checkedval))
  {?> checked <?php } ?>  value="Tiles" name="pavertype2[]" id="pavertype"/>
                <span style="color: black;">Tiles</span>
              </label>
		  
		  
            </p></th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="paverrs" name="paverrs2" type="number" value="<?php echo $project_table1['paverrs2'];?>">
</th>
...
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;"> Interior / Exterior (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="servicetotal" id="interiorworkRs" name="interiorworkRs2" type="number" value="<?php echo $project_table1['interiorworkRs2'];?>"></th>
</tr>
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Open / Stair head (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="servicetotal" id="openstaircaseRs" name="openstaircaseRs2" type="number" value="<?php echo $project_table1['openstaircaseRs2'];?>"></th>

</tr>
<tr>
<th style="width: 25%;border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;" class="serviceshow" id="serviceshow">Total</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="serviceovertotal" id="serviceovertotal" name="serviceovertotal2" type="text" value="<?php echo $project_table1['serviceovertotal2'];?>"></th>
</tr>
...
<thead>
 <tr>
                    ...
                    <th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Type Of Roofing</th>	
                    <th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;">Deprciation</th>
                    <th style="border-right:1px solid gray;border-bottom:1px solid gray;border-top:1px solid gray;"
					>Total</th>					
...
<tr><td><select class="selectin" name="floorselect[]" id="floorselect" ><option value="" selected>Select</option>
				  ...
				  <option value="Third" <?php if($floorselect[$floorselectcount]=='4th') {?> selected <?php } ?>>4th</option>
				  <option value="Third" <?php if($floorselect[$floorselectcount]=='5th') {?> selected <?php } ?>>5th</option>
				  </select></td><td><select class="selectin" name="floorfinish[]" id="floorfinish" ><option value="" selected >Select</option>
                  <option value="Tiles" <?php if($floorfinish[$floorselectcount]=='Tiles') {?> selected <?php } ?>>Tiles</option><option value="Mosaic" <?php if($floorfinish[$floorselectcount]=='Mosaic') {?> selected <?php } ?>>Mosaic</option><option value="C.M" <?php if($floorfinish[$floorselectcount]=='C.M') {?> selected <?php } ?>>C.M
...
<thead>
<tr>
<th style="border: 1px solid gray;">Services  <label><input type="checkbox" class="filled-in" name="servicevisible" id="servicevisible" <?php if($project1['servicevisible']=='Yes') { ?> checked<?php } ?> value="Yes"><span>Visible</span></label> </th><th style="border: 1px solid gray;"></th>
</tr>
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;width:60%;">Water Supply Arrangements (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="watersupplyarrangementsRs" name="watersupplyarrangementsRs" type="number" value="<?php echo $project1['watersupplyarrangementsRs'];?>"></th>
...
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Drainage Arrangements (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="drainagearrangementsRs" name="drainagearrangementsRs" type="number" value="<?php echo $project1['drainagearrangementsRs'];?>"></th>
...
<input  class="compoundwalltotal" id="compoundwallLtot" name="compoundwallLtot" type="text" value="<?php echo $project1['compoundwallLtot'];?>" style="    width: 30%;"  placeholder="Sqft">
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="sumpohtRs" name="sumpohtRs" type="number" value="<?php echo $project1['sumpohtRs'];?>"></th>
...
No.of Services <input class="compoundwalltotal" id="ebdep1" name="ebdep1" type="text" value="<?php echo $project1['ebdep1'];?>" style="    width: 40%;margin-top: 4%;" placeholder="No.of Services">
				...
				<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="ebdepositRs" name="ebdepositRs" type="number" value="<?php echo $project1['ebdepositRs'];?>"></th>
...
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px;"><input  class="servicetotal" id="paverrs" name="paverrs" type="number" value="<?php echo $project1['paverrs'];?>">
</th>
...
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;"> Interior / Exterior (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="servicetotal" id="interiorworkRs" name="interiorworkRs" type="number" value="<?php echo $project1['interiorworkRs'];?>"></th>
</tr>
<tr>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-left: 1px solid gray;border-right: 1px solid gray;padding: 5px;">Open / Stair head (Rs)</th>
<th class="serviceshow" id="serviceshow" style="border-bottom: 1px solid gray;border-right: 1px solid gray;padding: 5px"><input  class="servicetotal" id="openstaircaseRs" name="openstaircaseRs" type="number" value="<?php echo $project1['openstaircaseRs'];?>"></th>
 ...
 <tr>
                ...
                <tbody>
				   ...
				   <tr >
				    ...
				    <td style="width:200px;border-left:1px solid gray;border-right:1px solid gray;border-bottom:1px solid gray;    padding: 9px;"><textarea id="desc_prop" name="desc_prop[]" rows="3" cols="23" style="    height: 4rem;">
</textarea></td>
					<td style="width:200px;border-right:1px solid gray;border-bottom:1px solid gray;    padding: 9px;">
				...
				<td style="width: 53px;border-right:1px solid gray;border-bottom:1px solid gray;     padding: 9px;" class="divall"><input  id="percentage" name="percentage[]" type="text"  value=""></td>
					   ...
					   <td></td>
					    <td></td>
						 <td></td>
						  <td></td>
						   <td></td>
						    <td style="float:right;border-left:1px solid gray;border-right:1px solid gray;border-bottom:1px solid gray">Total<input  class="row-overalltotal" id="overalltotal" name="overalltotal" type="text"  value="">	<span class="removemul" style="float: left;color:red;cursor:pointer;" id="">Remove(X)</span></td>
					 </tr>
					   </tbody></table>
    <div style="    margin-top: 16px;
    margin-bottom: 16px;">		
...
{
$('#compoundwallLtot').val(compoundwallL3);  

}

var compoundwallL32 = $('#compoundwallLtot').val(); 
...
clone.find('#overalltotal').addClass('row-overalltotal' + random22);
  ...
  $(".btnadd"+ random22).click(function() { 
    $(".brow"+ random22).append(' <tr><td class="conall" style="border-left:1px solid gray;border-right:1px solid gray;border-bottom:1px solid gray;    padding: 10px;">	<select name="floorselect[]" id="floorselect" style="display:block;height:33px !important;"><option value="" selected>Select</option><option value="Ground">Ground</option><option value="First">First</option><option value="Second">Second</option><option value="Third">Third</option></select></td><td style="border-right:1px solid gray;border-bottom:1px solid gray;"><select name="floorfinish[]" id="floorfinish" style="display:block;height:33px !important;"><option value="" selected>Select</option><option value="Tiles">Tiles</option><option value="Mosaic">Mosaic</option><option value="C.M">C.M</option><option value="Granite">Granite</option><option value="Marble">Marble</option><option value="Italian Marble">Italian Marble</option><option value="Co Stone">Co Stone</option></select></td><td style="border-right:1px solid gray;border-bottom:1px solid gray;"><select name="floorfinish[]" id="floorfinish" style="display:block;height:33px !important;    width: 88%;float: left;"><option value="" selected>Select</option><?php $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); while ($roof1 = mysqli_fetch_array($roof)) {?><option value="<?php echo $roof1['id'];?>" <?php if($roofselect1[$lengthacountproper]==$roof1['id']) {?> selected <?php } ?> data-id="<?php echo $roof1['percentage'];?>"><?php echo $roof1['name'];?></option><?php } ?></select>' + '<input type="button" class="btnRemove333" value="X" style="width: 10%; background: red;color: white;border-color: red;font-weight: bold;margin-left: 5px;"/></td></tr>');
  });
...
$('#overlaynew').hide();
 ...
 $(document).ready(function() {
  ...
  $("#add").click(function(e) {
    ...
    $("#items").append(
      '<br><div class="next-referral col s12" style="    margin-top: -16px;margin-left: -14px;"><div class="col m12 s12 file-field input-field" style="width:50%;" id="taxreceiptfile"><div class="btn float-left"><span><i class="material-icons dp48">file_upload</i></span><input type="file" name="taxreceiptfile[]" ></div><div class="file-path-wrapper"><input class="file-path validate" type="text" style="   font-weight: 600; margin-left: -9px; font-size: 9px;background: white;border: 1px solid white !important;color: green;border-bottom: 1px solid;box-shadow: 0 1px 0 0 #eee;"></div></div>'
    );
  });
 ...
 $(document).ready(function() {
  ...
  $("#add1").click(function(e) {
    ...
    //Append a new row of code to the "#items" div
    $("#items1").append(
      '<br><div class="next-referral1 col s12 ebservicenofileadd" style="    margin-top: -16px;margin-left: -14px;"><div class="col m12 s12 file-field input-field" style="width:50%;" id="taxreceiptfile"><div class="btn float-left"><span><i class="material-icons dp48">file_upload</i></span><input type="file" name="ebservicenofile[]" ></div><div class="file-path-wrapper"><input class="file-path validate" type="text" style="   font-weight: 600; margin-left: -9px; font-size: 9px;background: white;border: 1px solid white !important;color: green;border-bottom: 1px solid;box-shadow: 0 1px 0 0 #eee;"></div></div>'
    );
  });
 ...
 $(document).ready(function() {
  ...
  $("#add2").click(function(e) {
    ...
    //Append a new row of code to the "#items" div
    $("#items2").append(
      '<br><div class="next-referral2 col s12 pattadtcpfileadd" style="    margin-top: -16px;margin-left: -14px;"><div class="col m12 s12 file-field input-field" style="width:50%;" id="taxreceiptfile"><div class="btn float-left"><span><i class="material-icons dp48">file_upload</i></span><input type="file" name="pattadtcpfile[]" ></div><div class="file-path-wrapper"><input class="file-path validate" type="text" style="   font-weight: 600; margin-left: -9px; font-size: 9px;background: white;border: 1px solid white !important;color: green;border-bottom: 1px solid;box-shadow: 0 1px 0 0 #eee;"></div></div>'
    );
  });
 ...
 $(document).ready(function() {
  ...
  $("#add3").click(function(e) {
    ...
    //Append a new row of code to the "#items" div
    $("#items3").append(
      '<br><div class="next-referral3 col s12 approvalplanfileadd" style="    margin-top: -16px;margin-left: -14px;"><div class="col m12 s12 file-field input-field" style="width:50%;" id="taxreceiptfile"><div class="btn float-left"><span><i class="material-icons dp48">file_upload</i></span><input type="file" name="approvalplanfile[]" ></div><div class="file-path-wrapper"><input class="file-path validate" type="text" style="   font-weight: 600; margin-left: -9px; font-size: 9px;background: white;border: 1px solid white !important;color: green;border-bottom: 1px solid;box-shadow: 0 1px 0 0 #eee;"></div></div>'
    );
  });
 ...
 $(document).ready(function() {
  ...
  $("#add4").click(function(e) {
    ...
    //Append a new row of code to the "#items" div
    $("#items4").append(
      '<br><div class="next-referral4 col s12 hdlinefileadd" style="    margin-top: -16px;margin-left: -14px;"><div class="col m12 s12 file-field input-field" style="width:50%;" id="taxreceiptfile"><div class="btn float-left"><span><i class="material-icons dp48">file_upload</i></span><input type="file" name="hdlinefile[]" ></div><div class="file-path-wrapper"><input class="file-path validate" type="text" style="   font-weight: 600; margin-left: -9px; font-size: 9px;background: white;border: 1px solid white !important;color: green;border-bottom: 1px solid;box-shadow: 0 1px 0 0 #eee;"></div></div>'
    );
  });
 ...
 $(document).ready(function() {
  ...
  $("#add7").click(function(e) {
    ...
    //Append a new row of code to the "#items" div
    $("#items7").append(
      '<br><div class="next-referral2 col s12" style="    margin-top: -16px;margin-left: -14px;"><div class="col m12 s12 file-field input-field" style="width:100%;" id="taxreceiptfile"><div class="btn float-left"><span><i class="material-icons dp48">file_upload</i></span><input type="file" name="refdocumentfile[]" ></div><div class="file-path-wrapper"><input class="file-path validate" type="text" style="   font-weight: 600; margin-left: -9px; font-size: 9px;background: white;border: 1px solid white !important;color: green;border-bottom: 1px solid;box-shadow: 0 1px 0 0 #eee;"></div></div>'
    );
  });
