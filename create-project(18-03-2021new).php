...
$ownerAddress=implode("--,",$_POST['ownerAddress']); 
...
else
{
     ...
     $query = "insert into project_details(ocontact,opincode,bank,parea,date,loanAmount,inspected,companyName,advanceAmount,ownerAddress,purchaseAddress,odoorno,ostreet,oarea,opost,otaluk,odistrict,pdoorno,pstreet,pvillage,ptaluk,pdistrict,date_time,log_id) values ('$ocontact','$opincode','$bank','$parea','$date','$loanAmount','$inspected','$companyName','$advanceAmount','$ownerAddress','$purchaseAddress','$odoorno','$ostreet','$oarea','$opost','$otaluk','$odistrict','$pdoorno','$pstreet','$pvillage','$ptaluk','$pdistrict','$date_time','$log_id')";
...
$hdline=$_POST['hdline']; 
 $residentialautofill=$_POST['residentialautofill'];

$oldsfno=$_POST['oldsfno']; 
$sfno=$_POST['sfno'];
$pymashno=$_POST['pymashno'];
$wardno=$_POST['wardno'];
...
$roof1=implode(",",$_POST['roof1']); 
$roof2=implode(",",$_POST['roof2']); 
$roof3=implode(",",$_POST['roof3']); 
$roof4=implode(",",$_POST['roof4']); 
$roof5=implode(",",$_POST['roof5']); 
...
<tr>
<th>Loan Amount: </th>
<th><input  id="loanAmount" name="loanAmount" type="number" value="<?php echo $project1['loanAmount'];?>"></th>
<?php if ($detect->isMobile()){?> </tr><tr> <?php } ?>
<th>Inspected:	</th>
...
foreach($ownerAddress2 as $lengthacountproper2 =>$key) {	?><div id="a">	<input  id="ownerAddress" name="ownerAddress[]" type="text" value="<?php echo $key;?>"  style=" width: 70%;"><input type="button" class="btnRemove" value="X" style=" width: 10%;background: red;color: white;border-color: red;font-weight: bold;"/></div> <?php } } else { ?> <div id="a">	<input  id="ownerAddress" name="ownerAddress[]" type="text" value=""></div> <?php } ?>
...
<th  class="purchaseyescheck">i) Door No:	</th>
<th  class="purchaseyescheck"><input  id="pdoorno" class="purchaseyescheck" name="pdoorno" type="text" value="<?php echo $project1['pdoorno'];?>"></th>
</tr>
<tr>
<th>ii) Street: </th>
<th> <input  id="ostreet" name="ostreet" type="text" value="<?php echo $project1['ostreet'];?>"></th>
<th  class="purchaseyescheck">ii) Street:	</th>
<th  class="purchaseyescheck"> <input  id="pstreet" class="purchaseyescheck" name="pstreet" type="text" value="<?php echo $project1['pstreet'];?>"></th>
</tr>
<tr>
<th>iii) Area: </th>
<th >   <input  id="oarea" name="oarea" type="text" value="<?php echo $project1['oarea'];?>"></th>
<th  class="purchaseyescheck">iii) Area:	</th>
<th  class="purchaseyescheck"> <input  id="parea" class="purchaseyescheck" name="parea" type="text" value="<?php echo $project1['parea'];?>"></th>
</tr>
<tr>
<th>vi) Post: </th>
<th>  <input  id="opost" name="opost" type="text" value="<?php echo $project1['opost'];?>"></th>
<th  class="purchaseyescheck">vi) Post:	</th>
<th  class="purchaseyescheck"> <input  id="ppost" class="purchaseyescheck" name="ppost" type="text" value="<?php echo $project1['ppost'];?>"></th>
</tr>
<tr>
<th>v) Taluk: </th>
<th ><input  id="otaluk" name="otaluk" type="text" value="<?php echo $project1['otaluk'];?>"></th>
<th  class="purchaseyescheck">v) Taluk:	</th>
<th  class="purchaseyescheck"><input  id="ptaluk" class="purchaseyescheck" name="ptaluk" type="text" value="<?php echo $project1['ptaluk'];?>"></th>
</tr>
<tr>
<th>vi) District: </th>
<th><input  id="odistrict" name="odistrict" type="text" value="<?php echo $project1['odistrict'];?>"></th>
<th  class="purchaseyescheck">vi) District:	</th>
<th  class="purchaseyescheck"><input  id="pdistrict" class="purchaseyescheck" name="pdistrict" type="text" value="<?php echo $project1['pdistrict'];?>"></th>
</tr>	
<tr>
<th>vii) Pincode: </th>
<th><input  id="opincode" name="opincode" type="text" value="<?php echo $project1['opincode'];?>"></th>
<th  class="purchaseyescheck">vii) Pincode::	</th>
<th  class="purchaseyescheck"><input  id="ppincode" class="purchaseyescheck" name="ppincode" type="text" value="<?php echo $project1['ppincode'];?>"></th>
</tr>	
<tr>
<th>viii) Contact: </th>
<th><input  id="ocontact" name="ocontact" type="text" value="<?php echo $project1['ocontact'];?>"></th>
<th  class="purchaseyescheck">viii) Contact::	</th>
<th  class="purchaseyescheck"><input  id="pcontact" class="purchaseyescheck" name="pcontact" type="text" value="<?php echo $project1['pcontact'];?>"></th>
</tr>		
 </thead>
</table> 
		 ...
		 <div class="col xl6 s4 mb-3">
					 
					  <input type="submit"  name="save"  value="Save"  style="  background-color:  #d32e09;width: 15%;color:white;    color: white;
    border-radius: 9px;
    padding: 8px;
    border-color: #d32e09;">
					 ...
					 <input type="submit"  name="next"  value="Next >"  style="  background-color: green;width: 15%;color:white;    color: white;
    border-radius: 9px;
    padding: 8px;
    border-color: green;" >
...
<th style="width: 39%;">   <input  id="propertydoorno" name="propertydoorno" type="text" value="<?php echo $project1['propertydoorno'];?>" > 

<input  id="propertydoornof" name="propertydoornof" type="hidden" value="<?php echo $project1['odoorno'];?>" ></th>
...
<tr>
<th>ii) Street</th>
<th>   <input  id="propertystreet" name="propertystreet" type="text" value="<?php echo $project1['propertystreet'];?>">  <input  id="propertystreetf" name="propertystreetf" type="hidden" value="<?php echo $project1['ostreet'];?>"> </th>
<th>ii) S.F NO</th>
<th> <input  id="sfno" name="sfno" type="text" value="<?php echo $project1['sfno'];?>"></th>
</tr>
<tr>
<th>iii) Area</th>
<th>  <input  id="propertyarea" name="propertyarea" type="text" value="<?php echo $project1['propertyarea'];?>"> <input  id="propertyareaf" name="propertyareaf" type="hidden" value="<?php echo $project1['oarea'];?>"></th>
<th>iii) Patta No</th>
<th>   <input  id="pattano" name="pattano" type="text" value="<?php echo $project1['pattano'];?>"></th>
</tr>
<tr>
<th>iv) Village</th>
<th> <input  id="propertyvillage" name="propertyvillage" type="text" value="<?php echo $project1['propertyvillage'];?>"> <input  id="propertyvillagef" name="propertyvillagef" type="hidden" value="<?php echo $project1['opost'];?>"></th>
<th>iv) R.S.F No</th>
<th>  <input  id="rsfno" name="rsfno" type="text" value="<?php echo $project1['rsfno'];?>"></th>
</tr>
<tr>
<th>v) Taluk</th>
<th>   <input  id="propertytaluk" name="propertytaluk" type="text" value="<?php echo $project1['propertytaluk'];?>">  <input  id="propertytalukf" name="propertytalukf" type="hidden" value="<?php echo $project1['otaluk'];?>"></th>
<th>v) Block No</th>
<th> <input  id="blockno" name="blockno" type="text" value="<?php echo $project1['blockno'];?>"></th>
</tr>
<tr>
<th>vi) District</th>
<th> <input  id="propertydistict" name="propertydistict" type="text" value="<?php echo $project1['propertydistict'];?>"> <input  id="propertydistictf" name="propertydistictf" type="hidden" value="<?php echo $project1['odistrict'];?>"></th>
<th>vi) Pymash No</th>
<th> <input  id="pymashno" name="pymashno" type="text" value="<?php echo $project1['pymashno'];?>"></th>
</tr>
<tr>
<th>vii) Pincode</th>
<th> <input  id="propertypincode" name="propertypincode" type="text" value="<?php echo $project1['propertypincode'];?>"> <input  id="propertypincodef" name="propertypincodef" type="hidden" value="<?php echo $project1['opincode'];?>"></th>
<th>vii) T.S.No</th>
...
<tbody <?php if($countproper1>0) {?> class="newTR<?php echo $valdel; ?>" <?php } else { ?> class="newTR1"  <?php } ?>>
				   ...
				   <tr >
		            <td>North</td>
					<td colspan="2"><input  id="boundary1" name="northboundary[]" type="text"  value="<?php echo $northboundary[$countproper1];?>" style="width: 100% !important;height: 31px !important;"></td>
				    <td><input  id="north1" name="north1[]" type="text"  value="<?php echo $north1[$countproper1];?>" style="width:20% !important;"><input  id="north2" name="north2[]" type="text" value="<?php echo $north2[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="north3" name="north3[]" type="text"  readonly value="<?php echo $north3[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
                     <td><input  id="north4" name="north4[]" type="text" value="<?php echo $north4[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="north5" name="north5[]" type="text" value="<?php echo $north5[$countproper1];?>"style="width:20% !important;margin-left: 3px;"><input  id="north6" name="north6[]" type="text" readonly value="<?php echo $north6[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
					 <td><input  id="north7" name="north7[]" type="text" value="<?php echo $north7[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="north8" name="north8[]" type="text" value="<?php echo $north8[$countproper1];?>"style="width:20% !important;margin-left: 3px;"><input  id="north9" name="north9[]" type="text" readonly value="<?php echo $north9[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
					
                  </tr> 
                  <tr>
		            <td >South</td>
					<td colspan="2"><input  id="southboundary" name="southboundary[]" type="text"  value="<?php echo $southboundary[$countproper1];?>" style="width: 100% !important;height: 31px !important;"></td>
				     <td><input  id="south1" name="south1[]" type="text" value="<?php echo $south1[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="south2" name="south2[]" type="text" value="<?php echo $south2[$countproper1];?>"style="width:20% !important;margin-left: 3px;"><input  id="south3" name="south3[]" type="text" readonly value="<?php echo $south3[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
                     <td><input  id="south4" name="south4[]" type="text" value="<?php echo $south4[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="south5" name="south5[]" type="text" value="<?php echo $south5[$countproper1];?>"style="width:20% !important;margin-left: 3px;"><input  id="south6" name="south6[]" type="text" readonly value="<?php echo $south6[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
					 <td><input  id="south7" name="south7[]" type="text" value="<?php echo $south7[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="south8" name="south8[]" type="text" value="<?php echo $south8[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="south9" name="south9[]" type="text" readonly value="<?php echo $south9[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
					
                  </tr>
                 <tr>
		            <td>East</td>
					<td colspan="2"><input  id="eastboundary" name="eastboundary[]" type="text"  value="<?php echo $eastboundary[$countproper1];?>" style="width: 100% !important;height: 31px !important;"> </td>
				      <td><input  id="east1" name="east1[]" type="text" value="<?php echo $east1[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="east2" name="east2[]" type="text" value="<?php echo $east2[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="east3" name="east3[]" type="text" readonly value="<?php echo $east3[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
                     <td><input  id="east4" name="east4[]" type="text" value="<?php echo $east4[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="east5" name="east5[]" type="text" value="<?php echo $east5[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="east6" name="east6[]" type="text" readonly value="<?php echo $east6[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
					 <td><input  id="east7" name="east7[]" type="text" value="<?php echo $east7[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="east8" name="east8[]" type="text" value="<?php echo $east8[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="east9" name="east9[]" type="text" readonly value="<?php echo $east9[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
					
                  </tr>
                      <tr>
		            <td>West</td>
					<td colspan="2"><input  id="westboundary" name="westboundary[]" type="text"  value="<?php echo $westboundary[$countproper1];?>"style="width: 100% !important;height: 31px !important;"></td>
				     <td><input  id="west1" name="west1[]" type="text" value="<?php echo $west1[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="west2" name="west2[]" type="text" value="<?php echo $west2[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="west3" name="west3[]" type="text" readonly value="<?php echo $west3[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
                     <td><input  id="west4" name="west4[]" type="text" value="<?php echo $west4[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="west5" name="west5[]" type="text" value="<?php echo $west5[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="west6" name="west6[]" type="text" readonly value="<?php echo $west6[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
					 <td><input  id="west7" name="west7[]" type="text" value="<?php echo $west7[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="west8" name="west8[]" type="text" value="<?php echo $west8[$countproper1];?>" style="width:20% !important;margin-left: 3px;"><input  id="west9" name="west9[]" type="text" readonly value="<?php echo $west9[$countproper1];?>" style="width:20% !important;margin-left: 3px;"></td>
 ...
 <tr>
					...
					<td>Total Area<br><input  id="totalarea" class="totalareacal" name="totalarea[]" readonly type="text" value="<?php echo $totalarea[$countproper1];?>"></td>
...
if($project1['roof5']!='') {
	...
	<div id="a1" style="    margin-bottom: 11px;">
	<?php
foreach($roof2 as $lengthacountproper2 =>$key) {	?>	<div class="con1" style="  "><select name="roof5[]" id="roof" style="display:block;    border: 1px solid;
    margin-top: 33px;">
                  <option value="" selected>Roof</option>
				  <?php
				  $roof = mysqli_query($GLOBALS['connect'],"SELECT * FROM  roof order by id asc"); 
...
<?php } } else { ?> 
 ...
 <tbody class="newTR1">
				   ...
				   <tr >
		            <td>North</td>
					<td colspan="2"><input  id="boundary1" name="northboundary[]" type="text"  value="" style="width: 100% !important;height: 31px !important;"></td>
				    <td><input  id="north1" name="north1[]" type="text"  value="" style="width:20% !important;"><input  id="north2" name="north2[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="north3" name="north3[]" type="text"  readonly value="" style="width:20% !important;margin-left: 3px;"></td>
                     <td><input  id="north4" name="north4[]" type="text" value="" style="width:20% !important;"><input  id="north5" name="north5" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="north6" name="north6[]" type="text" readonly value="" style="width:20% !important;margin-left: 3px;"></td>
					 <td><input  id="north7" name="north7[]" type="text" value="" style="width:20% !important;"><input  id="north8" name="north8[]" type="text" value="<?php echo $project1['hdlinefile'];?>" style="width:20% !important;margin-left: 3px;"><input  id="north9" name="north9[]" type="text" readonly value="" style="width:20% !important;margin-left: 3px;"></td>
					
                  </tr> 
                  <tr>
		            <td>South</td>
					<td colspan="2"><input  id="southboundary" name="southboundary[]" type="text"  value="" style="width: 100% !important;height: 31px !important;"></td>
				     <td><input  id="south1" name="south1[]" type="text" value="" style="width:20% !important;"><input  id="south2" name="south2[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="south3" name="south3[]" type="text" readonly value=""style="width:20% !important;margin-left: 3px;"></td>
                     <td><input  id="south4" name="south4[]" type="text" value="" style="width:20% !important;"><input  id="south5" name="south5[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="south6" name="south6[]" type="text" readonly value="" style="width:20% !important;margin-left: 3px;" style="width:20% !important;margin-left: 3px;"></td>
					 <td><input  id="south7" name="south7[]" type="text" value="" style="width:20% !important;"><input  id="south8" name="south8[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="south9" name="south9[]" type="text" readonly value="" style="width:20% !important;margin-left: 3px;"></td>
					
                  </tr>
                 <tr>
		            <td>East</td>
					<td colspan="2"><input  id="eastboundary" name="eastboundary[]" type="text"  value=""  style="width: 100% !important;height: 31px !important;"></td>
				      <td><input  id="east1" name="east1[]" type="text" value="" style="width:20% !important;"><input  id="east2" name="east2[]" type="text" value=""  style="width:20% !important;margin-left: 3px;"><input  id="east3" name="east3[]" type="text" readonly value="" style="width:20% !important;margin-left: 3px;"></td>
                     <td><input  id="east4" name="east4[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="east5" name="east5[]" type="text" value=""  style="width:20% !important;margin-left: 3px;"><input  id="east6" name="east6[]" type="text" readonly value="" style="width:20% !important;margin-left: 3px;"></td>
					 <td><input  id="east7" name="east7[]" type="text" value=""style="width:20% !important;"><input  id="east8" name="east8[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="east9" name="east9[]" type="text" readonly value=""style="width:20% !important;margin-left: 3px;"></td>
					
                  </tr>
                      <tr>
		            <td>West</td>
					<td  colspan="2"><input  id="westboundary" name="westboundary[]" type="text"  value=""  style="width: 100% !important;height: 31px !important;"></td>
				     <td><input  id="west1" name="west1[]" type="text" value="" style="width:20% !important;"><input  id="west2" name="west2[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="west3" name="west3[]" type="text" readonly value=""style="width:20% !important;margin-left: 3px;"></td>
                     <td><input  id="west4" name="west4[]" type="text" value=""  style="width:20% !important;margin-left: 3px;"><input  id="west5" name="west5[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="west6" name="west6[]" type="text" readonly value="" style="width:20% !important;margin-left: 3px;"></td>
					 <td><input  id="west7" name="west7[]" type="text" value=""  style="width:20% !important;"><input  id="west8" name="west8[]" type="text" value="" style="width:20% !important;margin-left: 3px;"><input  id="west9" name="west9[]" type="text" readonly value="" style="width:20% !important;margin-left: 3px;"></td>
...
<tbody>
<tr><td>Guideline Rate</td><td><input  id="guideline_rate" name="guideline_rate" type="text"  value="<?php echo $project1['guideline_rate'];?>"><input id="totalareaval" name="totalareaval" type="hidden" value="<?php echo $project1['totalareaval'];?>"></td></tr>
...
<select name="reasonable_perce1" id="reasonable_perce1" style="display:block;"> <option value="" selected>Percentage</option><?php
...
<?php } ?>
                </select><input  id="reasonable_perce" name="reasonable_perce" type="text"  value="<?php echo $project1['reasonable_perce'];?>"></td><td><input  id="reasonable_value" name="reasonable_value" type="text"  value="<?php echo $project1['reasonable_value'];?>"></td></tr>
<tr><td>3.Forced value<br><input  id="forced_percen1" name="forced_percen1" type="text"  value="<?php echo $project1['forced_percen1'];?>" placeholder="%"> <input  id="forced_percen" name="forced_percen" type="text"  value="<?php echo $project1['forced_percen'];?>" placeholder="Percentage"> Market</td><td><input  id="forced_value" name="forced_value" type="text"  value="<?php echo $project1['forced_value'];?>"></td></tr>
...
$("#market_value").val(sum3.toFixed(2));
var sum4=0;
...
$("#forced_value").val(forced_value);
  ...
  $("#btnAdd").click(function() {
    $("#a").append('<div class="con"><input type="text" id="ownerAddress" name="ownerAddress[]" value="" style="width: 70%;"/>' + '<input type="button" class="btnRemove" value="X" style=" width: 10%;background: red;color: white;border-color: red;font-weight: bold;"/></div>');
  });
		...
		if($('input[name="residentialautofill"]').is(':checked'))
{
 ...
 var propertydoornof = $("#propertydoornof").val();
 $("#propertydoorno").val(propertydoornof);
 var propertystreetf = $("#propertystreetf").val();
  $("#propertystreet").val(propertystreetf);
 var propertyareaf = $("#propertyareaf").val();
  $("#propertyarea").val(propertyareaf);
 var propertyvillagef = $("#propertyvillagef").val();
  $("#propertyvillage").val(propertyvillagef);
 var propertytalukf = $("#propertytalukf").val();
  $("#propertytaluk").val(propertytalukf);
 var propertydistictf = $("#propertydistictf").val();
  $("#propertydistict").val(propertydistictf);
 var propertypincodef = $("#propertypincodef").val();
