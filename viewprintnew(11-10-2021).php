...
.topleft {
    ...
    margin-bottom: 5px;"><tr><td style="width:34%;border:unset !important;"></td><td style="border:unset !important;font-size: 16px;"><span style="border-bottom:1px solid;"><?php echo strtoupper($project1['report_name']);?></span></td><td style="border:unset !important;"></td></tr>
	   ...
	   <tr><td style="width:34%;border:unset !important;"><?php echo ucwords($project1['ref_no']);?></td><td style="border:unset !important;font-size: 10px;"><span <?php if(strtoupper($project1['report_name'])=='EVEREST CONSTRUCTION') {?> style="margin-left:14px;" <?php } else {?> style="margin-left: -9px;"  <?php } ?>>PROVISIONAL VALUATION REPORT</span> </td></tr>
	   </table>
          </div>
   ...
   width: 96.7%;
    margin-left: 0px;
    margin-bottom: -5px;   " <?php } else {?>  style="border: 0px solid;
    border-left: 1px solid;
    border-right: 1px solid;
    border-top: 1px solid;
    width: 96.7%;
    margin-left: 0px;
    margin-bottom: -5px;    border-bottom: 1px solid;" <?php } ?> >
    <tbody>
...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;">Revenue Details: </td>
	...
	<td style="border:0px solid;height:10px;">
	<table style="border:unset !important;    margin-left: 0px;"><tr><td style="border:unset !important;    width: 50%;"> Ward No <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['wardno']);?></p></td></tr></table></td>
                </tr>
				<tr>
                  ...
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>
				  <table style="border:unset !important;    margin-left: 0px;"><tr><td style="border:unset !important;    width: 50%;">  Block No <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['blockno']);?></p></td></tr></table></td>
                </tr>
				<tr>
    ...
    <td style="border:0px solid;">
	 ...
	 <table style="border:unset !important;    margin-left: 0px;"><tr><td style="border:unset !important;    width: 50%;">  Pymash No  <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['pymashno']);?></p></td></tr></table>
				...
				<tr>
				  ...
				  <td colspan="2" <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>><table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 16%;"> Ref Document <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['deed']);?> <?php echo ucwords($project1['deed_description']);?></p></td></tr></table></td>
                </tr>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>> <?php echo $project1['pattadtcp']; ?><?php if( $project1['pattadtcp']=='Yes') {?> - <?php echo $project1['pattadtcp_name']; ?> <?php } ?></td> 
                </tr>
				<tr>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>> <?php echo $project1['approvalplan']; ?><?php if( $project1['approvalplan']=='Yes') {?> - <?php echo $project1['approvalplan_name']; ?> <?php } ?></td>
                </tr>
				<tr>
...
<td colspan="5" style="border:unset  !important;"></td>
				...
				<?php if($project1['land_type']=='Separate') {?> 
				  ...
				  <tr>
				   ...
				   <td style="border:1px solid;    width: 21%;"><?php echo moneyFormatIndia($totalarea[$countproper1]);?></td><td style="border:1px solid;    width: 21%;"><?php echo $guideselect[$countproper1];?></td><td style="border:1px solid;    width: 21%;"><?php echo $assignsqt[$countproper1];?></td><td style="border:1px solid;    width: 21%;">₹<?php echo moneyFormatIndia($guide_rate[$countproper1]);?>
			...
			width: 99%;    margin-top: 5px;" >
               ...
               <tr>
				  ...
				  <tr>
				   ...
				   <td style="border:1px solid;    width: 21%;"><?php echo $project1['totalareacom'];?></td><td style="border:1px solid;    width: 21%;"><?php echo $project1['guideselectcom'];?></td><td style="border:1px solid;    width: 21%;"><?php echo $project1['assignsqttot'];?></td><td style="border:1px solid;    width: 21%;">₹<?php echo moneyFormatIndia($project1['guide_ratecom']);?>
</td><td style="border:1px solid;    width: 21%;">₹<?php echo moneyFormatIndia($project1['guidevaluecom']);?></td>
                </tr>
            </table>	
<?php } ?>
   <table class="striped responsive-table newtab" style="    margin-left: -11px;
			width: 99%;    margin-top: 5px;       margin-bottom: 1px;" >
               ...
               <tr>
				  ...
				  <tr>
                  <?php if($project1['land_type']=='Common') {?> 
				   <td style="border:1px solid;    width: 21%;"><?php echo moneyFormatIndia($project1['totalareaval']);?></td>
				  <?php } ?>
...
<?php $totalall=($copy_project_table1['overalltotal']+$copy_project_table1['overalltotal1']+$copy_project_table1['overalltotal2']+$copy_project_table1['overalltotal3']);?>
    ...
    <tbody>
	           <tr >
                  ...
                  <td colspan="3" style="border:0px solid;border-bottom:1px solid;font-weight:bold;    font-size: 13px;text-align:center;border-right:1px solid;">Services				
</td>
  ...
  <table class="striped responsive-table" style="    width: 96.5%%;
    margin-left: -27px; border:unset !important;margin-top: 5px;">
              <thead>
                <thead>
                <tr>
    ...
    font-size: 16px;
    font-weight: bolder;text-align: center;font-family: fangsong;">Created by <?php if($project1['typed_by']!='') {?> - <?php echo $project1['created_by'];?> <?php } ?></p></th>
	<th style="width: 10%;border:unset !important;"></th>
                  <th style="border:1px solid;border:unset !important;"><p style="    font-size: 16px;
    font-weight: bolder;text-align: center;font-family: fangsong;">Typed by <?php if($project1['typed_by']!='') {?> - <?php echo $project1['typed_by'];?><?php } ?></p></th>
