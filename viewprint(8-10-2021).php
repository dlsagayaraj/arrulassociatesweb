...
.topright {
  ...
  font-size: 18px;
	      ...
	      <div class="topright"><p style=" background: white !important;
    color: black;
    margin-top: -23px;
    margin-right: -34px;
    padding: 1px;font-size:19px;"><?php echo ucwords($project1['file_no']);?></p>
	   ...
	   <tr><td style="width:34%;border:unset !important;"></td><td style="border:unset !important;font-size: 10px;"><span <?php if(strtoupper($project1['report_name'])=='EVEREST CONSTRUCTION') {?> style="margin-left:14px;" <?php } else {?> style="margin-left: -9px;"  <?php } ?>>PROVISIONAL VALUATION REPORT</span></td></tr>
		  ...
		  <div class="row">
            <div class="col m12 s12 l12">
             <table class="striped responsive-table" style="border: 0px solid;
    ...
    <tbody>
	 ...
	 <tr>
                  ...
                  <td style="border:0px solid;width: 32% !important;border-right:1px solid;"><?php echo ucwords($project1['bank']);?> <?php if(1!=1) {?> <?php echo str_replace("-","",$project1['date']);?><?php } ?></td>
				...
				<tr>
                  ...
                  <td style="border:0px solid;border-right:1px solid;"><?php if($project1['loanAmount']!='') {?>Rs.<?php } ?><?php echo $project1['loanAmount'];?></td>
				...
				<tr>
                  ...
                  <td style="border:0px solid;border-right:1px solid;"><?php $first_cap=explode("--",str_replace(","," ",$project1['first_cap'])); $second_cap=explode("--",str_replace(","," ",$project1['second_cap'])); $ownerAddress1=explode("--",str_replace(","," ",$project1['ownerAddress1'])); $expld=explode("--",str_replace(","," ",$project1['ownerAddress']));?> 
				   <?php $i=0; foreach ($expld as $expld1) { $i++;  $va=$i-1; echo $first_cap[$va]; echo $expld1." "; echo $second_cap[$va].""; echo $ownerAddress1[$va]; if($i>=1) { echo "<br>"; } } ?></td>
				    <td style="border:0px solid;">Advance Amount<span style="float:right">:</span></td>
   ...
   <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;width: 25% !important;" <?php } else {?> style="border:0px solid;height:10px; width: 30% !important;" <?php } ?>><?php echo ucwords($project1['pdoorno']);?></td>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>><?php echo $project1['parea'];?></td>
				...
				<tr>
				  ...
				  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>Village<span style="float:right">:</span></td>
...
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-right:1px solid;">Revenue Details: </td>
				...
				<tr>
				  ...
				  <table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 48%;">Old S.F No<span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['oldsfno']);?></p></td></tr></table>
				  
				   </td>
	<td style="border:0px solid;height:10px;">
	<table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 50%;"> Ward No <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['wardno']);?></p></td></tr></table></td>
                </tr>
				<tr>
				  ...
				  <table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 48%;">S.F NO<span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo $project1['sfno'];?></p></td></tr></table>
			 </td>
				  
				  
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>
				  <table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 50%;">  Block No <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['blockno']);?></p></td></tr></table></td>
                </tr>
				<tr>
	...
	<td <?php if($countot2=='1') {?>  style="border:0px solid;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>
	 <table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 50%;">  R.S.F No  <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['rsfno']);?></p></td></tr></table>
    ...
    <td style="border:0px solid;">
	 ...
	 <table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 50%;">  T.S.No  <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['tsno']);?></p></td></tr></table>
				...
				<tr>
				  ...
				  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>
				   <table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 48%;">Plot No<span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['plotno']);?></p></td></tr></table></td>
    <td style="border:0px solid;">
	
	
	 <table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 50%;">  Pymash No  <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['pymashno']);?></p></td></tr></table>
</td>
                </tr>
				<tr>
				...
				<tr>
				  ...
				  <td colspan="2" <?php if($countot2=='1') {?>  style="border:0px solid;height:20px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>><table style="border:unset !important;    margin-left: -5px;"><tr><td style="border:unset !important;    width: 13%;"> Ref Document <span style="float:right">:</span></td><td style="border:unset !important;    width: 52%;"><p style="    width: 144%;"><?php echo ucwords($project1['deed']);?> <?php echo ucwords($project1['deed_description']);?></p></td></tr></table></td>
                </tr>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:35px;border-top:1px solid;" <?php } else {?> style="border:0px solid;height:10px;border-top:1px solid;" <?php } ?>><?php echo ucfirst($project1['propertyoccupied']); ?></td>
                </tr>
				<tr>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>> <?php echo $project1['taxreceipt']; ?><?php if( $project1['taxreceipt']=='Yes') {?> - <?php echo $project1['taxreceipt_name']; ?> <?php } ?></td>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>><?php echo $project1['ebserviceno']; ?><?php if( $project1['taxreceipt']=='Yes') {?> - <?php echo $project1['ebserviceno_name']; ?> <?php } ?></td>
                </tr>
				<tr>
                  ...
                  <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;border-right:1px solid;" <?php } else {?> style="border:0px solid;height:10px;border-right:1px solid;" <?php } ?>>:<?php echo str_replace("Km","",$project1['distanceofrs']);?><?php if($project1['distanceofrs']!='') {?>Km<?php } ?></td>
				  <td style="border:0px solid;">Patta / DTCP<span style="float:right">:</span></td>
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>> <?php echo $project1['pattadtcp']; ?><?php if( $project1['taxreceipt']=='Yes') {?> - <?php echo $project1['pattadtcp_name']; ?> <?php } ?></td> 
                </tr>
				<tr>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>> <?php echo $project1['approvalplan']; ?><?php if( $project1['taxreceipt']=='Yes') {?> - <?php echo $project1['approvalplan_name']; ?><?php } ?></td>
                </tr>
				<tr>
    ...
    <td <?php if($countot2=='1') {?>  style="border:0px solid;height:17px;" <?php } else {?> style="border:0px solid;height:10px;" <?php } ?>>: <?php echo $project1['hdline']; ?><?php if( $project1['taxreceipt']=='Yes') {?> - <?php echo $project1['hdline_name']; ?><?php } ?></td>
                </tr>
				</tbody>
				</table>
...
foreach($totallandvalue2 as $countproper1 =>$key1) {	$valdel="55".$countproper1;
			...
			width: 95%" <?php } ?>>
              ...
              <tbody>
				...
				<tr>
                  ...
                  <td style="border:1px solid;"><?php if($estent[$countproper1]!='0.00' && $estent[$countproper1]!='') {?>As Per Manual<br><?php echo moneyFormatIndia($estent[$countproper1]);?><?php } ?></td>
    ...
    width: 122%;
				    ...
				    <p><?php if($totalarea[$countproper1]!='') {?> <?php echo moneyFormatIndia($totalarea[$countproper1]);?> <?php } else {?> - <?php } ?></p>
    ...
    margin-left: -12px;">Guideline Rate</p>
				    ...
				    <p><?php if($guide_rate[$countproper1]!='' && $guide_rate[$countproper1]!='0.00') {?> ₹<?php echo moneyFormatIndia($guide_rate[$countproper1]);?> <?php } ?></p>
</td>
    ...
    margin-left: -12px;"<?php } ?> >Guideline Value</p>
				    ...
				    <p> <?php if($guidevalue[$countproper1]!='') {?> ₹<?php echo moneyFormatIndia($guidevalue[$countproper1]);?> <?php } ?></p>
 ...
 <tr>
                  ...
                  <td <?php if($countotval>1) {?> style="border:1px solid;width: 20%;" <?php } else {?> style="border:1px solid;width: 20%;" <?php } ?>><?php echo moneyFormatIndia($project1['totalareaval']);?></td>
				  <?php } ?>
                ...
                <tr>
                  ...
                  <td style="border:1px solid;width: 20%;"> ₹<?php echo moneyFormatIndia($project1['guideline_value']);?></td>
				  <?php } ?>
                </tr>
				<tr>
			...
			<td colspan="2" style="text-align: center;border:1px solid;">Land Value</td>  <?php } ?>
              ...
              <td style="border:0px solid;border:1px solid;"> <?php echo select_value_other("recentdevelopments","name",$recentdevelopmentsnear2[$countproper1]); ?></td>
			    <?php if($countproper1==$countotval)
				  {?>
<td style="border:1px solid;">1.Market Value</td><td style="border:1px solid;">₹<?php echo moneyFormatIndia($project1['market_value']);?></td><?php } ?>
                </tr>
  ...
  <td style="border:0px solid;border:1px solid;"> <?php echo select_value_other("classofconstruction","name",$classofconstruction2[$countproper1]); ?></td>	
			...
			<td style="border:1px solid;">2.Reasonable value
				<br>
				<?php if($project1['reasonable_perce1'])  {?> <?php echo $project1['reasonable_perce1'];?>%<?php } ?></td><td style="border:1px solid;">₹<?php echo moneyFormatIndia($project1['reasonable_value']);?></td></tr>
				  <?php } ?>
  ...
  <td <?php if($countproper1==$countotval)
    ...
    margin-left: 72px;
				  border-left: 1px solid; padding: 7px;"><?php echo $project1['foreced_perc'];?></p><?php } ?></td><td style="border:1px solid;">₹<?php echo moneyFormatIndia($project1['forced_value']);?></td> <?php } ?>
    ...
    <?php if($countproper1==$countotval)
				  {?>
				  <td <?php if($countproper1==$countotval)
				  {?>  style="    border: 1px solid;" <?php } else {?>  style="    border-right: 1px solid;" <?php } ?>>4.Guideline value</td><td style="border:1px solid;">₹<?php echo moneyFormatIndia($project1['guideline_value']);?></td>  <?php } ?>
				  </tr> <?php } ?>
				<?php if(1!=1) {?>
				<tr>
...
<?php } ?>	
<br>
 <div class="row invoice-info" style="     width: 94.8% !important;
    margin-left: 4px;">
    <?php if($project1['typeofconstruction']!='') 
	{?>		
			<table class="striped responsive-table">
    <tbody>
	<tr>
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-left:1px solid;border-right:1px solid;width:56%;">General Information	: </td>
<td colspan="2" style="border-top:1px solid;border-bottom:1px solid;border-left:1px solid;border-right:1px solid;">Services: </td>


 </tr>
                <tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Type of Construction</td>
                  <td style="border:0px solid;border-bottom:1px solid;">:<?php echo select_value_other("typeofconstruction","name",$project1['typeofconstruction']); ?></td>
				   <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;width:28% !important;">Water Supply Arrangements</td>
                  <td style="border:0px solid;border-right:1px solid;border-bottom:1px solid;">:<?php if($project1['watersupplyarrangementsRs']!='') {?> ₹ <?php echo moneyFormatIndia($project1['watersupplyarrangementsRs']);?> <?php } ?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Building Maintenance	</td>
                  <td style="border:0px solid;border-bottom:1px solid;">: <?php echo select_value_other("maintananceofthebuilding","name",$project1['maintenanceofthebuilding']); ?></td>
				   <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Drainage Arrangements</td>
                  <td style="border:0px solid;border-right:1px solid;border-bottom:1px solid;">: <?php if($project1['drainagearrangementsRs']!='') {?> ₹ <?php echo moneyFormatIndia($project1['drainagearrangementsRs']);?><?php } ?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Drainage Arrangements	</td>
				  ...
				  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Compound Wall<table style="    margin-left: -11px;"><tr><td style="border:unset !important;border-right: 1px solid !important;border-bottom: 1px solid !important;border-top: 1px solid !important;">L</td><td style="border:unset !important;border-right: 1px solid !important;border-bottom: 1px solid !important;border-top: 1px solid !important;">B</td><td style="border:unset !important;border-right: 1px solid !important;border-bottom: 1px solid !important;border-top: 1px solid !important;">Sqft</td><td style="border:unset !important;border-right: 1px solid !important;border-bottom: 1px solid !important;border-top: 1px solid !important;">Rate</td></tr><tr><td style="border:unset !important;border-right: 1px solid !important;"><?php if($project1['compoundwallL1']!='-') { echo $project1['compoundwallL1']; } else { echo "-";}?></td><td style="border:unset !important;border-right: 1px solid !important;height: 16px"><?php echo $project1['compoundwallL2'];?></td><td style="border:unset !important;border-right: 1px solid !important;"><?php echo $project1['compoundwallL'];?></td><td style="border:unset !important;border-right: 1px solid !important;"><?php echo $project1['compoundwallrate'];?></td></tr></table></td>
                  <td style="border:0px solid;border-right:1px solid;border-bottom:1px solid;">: <?php if($project1['compoundwallRs']!='') {?> ₹ <?php echo moneyFormatIndia($project1['compoundwallRs']);?><?php } ?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Water Supply Arrangements	</td>
                  <td style="border:0px solid;border-bottom:1px solid;">: <?php  echo $project1['watersupplyarrangements'];   ?></td>
				   <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;"><table style="    margin-left: -11px;"><tr><td style="border:unset !important;border-right: 1px solid !important;border-bottom: 1px solid !important;">Sump</td><td style="border:unset !important;border-right: 1px solid !important;border-bottom: 1px solid !important;">OH Tank</td><td style="border:unset !important;border-bottom: 1px solid !important;border-right:1px solid !important;">Sintex</td></tr><tr><td style="border:unset !important;border-right:1px solid !important;"><?php echo $project1['sump'];?></td><td style="border:unset !important;border-right:1px solid !important;height: 16px"><?php echo $project1['oht'];?></td><td style="border:unset !important;border-right:1px solid !important;"><?php echo $project1['sintex'];?></td></tr></table></td>
                  <td style="border:0px solid;border-right:1px solid !important;border-bottom: 1px solid !important;">: <?php if($project1['sumpohtRs']!='') {?> ₹ <?php echo moneyFormatIndia($project1['sumpohtRs']);?><?php } ?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Joineries	</td>
                  <td style="border:0px solid;border-bottom:1px solid;">: <?php  echo $project1['joineries'];  ?></td>
				   <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;"><table style="margin-left: -11px;"><tr><td style="border:unset !important;border-right: 1px solid !important;border-bottom: 1px solid !important;">E.B Deposit</td><td style="border:unset !important;border-right: 1px solid !important;border-bottom: 1px solid !important;">No.of Services</td></tr><tr><td style="border:unset !important;border-right: 1px solid !important;height: 16px"><?php echo $project1['ebdepositI'];?></td><td style="border:unset !important;border-right: 1px solid !important;"><?php echo $project1['ebdep1'];?></td></tr></table></td>
                  <td style="border:0px solid;border-right:1px solid;border-bottom:1px solid;">:<?php if($project1['ebdepositRs']!='') {?> ₹ <?php echo moneyFormatIndia($project1['ebdepositRs']);?> <?php } ?> </td>
                </tr>
				<tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Road Facilities</td>
                  <td style="border:0px solid;border-bottom:1px solid;">: <?php echo $project1['roadfacilities'];?> - <?php if($project1['roadfacilitiesyes']!='') {?> <?php echo select_value_other("roadfacilities","name",$project1['roadfacilitiesyes']); ?><?php } ?></td>
				   <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;"><?PHP $checkedval=explode(",",$project1['pavertype']);	 if (in_array('Pavements', $checkedval))
  {?>  Pavements<?php } ?> <?php 	 if (in_array('Cement', $checkedval))
  {?> /Cement <?php } ?> <?php  	 if (in_array('Tiles', $checkedval))
  {?> <?php if (in_array('Cement', $checkedval))
  {?>/<?php } ?>Tiles <?php } ?> </td>
                  <td style="border:0px solid;border-right:1px solid;border-bottom:1px solid;">: <?php echo $project1['paverrs'];?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Type of Plot		</td>
                  <td style="border:0px solid;border-bottom:1px solid;">: <?php echo select_value_other("cornerintermittentcommerciallot","name",$project1['cornerplotintermittentplot']); ?></td>
				   <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Interior</td>
                  <td style="border:0px solid;border-right:1px solid;border-bottom:1px solid;">: <?php if($project1['interiorworkRs']!='') {?> ₹ <?php echo moneyFormatIndia($project1['interiorworkRs']);?><?php } ?></td>
                </tr>
				<tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Character of Locality			</td>
                  <td style="border:0px solid;border-bottom:1px solid;">: <?php echo select_value_other("characteroflocality","name",$project1['characteroflocality']); ?></td>
				   <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Exterior</td>
                  <td style="border:0px solid;border-right:1px solid;border-bottom:1px solid;">: <?php if($project1['exteriorworkRs']!='') {?> ₹ <?php echo moneyFormatIndia($project1['exteriorworkRs']);?><?php } ?></td>
				  
                </tr>
				<tr>
                  <td colspan="2" style="border:0px solid;border-left:1px solid;"><table class="striped responsive-table" style="    width: 102.7%;
    margin-left: -6px;
    margin-top: -2px;">
    <tbody>
	<tr>
<td colspan="1" style="border-bottom:1px solid;border-right:1px solid;">Floor</td>
<td colspan="1" style="border-bottom:1px solid;border-right:1px solid;">Floor Finishing	</td>
<td colspan="1" style="border-bottom:1px solid;">Roofing</td>
...
foreach($floorselect as $floorselectcount =>$key) {   $floorselect[$floorselectcount]; ?>
                <tr>
                  <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;border-right:1px solid;"><?php echo $floorselect[$floorselectcount];?>	</td>
                  <td style="border:0px solid;border-bottom:1px solid;border-right:1px solid;"><?php echo $floorfinish[$floorselectcount]; ?></td>
                  <td style="border:0px solid;border-bottom:1px solid;"><?php echo select_value_other("roof","name",$roofingselect[$floorselectcount]);?></td>
                </tr>
<?php } }?>				
				  <tbody>
				</table></td>
               
				   <td style="border:0px solid;border-left:1px solid;border-bottom:1px solid;">Open / Stair head</td>
                  <td style="border:0px solid;border-right:1px solid;border-bottom:1px solid;">: <?php if($project1['openstaircaseRs']!='') {?> ₹ <?php echo moneyFormatIndia($project1['openstaircaseRs']);?> <?php } ?></td>
				  
                </tr>
				<tr>
                  <td style="border:0px solid;border-left:1px solid;"></td>
                  <td style="border:0px solid;">:</td>
				  
				  <td style="border:0px solid;border-left:1px solid;">Total</td>
                  <td style="border:0px solid;border-right:1px solid;">: ₹ <?php echo moneyFormatIndia($project1['serviceovertotal']);?></td>
                </tr>
				  <tbody>
				</table>
...
<?php } ?>			
				<tr>
                  ...
                  <td colspan="9" style="text-align:right;border:1px solid;">Grand Total:	</td>
					   ...
					   <td colspan="1" style="text-align:left;border:1px solid;"> <?php echo $copy_project_table1['overalltotal'];?></td>
...
foreach($lengtha1 as $lengthacountproper =>$key) {	$i++;
...
foreach($lengtha2 as $lengthacountproper =>$key) {	$i++;
...
<?php } ?>			
				<tr>
                  ...
                  <td colspan="9" style="text-align:right;border:1px solid;">Grand Total:	</td>
					   ...
					   <td colspan="1" style="text-align:left;border:1px solid;"><?php echo $copy_project_table1['overalltotal2'];?></td>
...
<table id="b" style="    width: 105.5%;
    ...
    <tbody>
                ...
                <tr>
                   <td style="border:0px solid;border-bottom:1px solid;border-right:1px solid;border-left:1px solid;">Land Value</td><td style="border:0px solid;border-bottom:1px solid;text-align:right;border-right:1px solid;">₹ <?php echo moneyFormatIndia($project1['landtotal']);?></td> 
				    <td style="border:0px solid;border-bottom:1px solid;border-right:1px solid;">Market Value</td><td style="border:0px solid;border-bottom:1px solid;text-align:right;border-right:1px solid;">₹ <?php echo moneyFormatIndia($project1['newmarkettotal']);?></td> 
                </tr>	
				 <tr>
  ...
  <table class="striped responsive-table" style="    width: 102.5%;
    margin-left: -12px; border:unset !important;    margin-top: -100px;">
              <thead>
                <tr>
	
                  <th style="border:1px solid;border:unset !important;;"><p style=" 
    font-size: 16px;
    font-weight: bolder;text-align: center;font-family: fangsong;">Created by</p></th>
	<th style="width: 38%;border:unset !important;"></th>
                  <th style="border:1px solid;border:unset !important;"><p style="    font-size: 16px;
    font-weight: bolder;text-align: center;font-family: fangsong;">Typed by</p></th>
    ...
    font-weight: bolder;font-family: fangsong;"><?php echo $project1['created_by'];?></p></th>
	<th style="border:unset !important;"></th>
                  <th style="border:1px solid;border:unset !important;"><p style="    font-size: 16px;
    font-weight: bolder;text-align: center;font-family: fangsong;
