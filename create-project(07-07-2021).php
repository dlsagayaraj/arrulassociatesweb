...
<tr>
<th style="border:1px solid #ff0080;"><div class="input-field col s12 divheight  address fifthborder" style="width:50%;"> <input  id="propertyvillage" name="propertyvillage" type="text" value="<?php echo $project1['propertyvillage'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="propertyvillage" style="">Post </label> </div><div class="input-field col s12 divheight  address fifthborder property_address_limit"  style="width:49%;;"> <select name="property_address_limit" id="property_address_limit" style="display:block;height:33px !important;" id="property_address_limit">
