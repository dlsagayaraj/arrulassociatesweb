...
.input-field label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;width: 42%;
}
.purchase  label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;width: 42%;
}
...
.ownera1  label.active {
width: 100%; color: rgba(48,48,48,.7);top: 4px;background: white;    width: 42%;
}
.date  label.active {
width: 100%; color: rgba(48,48,48,.7);top: -7px;background: white;    width: 42%;
}
...
border:1px solid #21058f !important ;box-shadow:0 1px 0 0 #21058f !important ;
}
...
border:1px solid #f66a07 !important ;box-shadow:0 1px 0 0 #f66a07 !important ;
}
...
border:1px solid #009933 !important ;box-shadow:0 1px 0 0 #009933 !important ;
}
...
border:1px solid #05529f !important ;box-shadow:0 1px 0 0 #05529f !important ;
}
...
border:1px solid #ff0080 !important ;box-shadow:0 1px 0 0 #ff0080 !important ;
}
...
border:1px solid #c300dc !important ;box-shadow:0 1px 0 0 #c300dc !important ;
}
...
border:1px solid #139830 !important ;box-shadow:0 1px 0 0 #139830 !important ;
}
...
border:1px solid #082cdc !important ;box-shadow:0 1px 0 0 #082cdc !important ;
}
...
.select2-selection--single{background: #21058f;}
...
// WEBPACK FOOTER //
// ./src/styles/TextFieldCatalog.scss
...
<?php if($_REQUEST['step']=='step1' || $_REQUEST['step']==''){?>
 ...
 <thead>
<tr>
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> colspan="2"  <?php } else {?> colspan="1" <?php } ?> style="text-align: center;    background: white; border:1px solid #21058f;background:#21058f;width:49%;color: white; ">PROVISIONAL VALUATION REPORT </th> <th style="width:0% "></th><th  colspan="1" style="text-align: center;     background: white;border-right:1px solid #f66a07;background:#f66a07;background:#f66a07; width:49%; "> <div class="input-field divheight secondborder"><select name="report_name" id="report_name"  class="select2 browser-default" style=" background: white;"> 
...
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="width:50%;"<?php } else { ?> style="border-left:1px solid #21058f;border-right:1px solid #21058f;background:#21058f;"  <?php } ?>> <?php if(1!=1) {?> Name of the Bank:<?php } ?>  <div class="input-field divheight firstborder"> <select name="bank" id="bank"  class="select2" required  <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="width:50% !important; "<?php } else { ?> style="margin-left: -14px !important;
...
<th style="border-left:1px solid #f66a07; border-right:1px solid #f66a07;background:#f66a07;"><div class="input-field col s12 divheight date secondborder" style="    height: 31px !important;"><input  id="date" name="date" type="date" value="<?php echo $project1['date'];?>"  style=" margin-left: -14px !important;
...
<th style="border:1px solid #21058f;background:#21058f;">

<div class="text-field-container"><div class="mdc-text-field text-field mdc-text-field--outlined"><input type="text" id="text-field-outlined" class="mdc-text-field__input" aria-describedby="text-field-outlined-helper-text"><div class="mdc-notched-outline mdc-notched-outline--upgraded mdc-notched-outline--notched"><div class="mdc-notched-outline__leading"></div><div class="mdc-notched-outline__notch" style="width: 57.5px;"><label class="mdc-floating-label mdc-floating-label--float-above" for="text-field-outlined" style="">Standard</label></div><div class="mdc-notched-outline__trailing"></div></div></div><div class="mdc-text-field-helper-line"><p class="mdc-text-field-helper-text mdc-text-field-helper-text--persistent mdc-text-field-helper-text--validation-msg" id="text-field-outlined-helper-text">Helper Text</p></div></div>
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border-right:1px solid #f66a07;background:#f66a07;background:#f66a07; "><div class="input-field col s12 divheight ins secondborder">	<input  id="inspected" name="inspected" type="text" value="<?php echo $project1['inspected'];?>" required style=" margin-left: -14px !important;
    width: 104% !important;">          <label  for="inspected" style="">Inspected</label></div></th>
</tr>
<tr>
<th style="border-left:1px solid #21058f;border-right:1px solid #21058f;background:#21058f;">  <div class="input-field col s12 divheight company firstborder"> <textarea id="companyName" name="companyName" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['companyName'];?>
</textarea><label  for="companyName" style="">Company Name</label></div></th><th></th>
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border-left:1px solid #f66a07; border-right:1px solid #f66a07;background:#f66a07; "><div class="input-field col s12 divheight secondborder"><input  id="advanceAmount" name="advanceAmount" type="number" value="<?php echo $project1['advanceAmount'];?>"  style=" margin-left: -14px !important;
    width: 104% !important;"> <label  for="advanceAmount" style="">Advance Amount (Rs.)</label></div></th>
</tr>	
<tr>
<th style="width:50%;border:1px solid #21058f;background:#21058f;"><?php $ownerAddress2=explode("--,",$project1['ownerAddress']);
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th style="border-right:1px solid #f66a07;background:#f66a07;background:#f66a07; "><div class="input-field col s12 purchase secondborder"><input  id="purchaseAddress" name="purchaseAddress" type="text" value="<?php echo $project1['purchaseAddress'];?>" style=" margin-left: -14px !important;
...
<th style="border:1px solid #21058f;background:#21058f;">Residential Address: </th>
<th style="border:1px solid #21058f;background:#21058f;"></th>
</tr>
<tr>

<th style="border:1px solid #21058f;background:#21058f;">i) Door No: <textarea id="odoorno" name="odoorno" rows="3" cols="23" style="    height: 3rem;">
...
<th style="width:50%;border:1px solid #009933;background: #009933;color:white;">Residential Address: </th> <th style="width:0%;"></th>
<th style="border:1px solid #1680eb;background: #1680eb;width:49%;color:white;"> <p class="mb-1" style="color:white;"> Purchaser Available:
...
<th style="border-left:1px solid #009933; border:1px solid #009933;background: #009933;"><div class="input-field col s12 divheight  address thirdborder"><textarea id="odoorno" name="odoorno" rows="3" cols="23" style="    height: 3rem; margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['odoorno'];?>
</textarea><label  for="odoorno" style="">Door No </label></div></th>
<th></th>
<th style="border-left:1px solid #05529f; border:1px solid #1680eb;background: #1680eb;"><div class="input-field col s12 divheight address purchaseyescheck fourthborder"><textarea id="pdoorno" class="purchaseyescheck"  name="pdoorno" rows="3" cols="23" style="    height: 3rem; margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['pdoorno'];?>
</textarea><label  for="pdoorno" style="">Door No</label></div></th>
</tr>
<tr>
<th style="border:1px solid #009933;background: #009933;"> <div class="input-field col s12 divheight street thirdborder"> <textarea id="ostreet" name="ostreet" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['ostreet'];?>
</textarea><label  for="ostreet" style="">Street </label></div></th>
<th></th>
<th style="border:1px solid #1680eb;background: #1680eb;"><div class="input-field col s12 divheight street purchaseyescheck fourthborder"> <textarea id="pstreet" class="purchaseyescheck" name="pstreet" rows="3" cols="23" style="    height: 3rem; margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['pstreet'];?>
...
<tr>
<th style="border-left:1px solid #009933; border:1px solid #009933;background: #009933;"> <div class="input-field col s12 divheight street thirdborder"><textarea id="oarea" name="oarea" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['oarea'];?>
</textarea><label  for="oarea" style="">Area  </label></div></th>
<th></th>
<th style="border-left:1px solid #05529f; border:1px solid #1680eb;background: #1680eb;"><div class="input-field col s12 divheight street purchaseyescheck fourthborder"><textarea id="parea" class="purchaseyescheck" name="parea"  rows="3" cols="23" style="   height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['parea'];?>
</textarea><label  for="parea" style="">Area  </label></div></th>
</tr>
<tr>
<th style="border:1px solid #009933;background: #009933;"><div class="input-field col s12 divheight street thirdborder"> <input  id="opost" name="opost" type="text" value="<?php echo $project1['opost'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="opost" style="">Post  </label></div></th>
	<th></th>
<th style="border:1px solid #1680eb;background: #1680eb;"><div class="input-field col s12 divheight street purchaseyescheck fourthborder"> <input  id="ppost" class="purchaseyescheck" name="ppost" type="text" value="<?php echo $project1['ppost'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="ppost" style="">Post  </label></div></th>
</tr>

<tr>
<th style="border-left:1px solid #009933; border:1px solid #009933;background: #009933;"><div class="input-field col s12 divheight street thirdborder">  <input  id="otaluk" name="otaluk" type="text" value="<?php echo $project1['otaluk'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="otaluk" style="">Taluk </label></div></th>
	<th></th>
<th style="border-left:1px solid #05529f; border:1px solid #1680eb;background: #1680eb;"><div class="input-field col s12 divheight street purchaseyescheck fourthborder"><input  id="ptaluk" class="purchaseyescheck" name="ptaluk" type="text" value="<?php echo $project1['ptaluk'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="ptaluk" style="">Taluk </label></div></th>
</tr>
<tr>
<th style="border:1px solid #009933;background: #009933;"><div class="input-field col s12 divheight contact thirdborder">  <input  id="odistrict" name="odistrict" type="text" value="<?php echo $project1['odistrict'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="odistrict" style="">District </label></div></th>
	<th></th>
<th style="border:1px solid #1680eb;background: #1680eb;"><div class="input-field col s12 divheight contact purchaseyescheck fourthborder"><input  id="pdistrict" class="purchaseyescheck" name="pdistrict" type="text" value="<?php echo $project1['pdistrict'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="pdistrict" style="">District </label></div></th>
</tr>	
<tr>

<th style="border-left:1px solid #009933; border:1px solid #009933;background: #009933;"><div class="input-field col s12 divheight contact thirdborder"> <input  id="opincode" name="opincode" type="text" value="<?php echo $project1['opincode'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="opincode" style="">Pincode </label></div></th>
	<th></th>
<th style="border-left:1px solid #05529f; border:1px solid #1680eb;background: #1680eb;"><div class="input-field col s12 divheight contact purchaseyescheck fourthborder"><input  id="ppincode" class="purchaseyescheck" name="ppincode" type="text" value="<?php echo $project1['ppincode'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="ppincode" style="">Pincode </label></div></th>
</tr>	
<tr>
<th style="border:1px solid #009933;background: #009933;"><div class="input-field col s12 divheight contact thirdborder"><input  id="ocontact" name="ocontact" type="text" value="<?php echo $project1['ocontact'];?>" style="margin-left: -14px !important;
    width: 104% !important;"><label  for="ocontact" style="">Contact </label></div></th>
	<th></th>
<th style="border:1px solid #1680eb;background: #1680eb;"><div class="input-field col s12 divheight contact purchaseyescheck fourthborder"><input  id="pcontact" class="purchaseyescheck" name="pcontact" type="text" value="<?php echo $project1['pcontact'];?>" style="margin-left: -14px !important;
 ...
 <thead>
<tr style="background: #ddd;">
<th style="border:1px solid #1680eb;background: #1680eb;">Property Address</th>
<th style="border:1px solid #1680eb;background: #1680eb;"><p class="mb-1">
<label>
...
<?php } else {?>
 ...
 <thead>
<tr style="">
<th style="    width: 50%;;border:1px solid #ff0080;background: #ff0080;color:white;"><p class="mb-1">Property Address
              <label>
                <input type="checkbox" class="filled-in" name="residentialautofill" id="residentialautofill" <?php if($project1['residentialautofill']=='Yes') { ?> checked<?php } ?> value="Yes">
                <span style="color: white;">Auto Fill</span>
              </label>
            </p></th><th style="width:1%;"></th>
<th style="border:1px solid #c300dc;;background: #c300dc;;width:49%;color:white;">Revenue Details</th>
</tr>

<tr>
<th style="width: 39%;border-left:1px solid #ff0080; border:1px solid #ff0080;background: #ff0080;"><div class="input-field col s12 divheight  address fifthborder"><textarea id="propertydoorno" name="propertydoorno" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['propertydoorno'];?>
</textarea>  <label  for="propertydoorno" style="">Door No </label> </div></th><th></th>
<th style="border-left:1px solid #c300dc; border:1px solid #c300dc;;background: #c300dc;;;background: #c300dc;;"><table><tr><td style="border:unset !important;width:50%"><div class="input-field col s12 divheight  oldsf sixthborder"><input  id="oldsfno" name="oldsfno" type="text" value="<?php echo $project1['oldsfno'];?>"  style="margin-left: -14px !important;"><label  for="oldsfno" style="">Old S.F No </label></div> </td><td style="border:unset !important"><div class="input-field col s12 divheight  oldsf sixthborder"><input  id="wardno" name="wardno" type="text" value="<?php echo $project1['wardno'];?>"  style="margin-left: -14px !important;"><label  for="wardno" style="">Ward No  </label></div> </td></tr></table></th>
</tr>
<tr>
<th style="border:1px solid #ff0080;background: #ff0080;"> <div class="input-field col s12 divheight  address fifthborder"><textarea id="propertystreet" name="propertystreet" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['propertystreet'];?>
</textarea> <label  for="propertystreet" style="">Street </label> </div>  </th><th></th>
<th style="border:1px solid #c300dc;;background: #c300dc;;"><table><tr><td style="border:unset !important;width:50%"><div class="input-field col s12 divheight  oldsf sixthborder"><input  id="sfno" name="sfno" type="text" value="<?php echo $project1['sfno'];?>"  style="margin-left: -14px !important;"><label  for="sfno" style="">S.F NO  </label></div> </td><td style="border:unset !important"><div class="input-field col s12 divheight  oldsf sixthborder" >  <input  id="blockno" name="blockno" type="text" value="<?php echo $project1['blockno'];?>" style="margin-left: -14px !important;"><label  for="blockno" style="">Block No   </label></div></td></tr></table></th><th></th>
</tr>

<tr>
<th style="border-left:1px solid #ff0080; border:1px solid #ff0080;background: #ff0080;">   <div class="input-field col s12 divheight  address fifthborder"><textarea id="propertyarea" name="propertyarea" rows="3" cols="23" style="    height: 3rem;margin-left: -14px !important;
    width: 104% !important;">
<?php echo $project1['propertyarea'];?>
...
<tr>
<th style="border:1px solid #ff0080;background: #ff0080;"><div class="input-field col s12 divheight  address fifthborder"> <input  id="propertyvillage" name="propertyvillage" type="text" value="<?php echo $project1['propertyvillage'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="propertyvillage" style="">Post </label> </div></th><th></th>
<th style="border:1px solid #c300dc;;background: #c300dc;;"><div class="input-field col s12 divheight  oldsf sixthborder"><input  id="pattano" name="pattano" type="text" value="<?php echo $project1['pattano'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="pattano" style="">Patta No </label></th>
</tr>
<tr>
<th style="border-left:1px solid #ff0080; border:1px solid #ff0080;background: #ff0080;"><div class="input-field col s12 divheight  address fifthborder">  <input  id="propertytaluk" name="propertytaluk" type="text" value="<?php echo $project1['propertytaluk'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="propertytaluk" style="">Taluk </label> </div></th><th></th>
<th style="border-left:1px solid #c300dc; border:1px solid #c300dc;;background: #c300dc;;;background: #c300dc;;"><div class="input-field col s12 divheight  address sixthborder"><input  id="plotno" name="plotno" type="text" value="<?php echo $project1['plotno'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="plotno" style="">Plot No </label></th>
</tr>
<tr>
<th style="border:1px solid #ff0080;background: #ff0080;"><div class="input-field col s12 divheight  address fifthborder"> <input  id="propertydistict" name="propertydistict" type="text" value="<?php echo $project1['propertydistict'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="propertytaluk" style="">District</label> </div></th><th></th>
<th style="border:1px solid #c300dc;;background: #c300dc;;"><div class="input-field col s12 divheight  sro sixthborder"> <input  id="pymashno" name="pymashno" type="text" value="<?php echo $project1['pymashno'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="pymashno" style="">Pymash No</label> </div></th>
</tr>

<tr>
<th style="border-left:1px solid #ff0080; border:1px solid #ff0080;background: #ff0080;border-bottom:1px solid #ff0080;"><div class="input-field col s12 divheight  contact fifthborder"> <input  id="propertypincode" name="propertypincode" type="text" value="<?php echo $project1['propertypincode'];?>" style=" margin-left: -14px !important;
    width: 104% !important;"><label  for="propertypincode" style="">Pincode</label> </div> </th><th></th>
<th style="border-left:1px solid #c300dc; border:1px solid #c300dc;;background: #c300dc;;;background: #c300dc;;border-bottom:1px solid #c300dc;"><div class="input-field col s12 divheight  address sixthborder"><input  id="sro" name="sro" type="text" value="<?php echo $project1['sro'];?>" style="margin-left: -14px !important;"><label  for="sro" style="">S.R.O </label></div></th>
</tr>
</thead>
</table>
 ...
 <thead>
<tr>
<th style="border:1px solid #0bdeb7;;background: #0bdeb7;;width:50%;"><div class="input-field col s12 divheight  sro seventhborder"><input  id="landmark" name="landmark" type="text" value="<?php echo $project1['landmark'];?>" style=" margin-left: -14px !important;
    width: 104% !important;height:3rem !important;"><label  for="landmark" style="">Land Mark</label> </div></th>	<th style="width:0%;"></th>
<th style="border:1px solid #082cdc;width:49%;background: #e47514;"><div class="input-field divheight eighthborder"><select name="propertyoccupied" style="display:block;">
<option value="" >Property Occupied</option>
<option <?php if($project1['propertyoccupied']=='owner') {?> Selected <?php } ?> value="owner">Owner</option>
<option <?php if($project1['propertyoccupied']=='rent') {?> Selected <?php } ?> value="rent">Rent</option>
</select></div></th>	
...
<tr>
<th style="border-left:1px solid #139830; border:1px solid #0bdeb7;;background: #0bdeb7;;"><div class="input-field col s12 divheight  oldsf seventhborder"><input  id="nearestbustop" name="nearestbustop" type="text" value="<?php echo $project1['nearestbustop'];?>" style=" margin-left: -14px !important;
...
<th style="border:1px solid #0bdeb7;;background: #0bdeb7;;"> <div class="input-field col s12 divheight  distanceofbranch seventhborder"><input  id="distanceofbranch" name="distanceofbranch" type="text" value="<?php echo $project1['distanceofbranch'];?>"style=" margin-left: -14px !important;
...
<tr>
<th style="border-left:1px solid #139830; border:1px solid #0bdeb7;;background: #0bdeb7;;"><div class="input-field col s12 divheight  oldsf seventhborder"><input  id="distanceofrs" name="distanceofrs" type="text" value="<?php echo $project1['distanceofrs'];?>" style=" margin-left: -14px !important;
...
<tr>
<th style="border:1px solid #0bdeb7;;background: #0bdeb7;;"><div class="input-field col s12 divheight  oldsf seventhborder"><input  id="nearestmainroad" name="nearestmainroad" type="text" value="<?php echo $project1['nearestmainroad'];?>" style=" margin-left: -14px !important;
...
<th style="border-left:1px solid #139830; border:1px solid #0bdeb7;;background: #0bdeb7;;border-bottom:1px solid #082cdc;"><div class="input-field col s12 divheight  oldsf seventhborder"><input  id="civilamenities" name="civilamenities" type="text" value="<?php echo $project1['civilamenities'];?>" style=" margin-left: -14px !important;
...
<th style="border-top: 1px solid gray;padding: 5px 8px !important;border-left: 1px solid gray;padding: 5px 8px !important; border-bottom: 1px solid gray;padding: 5px 8px !important;">Patta<label>
...
<th style="border-top: 1px solid gray;padding: 5px 8px !important;border-left: 1px solid gray;padding: 5px 8px !important; border-bottom: 1px solid gray;padding: 5px 8px !important;">Document<label>
                <input type="checkbox" class="filled-in" name="documentvisible" id="documentvisible" <?php if($project1['documentvisible']=='Yes') { ?> checked<?php } ?> value="Yes"><span>Visible</span></label></th>
<th style="border-top: 1px solid gray;padding: 5px 8px !important;border-left: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important; border-bottom: 1px solid gray;padding: 5px 8px !important;"></th>
</tr>
		   <tr>     <th style="border-bottom: 1px solid gray;padding: 5px 8px !important;border-left: 1px solid gray;padding: 5px 8px !important;">Direction</th>
				    ...
				    <th class="pattashow" style="border-bottom: 1px solid gray;padding: 5px 8px !important;border-left: 1px solid gray;padding: 5px 8px !important;">Patta   </th>
                    <th class="documentshow" style="border-bottom: 1px solid gray;padding: 5px 8px !important;border-left: 1px solid gray;padding: 5px 8px !important;">Document </th>
...
<?php } } else { ?> 
 ...
 <tr>
					...
					<td colspan="2" style="border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;">As Per Manual<br><input  id="estent" name="estent[]"  type="number" value="" style="width:60% !important;margin-left: 3px;"></td>
				     <td class="pattashow" style="border-left: 1px solid gray;padding: 5px 8px !important;
    width: 23%;
">As Per Patta<input type="radio" id="est1" name="est1" value="ON"><label style="margin-left: 21px;font-size: 12px;color: black;">ON</label> <input type="radio" id="est1" name="est1" value="OFF"> <label style="margin-left: 21px;font-size: 12px;color: black;">OFF</label><br><input  id="estent1" name="estent1[]"  type="number" value="" style="width:60% !important;margin-left: 3px;"></td>
                     <td class="documentshow" style="border-left: 1px solid gray;padding: 5px 8px !important;">As Per Document<input type="radio" id="est2" name="est2" value="ON"><label style="margin-left: 21px;font-size: 12px;color: black;">ON</label> <input type="radio" id="est2" name="est2" value="OFF"> <label style="margin-left: 21px;font-size: 12px;color: black;">OFF</label><br> <input  id="estent2" name="estent2[]" type="number"  value="" style="width:60% !important;margin-left: 3px;"></td>
					 <td style="border-left: 1px solid gray;padding: 5px 8px !important;border-right: 1px solid gray;padding: 5px 8px !important;">As Per Actual<input type="radio" id="est3" name="est3" value="ON"><label style="margin-left: 21px;font-size: 12px;color: black;">ON</label> <input type="radio" id="est3" name="est3" value="OFF"> <label style="margin-left: 21px;font-size: 12px;color: black;">OFF</label><br><input  id="estent3" name="estent3[]" type="number"  value="" style="width:60% !important;margin-left: 3px;"></td>
...
<?php if(1!=1) {?>
					...
					<td style="    width: 33%;border-left: 1px solid gray;padding: 5px 8px !important;border-bottom: 1px solid gray;padding: 5px 8px !important;">Guideline Rate<br><input  id="guide_rate" name="guide_rate[]"  class="guide_rate" type="number" value="" style="
    font-size: 18px;
    width: 45% !important;border: 1px solid gray;padding: 5px 8px !important;"><select name="guideselect[]" id="guideselect" style="display:block" class="guideselect">
                  <option value="" >Select</option>
				   <option value="Sq ft" >Sq ft</option>
				    <option value="Cent" >Cent</option>
					 <option value="Acre" >Acre</option>
