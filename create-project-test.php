...
.input-field label.active {
width: 100%;color: black;top: 4px;background: white;width: 25%;
}
.input-field>label {
    top: -5px;
}
...
<?php if($_REQUEST['step']=='step1' || $_REQUEST['step']==''){?>
 ...
 <thead>
<tr>
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> colspan="2"  <?php } else {?> colspan="4" <?php } ?> style="text-align: center;    background: #ddd;">PROVISIONAL VALUATION REPORT</th>
</tr>	
<tr> 
<th  style="border-right:2px solid;width:50%;">VALUATION REPORT NAME <select name="report_name" id="report_name"  class="select2 browser-default"> 
...
<th <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="width:50%;"<?php } ?> style="border-right:2px solid;"> Name of the Bank:   <select name="bank" id="bank"  class="select2" required  <?php if($deviceType=='phone' || $deviceType=='tablet') {?> style="width:50% !important; "<?php } ?> > 
...
<th>Date:<input  id="date" name="date" type="date" value="<?php echo $project1['date'];?>"></th>
</tr>
<tr>
...
<?php if($deviceType=='phone' || $deviceType=='tablet') {?> </tr><tr><?php } ?>
<th>  Name of the Purchaser:	:	<input  id="purchaseAddress" name="purchaseAddress" type="text" value="<?php echo $project1['purchaseAddress'];?>"></th>
</tr>
...
<th>i) Door No: <textarea id="odoorno" name="odoorno" rows="3" cols="23" style="    height: 3rem;">
...
<th><div class="purchaseyescheck"><input  id="pcontact" class="purchaseyescheck" name="pcontact" type="text" value="<?php echo $project1['pcontact'];?>"></div></th>
 ...
 <thead>
<tr style="background: #ddd;">
<th style="width:50%;">Residential Address: </th>
<th> Purchaser Available: <p class="mb-1">
              <label>
                <input type="checkbox" class="filled-in" name="purchaseyes" id="purchaseyes" <?php if($project1['purchaseyes']=='Yes') { ?> checked <?php } ?>  value="Yes">
                <span>Yes</span>
              </label>
...
<th><div class="purchaseyescheck">i) Door No:	</div><div class="purchaseyescheck"><textarea id="pdoorno" class="purchaseyescheck"  name="pdoorno" rows="3" cols="23" style="    height: 3rem;">
<?php echo $project1['pdoorno'];?>
</textarea></div></th>
</tr>
<tr>
<th> ii) Street: <textarea id="ostreet" name="ostreet" rows="3" cols="23" style="    height: 3rem;">
<?php echo $project1['ostreet'];?>
</textarea></th>
<th><div class="purchaseyescheck">ii) Street:	</div><div class="purchaseyescheck"> <textarea id="pstreet" class="purchaseyescheck" name="pstreet" rows="3" cols="23" style="    height: 3rem;">
<?php echo $project1['pstreet'];?>
</textarea></div></th>
</tr>
<tr>
<th > iii) Area:  <textarea id="oarea" name="oarea" rows="3" cols="23" style="    height: 3rem;">
<?php echo $project1['oarea'];?>
</textarea></th>
<th><div class="purchaseyescheck">iii) Area:	</div><div class="purchaseyescheck"><textarea id="parea" class="purchaseyescheck" name="parea"  rows="3" cols="23" style="    height: 3rem;">
<?php echo $project1['parea'];?>
</textarea></div></th>
</tr>
<tr>
<th>  vi) Post: <input  id="opost" name="opost" type="text" value="<?php echo $project1['opost'];?>"></th>
<th><div class="purchaseyescheck">vi) Post:	</div><div class="purchaseyescheck"> <input  id="ppost" class="purchaseyescheck" name="ppost" type="text" value="<?php echo $project1['ppost'];?>"></div></th>
</tr>
<tr>
<th >v) Taluk: <input  id="otaluk" name="otaluk" type="text" value="<?php echo $project1['otaluk'];?>"></th>
<th><div class="purchaseyescheck">v) Taluk:	</div><div class="purchaseyescheck"><input  id="ptaluk" class="purchaseyescheck" name="ptaluk" type="text" value="<?php echo $project1['ptaluk'];?>"></div></th>
</tr>
<tr>
<th>vi) District: <input  id="odistrict" name="odistrict" type="text" value="<?php echo $project1['odistrict'];?>"></th>
<th><div class="purchaseyescheck">vi) District:	</div><div class="purchaseyescheck"><input  id="pdistrict" class="purchaseyescheck" name="pdistrict" type="text" value="<?php echo $project1['pdistrict'];?>"></div></th>
</tr>	
<tr>
<th>vii) Pincode:<input  id="opincode" name="opincode" type="text" value="<?php echo $project1['opincode'];?>"></th>
<th><div class="purchaseyescheck">vii) Pincode:	</div><div class="purchaseyescheck"><input  id="ppincode" class="purchaseyescheck" name="ppincode" type="text" value="<?php echo $project1['ppincode'];?>"></div></th>
</tr>	
<tr>
<th>viii) Contact: <input  id="ocontact" name="ocontact" type="text" value="<?php echo $project1['ocontact'];?>"></th>
<th><div class="purchaseyescheck">viii) Contact:</div><div class="purchaseyescheck"><input  id="pcontact" class="purchaseyescheck" name="pcontact" type="text" value="<?php echo $project1['pcontact'];?>"></div></th>
</tr>		
 </thead>
</table> 
...
<?php } else {?>
 ...
 <thead>
<tr style="background: #ddd;">
<th style="width:50%;">Property Address<p class="mb-1">
              <label>
                <input type="checkbox" class="filled-in" name="residentialautofill" id="residentialautofill" <?php if($project1['residentialautofill']=='Yes') { ?> checked<?php } ?> value="Yes">
                <span>Auto Fill</span>
              </label>
...
<tr>
<th style="width: 39%;"> i) Door No <textarea id="propertydoorno" name="propertydoorno" rows="3" cols="23" style="    height: 3rem;">
<?php echo $project1['propertydoorno'];?>
</textarea>   </th>
<th><table><tr><td style="border:unset !important;width:50%">i) Old S.F No <input  id="oldsfno" name="oldsfno" type="text" value="<?php echo $project1['oldsfno'];?>"> </td><td style="border:unset !important">viii) Ward No <input  id="wardno" name="wardno" type="text" value="<?php echo $project1['wardno'];?>"></td></tr></table></th>
</tr>
<tr>
<th> ii) Street  <textarea id="propertystreet" name="propertystreet" rows="3" cols="23" style="    height: 3rem;">
<?php echo $project1['propertystreet'];?>
</textarea>   </th>
<th><table><tr><td style="border:unset !important;width:50%">ii) S.F NO  <input  id="sfno" name="sfno" type="text" value="<?php echo $project1['sfno'];?>"></td><td style="border:unset !important"> ix)  Block No <input  id="blockno" name="blockno" type="text" value="<?php echo $project1['blockno'];?>"></td></tr></table></th>
</tr>
<tr>
<th> iii) Area <textarea id="propertyarea" name="propertyarea" rows="3" cols="23" style="    height: 3rem;">
<?php echo $project1['propertyarea'];?>
</textarea></th>
<th><table><tr><td style="border:unset !important;width:50%">iii) R.S.F No  <input  id="rsfno" name="rsfno" type="text" value="<?php echo $project1['rsfno'];?>"></td><td style="border:unset !important"> x) S.R.O <input  id="sro" name="sro" type="text" value="<?php echo $project1['sro'];?>"></td></tr></table></th>

</tr>
<tr>
<th> iv) Post <input  id="propertyvillage" name="propertyvillage" type="text" value="<?php echo $project1['propertyvillage'];?>"></th>
<th>iv) Patta No<input  id="pattano" name="pattano" type="text" value="<?php echo $project1['pattano'];?>"></th>
</tr>
<tr>
<th> v) Taluk  <input  id="propertytaluk" name="propertytaluk" type="text" value="<?php echo $project1['propertytaluk'];?>"></th>
<th> v) Plot No<input  id="plotno" name="plotno" type="text" value="<?php echo $project1['plotno'];?>"></th>
</tr>
<tr>
<th> vi) District <input  id="propertydistict" name="propertydistict" type="text" value="<?php echo $project1['propertydistict'];?>"></th>
<th>vi) Pymash No <input  id="pymashno" name="pymashno" type="text" value="<?php echo $project1['pymashno'];?>"></th>
</tr>
<tr>
<th> vii) Pincode<input  id="propertypincode" name="propertypincode" type="text" value="<?php echo $project1['propertypincode'];?>"> </th>
<th> vii) T.S.No<input  id="tsno" name="tsno" type="text" value="<?php echo $project1['tsno'];?>"></th>
</tr>
<tr style="background: #ddd;">
<th></th>
<th></th>
...
<th>i) Land Mark<input  id="landmark" name="landmark" type="text" value="<?php echo $project1['landmark'];?>"></th>	
<th>i) Property Occupied<select name="propertyoccupied" style="display:block;">
<option value="" >Property Occupied</option>
<option <?php if($project1['propertyoccupied']=='owner') {?> Selected <?php } ?> value="owner">Owner</option>
<option <?php if($project1['propertyoccupied']=='rent') {?> Selected <?php } ?> value="rent">Rent</option>
</select></th>	
...
<tr>
<th>ii) Nearest Bus Stop<input  id="nearestbustop" name="nearestbustop" type="text" value="<?php echo $project1['nearestbustop'];?>"></th>	
<th>ii) Tax Receipt<select name="taxreceipt"  id="taxreceipt" style="display:block;">
<option value="" >Tax Receipt</option>
<option <?php if($project1['taxreceipt']=='Yes') {?> Selected <?php } ?>  value="Yes">Yes</option>
<option <?php if($project1['taxreceipt']=='No') {?> Selected <?php } ?> value="No">No</option>
</select>
...
<th> iii) Distance of Branch (KM) <input  id="distanceofbranch" name="distanceofbranch" type="text" value="<?php echo $project1['distanceofbranch'];?>"></th>	
<th>iii) E.B. Service No<select name="ebserviceno" id="ebserviceno" style="display:block;">
<option value="">E.B. Service No</option>
<option <?php if($project1['ebserviceno']=='Yes') {?> Selected <?php } ?> value="Yes">Yes</option>
<option <?php if($project1['ebserviceno']=='No') {?> Selected <?php } ?> value="No">No</option>
</select>
...
<tr>
<th>iv) Distance of R.S  (KM)<input  id="distanceofrs" name="distanceofrs" type="text" value="<?php echo $project1['distanceofrs'];?>">
</th>	
<th>iv) Patta / DTCP<select name="pattadtcp" id="pattadtcp" style="display:block;">
<option value="" >Patta / DTCP</option>
<option <?php if($project1['pattadtcp']=='Yes') {?> Selected <?php } ?> value="Yes">Yes</option>
<option <?php if($project1['pattadtcp']=='No') {?> Selected <?php } ?> value="No">No</option>
</select><br><input  id="pattadtcpfile" name="pattadtcpfile" type="file" value="<?php echo $project1['pattadtcpfile'];?>">
...
<tr>
<th>v) Nearest Main Road <input  id="nearestmainroad" name="nearestmainroad" type="text" value="<?php echo $project1['nearestmainroad'];?>"></th>	
<th>v) Approval Plan<select name="approvalplan" id="approvalplan" style="display:block;">
<option value="" >Approval Plan</option>
<option <?php if($project1['approvalplan']=='Yes') {?> Selected <?php } ?> value="Yes">Yes</option>
<option <?php if($project1['approvalplan']=='No') {?> Selected <?php } ?> value="No">No</option>
</select><br><input  id="approvalplanfile" name="approvalplanfile" type="file" value="<?php echo $project1['approvalplanfile'];?>"><input  id="approvalplan_name" name="approvalplan_name" type="text" value="<?php echo $project1['approvalplan_name'];?>" placeholder="Approval"><input  id="approvalplanfile_name" name="approvalplanfile_name" type="hidden" value="<?php echo $project1['approvalplanfile'];?>"><?php if($project1['approvalplanfile']!='')  {?> <a target="_blank" href="<?php echo $web_url; ?>documents/approvalplan/<?php echo $project1['approvalplanfile'];?>"><i class="material-icons dp48" style="color: green;font-size: 22px;font-weight: bold;">check</i>View</a><?php } ?></th>	
...
<tr>
<th>vi) Civil Amenities<input  id="civilamenities" name="civilamenities" type="text" value="<?php echo $project1['civilamenities'];?>"></th>	
<th>vi) H.D Line<select name="hdline" id="hdline" style="display:block;">
<option value="" >H.D Line</option>
<option <?php if($project1['hdline']=='Yes') {?> Selected <?php } ?> value="Yes">Yes</option>
<option <?php if($project1['hdline']=='No') {?> Selected <?php } ?> value="No">No</option>
</select><br><input  id="hdlinefile" name="hdlinefile" type="file" value="<?php echo $project1['hdlinefile'];?>">
...
<?php } } else { ?> 
 ...
 <tbody class="newTR1">
				 <tr><td colspan="1">Descrption</td>
					...
					<td class="pattashow"></td><td class="documentshow"></td>
           <td></td></tr>  
				   <tr >
		            <td>North</td>
					<td colspan="2" style="    width: 24%;"><textarea id="boundary1" name="northboundary[]" rows="3" cols="23" style="    height: 4rem;">
</textarea></td>
				    <td class="pattashow"><input  id="north1" name="north1[]" type="number"  value="" style="width:45% !important;"><input  id="north2" name="north2[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="north3" name="north3[]" type="number"  readonly value="" style="width:45% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="north4" name="north4[]" type="number" value="" style="width:45% !important;"><input  id="north5" name="north5" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="north6" name="north6[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
					 <td><input  id="north7" name="north7[]" type="number" value="" style="width:45% !important;"><input  id="north8" name="north8[]" type="number" value="<?php echo $project1['hdlinefile'];?>" style="width:45% !important;margin-left: 3px;"><input  id="north9" name="north9[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
                  ...
                  <tr>
					...
					<td colspan="2"><textarea id="southboundary" name="southboundary[]" rows="3" cols="23" style="    height: 4rem;">
				     ...
				     <td class="pattashow"><input  id="south1" name="south1[]" type="number" value="" style="width:45% !important;"><input  id="south2" name="south2[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="south3" name="south3[]" type="number" readonly value=""style="width:45% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="south4" name="south4[]" type="number" value="" style="width:45% !important;"><input  id="south5" name="south5[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="south6" name="south6[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
					 <td><input  id="south7" name="south7[]" type="number" value="" style="width:45% !important;"><input  id="south8" name="south8[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="south9" name="south9[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
                 ...
                 <tr>
					...
					<td colspan="2"><textarea id="eastboundary" name="eastboundary[]" rows="3" cols="23" style="    height: 4rem;">
				      ...
				      <td class="pattashow"><input  id="east1" name="east1[]" type="number" value="" style="width:45% !important;"><input  id="east2" name="east2[]" type="number" value=""  style="width:45% !important;margin-left: 3px;"><input  id="east3" name="east3[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="east4" name="east4[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="east5" name="east5[]" type="number" value=""  style="width:45% !important;margin-left: 3px;"><input  id="east6" name="east6[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
					 <td><input  id="east7" name="east7[]" type="number" value=""style="width:45% !important;"><input  id="east8" name="east8[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="east9" name="east9[]" type="number" readonly value=""style="width:45% !important;margin-left: 3px;"></td>
					...
					<td  colspan="2"><textarea id="westboundary" name="westboundary[]" rows="3" cols="23" style="    height: 4rem;">
				     ...
				     <td class="pattashow"><input  id="west1" name="west1[]" type="number" value="" style="width:45% !important;"><input  id="west2" name="west2[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="west3" name="west3[]" type="number" readonly value=""style="width:45% !important;margin-left: 3px;"></td>
                     <td class="documentshow"><input  id="west4" name="west4[]" type="number" value=""  style="width:45% !important;margin-left: 3px;"><input  id="west5" name="west5[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="west6" name="west6[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
					 <td><input  id="west7" name="west7[]" type="number" value=""  style="width:45% !important;"><input  id="west8" name="west8[]" type="number" value="" style="width:45% !important;margin-left: 3px;"><input  id="west9" name="west9[]" type="number" readonly value="" style="width:45% !important;margin-left: 3px;"></td>
 ...
 <tr>
		            <td>Extent of Site </td>
					<td colspan="2">As Per Manual <br><input  id="estent" name="estent[]"  type="number" value="" style="width:60% !important;margin-left: 3px;"></td>
				     <td class="pattashow">As Per Patta <br><input  id="estent1" name="estent1[]"  type="number" value="" style="width:60% !important;margin-left: 3px;"></td>
                     <td class="documentshow">As Per Document<br> <input  id="estent2" name="estent2[]" type="number"  value="" style="width:60% !important;margin-left: 3px;"></td>
					 <td>As Per Actual<br><input  id="estent3" name="estent3[]" type="number"  value="" style="width:60% !important;margin-left: 3px;"></td>
				  ...
				  <tr><td colspan="1">Resent Sale Details</td>
					...
					<td colspan="2"><input  id="sale_from" name="sale_from[]"  type="number" value="" style="font-weight:bold;font-size:18px;    width: 40% !important;"> TO <input  id="sale_to" name="sale_to[]"  type="number" value=""></td><td><select name="sale_type[]" id="sale_type" style="display:block" class="assignast1">
                  <option value="" >Select</option>
...
<?php if(1!=1) {?>
		            <td  style="border:unset !important"></td>
				     ...
				     <td colspan="2"  style="border:unset !important">		<?php if(1!=1) {?>Total Area if Any<input  id="anyarea" name="anyarea[]"  type="text" value=""><?php } ?></td>
                  	  <td >	Dimension of the<br><input  id="dimensionsite" name="dimensionsite[]"  type="text" value=""></td><?php } ?> 
				     <td>Total Area<br><input  id="totalarea" name="totalarea[]" class="totalareatot" type="text" value=""></td>
                     <td colspan="2" >Rate <span class="assignsq" id="assignsq"></span><br><input  id="totalrate" name="totalrate[]"  type="text" value=""></td>
					 <td style="width:15%;">Land Value Total<br><input  id="totallandvalue" class="totallandvalue" name="totallandvalue[]" readonly type="text" value="">     </td>
    ...
    width: 45% !important;"><select name="guideselect[]" id="guideselect" style="display:block" class="guideselect">
                  <option value="" >Select</option>
				   <option value="Sq ft" >Sq ft</option>
					...
					<td>Guideline Value<br><input  id="guidevalue" class="guidevalue" name="guidevalue[]" readonly type="text" value="">   <input  id="guideupload" name="guideupload[]" type="file" value="" style="    width: 100% !important;">   </td>
                  </tr>		
...
<tr>
<th colspan="1" style="width:16%;">Type of Property <select name="typeofproperty[]" id="typeofproperty" style="display:block">
                  <option value="" >Type of Property </option>
				  <?php
				  $typeofproperty = mysqli_query($GLOBALS['connect'],"SELECT * FROM  typeofproperty order by id asc"); 
while ($typeofproperty1 = mysqli_fetch_array($typeofproperty)) {?>
...
<th colspan="1" style="width:20%;">Size of Plot <select name="sizeofplot[]" id="sizeofplot" style="display:block">
                  <option value="" >Size of Plot</option>
				  <?php
				  $sizeofplot = mysqli_query($GLOBALS['connect'],"SELECT * FROM  sizeofplot order by id asc"); 
while ($sizeofplot1 = mysqli_fetch_array($sizeofplot)) {?>
...
<?php } ?>
				...
				<th colspan="2">Development to site <select name="recentdevelopmentsnear[]" id="recentdevelopmentsnear" style="display:block">
                  <option value="" >Select</option>
				  <?php
				  $recentdevelopments = mysqli_query($GLOBALS['connect'],"SELECT * FROM  recentdevelopments order by id asc"); 
while ($recentdevelopments1 = mysqli_fetch_array($recentdevelopments)) {?>
...
<?php } ?>
				...
				<th>Class of Construction  <select name="classofconstruction[]" id="classofconstruction" style="display:block">
                  <option value="" selected>Class of Construction</option>
				  <?php
				  $classofconstruction = mysqli_query($GLOBALS['connect'],"SELECT * FROM  classofconstruction order by id asc"); 
while ($classofconstruction1 = mysqli_fetch_array($classofconstruction)) {?>
...
<tbody>
<tr><td>Total Sq.ft</td><td><input id="totalareaval" name="totalareaval" type="text" value="<?php echo $project1['totalareaval'];?>"></td></tr>
<tr><td>Total Guideline value</td><td><input  id="guideline_value" name="guideline_value" type="text"  value="<?php echo $project1['guideline_value'];?>"><input  id="guideline_rate" name="guideline_rate" type="hidden"  value="<?php echo $project1['guideline_rate'];?>"></td></tr>
<?php if(1!=1) {?>
<tr><td>Guideline Rate</td><td><input  id="guideline_rate" name="guideline_rate" type="text"  value="<?php echo $project1['guideline_rate'];?>"></td></tr>
<?php } ?>
<tr><td colspan="2" style="text-align: center;">Land Value</td></tr>
...
while ($reasonable_perce1 = mysqli_fetch_array($reasonable_perce)) {?>
                  <option <?php if($reasonable_perce1['name']==$project1['reasonable_perce1']) {?> selected <?php } ?> value="<?php echo $reasonable_perce1['name'];?>"><?php echo $reasonable_perce1['name'];?>%</option>
<?php } ?>
                </select><input  id="reasonable_perce" name="reasonable_perce" type="hidden"  value="<?php echo $project1['reasonable_perce'];?>" style="width: 30%;float: right;margin-right: 112px;margin-top: -31px;"></td><td><input  id="reasonable_value" name="reasonable_value" type="text"  value="<?php echo $project1['reasonable_value'];?>"></td></tr>
<tr><td>3.Forced value<br><input  id="forced_percen1" name="forced_percen1" type="text"  value="<?php echo $project1['forced_percen1'];?>" placeholder="%" style="width:100%;"> <input  id="forced_percen" name="forced_percen" type="hidden"  value="<?php echo $project1['forced_percen'];?>" placeholder="Percentage" style="width:30%;"> <?php if(1!=1) {?>Market<?php } ?></td><td><input  id="forced_value" name="forced_value" type="text"  value="<?php echo $project1['forced_value'];?>"></td></tr>
<?php if(1!=1) {?>
<tr><td>4.Guideline value</td><td><input  id="guideline_value" name="guideline_value" type="text"  value="<?php echo $project1['guideline_value'];?>"></td></tr><?php } ?>
</tbody>
</table>
