      ...
      <table class="striped responsive-table">
        <tbody>
            ...
            <tr>
              ...
              echo moneyFormatIndia($project1['serviceovertotal']);?> </td>
              <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid;width:25%;">₹ <?php echo moneyFormatIndia($project1['serviceovertotal']);?></td>
            </tr>
            <tr>
