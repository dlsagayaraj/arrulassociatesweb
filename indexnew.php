...
<body>
  ...
  <div class="container">
    ...
    <section class="photographer">
      ...
      <div class="out-border-1"><a href="/project.php?type=ARRUL-ASSOCIATES" class="button-1">go to site</a> </div>
    </section>
    ...
    <section class="designer">
      ...
      <div class="out-border-1"><a href="/project.php?type=EVEREST-CONSTRUCTION" class="button-1">go to site</a> </div>
    </section>
